...
Integrated Management System (IMS) monorepo with 45 API services, 48 web apps, and 398 shared packages. Built with Next.js 15, Express.js, PostgreSQL/Prisma, Docker Compose. 45 Prisma schemas with ~610 database tables. ~1,224,330 unit tests across ~1,193 suites / 489 Jest projects (all passing).
...
```bash
pnpm test                        # ~1,224,330 Jest unit tests (~1,193 suites / 489 projects)
