...
Integrated Management System (IMS) monorepo with 44 API services, 47 web apps, and 398 shared packages. Built with Next.js 15, Express.js, PostgreSQL/Prisma, Docker Compose. 44 Prisma schemas with ~597 database tables. ~1,223,283 unit tests across ~1,149 suites / 489 Jest projects (all passing).
...
```bash
pnpm test                        # ~1,223,283 Jest unit tests (~1,149 suites / 489 projects)
