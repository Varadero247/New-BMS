...
Integrated Management System (IMS) monorepo with 42 API services, 44 web apps, and 61 shared packages. Built with Next.js 15, Express.js, PostgreSQL/Prisma, Docker Compose. 44 Prisma schemas with ~590 database tables. 49,888 unit tests across 711 suites (all passing, every file ≥70 tests).
...
```bash
pnpm test                        # 49,888 Jest unit tests (711 suites)
