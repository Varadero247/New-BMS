...
> Last updated: 2026-03-08 (Phase 166 — startup scripts wired for api-billing:4043 + web-partner-portal:3049; +5 partner email templates)
...
| Scripts                  | 60+                                                   |
| Unit Tests               | ~1,221,236 across ~1,121 suites / ~483 Jest projects (all passing) |
...
### Unit Tests (1,144 suites — all passing)

All 1,151 Jest test suites pass with 0 failures as of 2026-03-08. ~1,223,595 total tests. 489 Jest projects. Full breakdown by service is approximate:

| Category               | Suites (approx) | Tests (approx) |
| ---------------------- | --------------- | -------------- |
| API services (44)      | ~440            | ~315,000       |
| Web apps (47)          | ~99             | ~96,000        |
| Shared packages (398)  | ~605            | ~829,502       |
| **Total**              | **1,151**       | **~1,223,595** |
