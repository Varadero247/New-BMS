  ...
  // ───────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'table',
        columns: [
          { id: 'issue', label: 'Issue', type: 'text', required: true, placeholder: 'Describe the issue' },
          { id: 'impact', label: 'Impact', type: 'select', required: true, options: [{ label: 'High', value: 'high' }, { label: 'Medium', value: 'medium' }, { label: 'Low', value: 'low' }] },
          { id: 'owner', label: 'Owner', type: 'text', required: true, placeholder: 'Responsible person' },
          { id: 'action', label: 'Action Required', type: 'text', placeholder: 'Next step to resolve' },
        ],
      ...
      },
      {
        ...
        columns: [
          ...
          { id: 'status', label: 'Status', type: 'select', required: true, options: [{ label: 'Complete', value: 'complete' }, { label: 'On Track', value: 'on_track' }, { label: 'At Risk', value: 'at_risk' }, { label: 'Overdue', value: 'overdue' }] },
        ],
    ...
    fields: [
      ...
      },
      {
        ...
        columns: [
          ...
          { id: 'discussion', label: 'Discussion Notes', type: 'textarea', placeholder: 'Key points discussed', validation: { maxLength: 2000 } },
          { id: 'decision', label: 'Decision', type: 'text', placeholder: 'Decision made (if any)' },
        ],
      ...
      },
      {
        ...
        required: true,
        columns: [
          { id: 'action', label: 'Action', type: 'text', required: true, placeholder: 'What needs to be done' },
          { id: 'owner', label: 'Owner', type: 'text', required: true, placeholder: 'Responsible person' },
          { id: 'due_date', label: 'Due Date', type: 'date', required: true },
          { id: 'status', label: 'Status', type: 'select', options: [{ label: 'Open', value: 'open' }, { label: 'In Progress', value: 'in_progress' }, { label: 'Complete', value: 'complete' }] },
        ],
  ...
  // ───────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        columns: [
          { id: 'name', label: 'Name / Group', type: 'text', required: true, placeholder: 'Stakeholder name or group' },
          { id: 'role', label: 'Role / Title', type: 'text', required: true },
          { id: 'interest', label: 'Interest Level', type: 'select', required: true, options: [{ label: 'High', value: 'high' }, { label: 'Medium', value: 'medium' }, { label: 'Low', value: 'low' }] },
          { id: 'influence', label: 'Influence Level', type: 'select', required: true, options: [{ label: 'High', value: 'high' }, { label: 'Medium', value: 'medium' }, { label: 'Low', value: 'low' }] },
          { id: 'strategy', label: 'Engagement Strategy', type: 'select', required: true, options: [{ label: 'Manage Closely', value: 'manage_closely' }, { label: 'Keep Satisfied', value: 'keep_satisfied' }, { label: 'Keep Informed', value: 'keep_informed' }, { label: 'Monitor', value: 'monitor' }] },
          { id: 'needs', label: 'Key Needs / Concerns', type: 'text', placeholder: 'What matters most to this stakeholder' },
          { id: 'communication', label: 'Communication Method', type: 'text', placeholder: 'e.g. Weekly email, monthly meeting' },
        ],
  ...
  // ───────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        columns: [
          { id: 'what', label: 'Communication', type: 'text', required: true, placeholder: 'e.g. Status Report' },
          { id: 'audience', label: 'Audience', type: 'text', required: true, placeholder: 'e.g. Steering Committee' },
          { id: 'channel', label: 'Channel', type: 'select', required: true, options: [{ label: 'Email', value: 'email' }, { label: 'Meeting', value: 'meeting' }, { label: 'Report', value: 'report' }, { label: 'Dashboard', value: 'dashboard' }, { label: 'Presentation', value: 'presentation' }] },
          { id: 'frequency', label: 'Frequency', type: 'select', required: true, options: [{ label: 'Daily', value: 'daily' }, { label: 'Weekly', value: 'weekly' }, { label: 'Fortnightly', value: 'fortnightly' }, { label: 'Monthly', value: 'monthly' }, { label: 'Ad Hoc', value: 'ad_hoc' }] },
          { id: 'owner', label: 'Owner', type: 'text', required: true, placeholder: 'Responsible person' },
  ...
  // ───────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        columns: [
          { id: 'id', label: 'ID', type: 'text', required: true, placeholder: 'e.g. R-01, A-01, I-01, D-01' },
          { id: 'type', label: 'Type', type: 'select', required: true, options: [{ label: 'Risk', value: 'risk' }, { label: 'Assumption', value: 'assumption' }, { label: 'Issue', value: 'issue' }, { label: 'Dependency', value: 'dependency' }] },
          { id: 'description', label: 'Description', type: 'textarea', required: true, placeholder: 'Describe the item', validation: { maxLength: 1000 } },
          { id: 'severity', label: 'Severity', type: 'select', required: true, options: [{ label: 'High', value: 'high' }, { label: 'Medium', value: 'medium' }, { label: 'Low', value: 'low' }] },
          { id: 'owner', label: 'Owner', type: 'text', required: true },
          { id: 'mitigation', label: 'Mitigation / Action', type: 'textarea', placeholder: 'Response plan', validation: { maxLength: 1000 } },
  ...
  // ───────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Work Packages',
        type: 'section',
        helpText: 'Define each work package with its parent deliverable, effort estimate, and owner.',
      },
      {
        id: 'work_packages',
        label: 'Work Packages',
        ...
        required: true,
        columns: [
          { id: 'wbs_id', label: 'WBS ID', type: 'text', required: true, placeholder: 'e.g. 1.1.1' },
          { id: 'deliverable', label: 'Deliverable / Phase', type: 'text', required: true, placeholder: 'Parent deliverable' },
          { id: 'work_package', label: 'Work Package', type: 'text', required: true, placeholder: 'Specific work item' },
          { id: 'description', label: 'Description', type: 'textarea', placeholder: 'Brief description', validation: { maxLength: 500 } },
          { id: 'owner', label: 'Owner', type: 'text', required: true },
