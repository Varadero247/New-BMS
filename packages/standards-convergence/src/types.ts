export type ISOStandard =
  ...
  | 'ISO_42001' | 'ISO_50001' | 'ISO_22000' | 'ISO_13485'
  | 'ISO_37001' | 'ISO_55001' | 'IATF_16949' | 'AS9100D';
...
export type RecordType =
  | 'INTERNAL_AUDIT' | 'MANAGEMENT_REVIEW' | 'RISK_REGISTER'
  | 'OBJECTIVE' | 'DOCUMENT' | 'CAPA' | 'TRAINING' | 'LEGAL_REGISTER';
