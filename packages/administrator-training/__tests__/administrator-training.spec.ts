...
function mn253at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph253at5_mn',()=>{it('a',()=>{expect(mn253at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn253at5([0,1])).toBe(2);});it('c',()=>{expect(mn253at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn253at5([0])).toBe(1);});it('e',()=>{expect(mn253at5([1])).toBe(0);});});
function mn254at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph254at5_mn',()=>{it('a',()=>{expect(mn254at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn254at5([0,1])).toBe(2);});it('c',()=>{expect(mn254at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn254at5([0])).toBe(1);});it('e',()=>{expect(mn254at5([1])).toBe(0);});});
function mn255at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph255at5_mn',()=>{it('a',()=>{expect(mn255at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn255at5([0,1])).toBe(2);});it('c',()=>{expect(mn255at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn255at5([0])).toBe(1);});it('e',()=>{expect(mn255at5([1])).toBe(0);});});
function mn256at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph256at5_mn',()=>{it('a',()=>{expect(mn256at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn256at5([0,1])).toBe(2);});it('c',()=>{expect(mn256at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn256at5([0])).toBe(1);});it('e',()=>{expect(mn256at5([1])).toBe(0);});});
function mn257at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph257at5_mn',()=>{it('a',()=>{expect(mn257at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn257at5([0,1])).toBe(2);});it('c',()=>{expect(mn257at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn257at5([0])).toBe(1);});it('e',()=>{expect(mn257at5([1])).toBe(0);});});
function mn258at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph258at5_mn',()=>{it('a',()=>{expect(mn258at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn258at5([0,1])).toBe(2);});it('c',()=>{expect(mn258at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn258at5([0])).toBe(1);});it('e',()=>{expect(mn258at5([1])).toBe(0);});});
function mn259at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph259at5_mn',()=>{it('a',()=>{expect(mn259at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn259at5([0,1])).toBe(2);});it('c',()=>{expect(mn259at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn259at5([0])).toBe(1);});it('e',()=>{expect(mn259at5([1])).toBe(0);});});
function mn260at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph260at5_mn',()=>{it('a',()=>{expect(mn260at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn260at5([0,1])).toBe(2);});it('c',()=>{expect(mn260at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn260at5([0])).toBe(1);});it('e',()=>{expect(mn260at5([1])).toBe(0);});});
function mn261at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph261at5_mn',()=>{it('a',()=>{expect(mn261at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn261at5([0,1])).toBe(2);});it('c',()=>{expect(mn261at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn261at5([0])).toBe(1);});it('e',()=>{expect(mn261at5([1])).toBe(0);});});
function mn262at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph262at5_mn',()=>{it('a',()=>{expect(mn262at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn262at5([0,1])).toBe(2);});it('c',()=>{expect(mn262at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn262at5([0])).toBe(1);});it('e',()=>{expect(mn262at5([1])).toBe(0);});});
function mn263at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph263at5_mn',()=>{it('a',()=>{expect(mn263at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn263at5([0,1])).toBe(2);});it('c',()=>{expect(mn263at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn263at5([0])).toBe(1);});it('e',()=>{expect(mn263at5([1])).toBe(0);});});
function mn264at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph264at5_mn',()=>{it('a',()=>{expect(mn264at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn264at5([0,1])).toBe(2);});it('c',()=>{expect(mn264at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn264at5([0])).toBe(1);});it('e',()=>{expect(mn264at5([1])).toBe(0);});});
function mn265at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph265at5_mn',()=>{it('a',()=>{expect(mn265at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn265at5([0,1])).toBe(2);});it('c',()=>{expect(mn265at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn265at5([0])).toBe(1);});it('e',()=>{expect(mn265at5([1])).toBe(0);});});
function mn266at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph266at5_mn',()=>{it('a',()=>{expect(mn266at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn266at5([0,1])).toBe(2);});it('c',()=>{expect(mn266at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn266at5([0])).toBe(1);});it('e',()=>{expect(mn266at5([1])).toBe(0);});});
function mn267at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph267at5_mn',()=>{it('a',()=>{expect(mn267at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn267at5([0,1])).toBe(2);});it('c',()=>{expect(mn267at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn267at5([0])).toBe(1);});it('e',()=>{expect(mn267at5([1])).toBe(0);});});
function mn268at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph268at5_mn',()=>{it('a',()=>{expect(mn268at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn268at5([0,1])).toBe(2);});it('c',()=>{expect(mn268at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn268at5([0])).toBe(1);});it('e',()=>{expect(mn268at5([1])).toBe(0);});});
function mn269at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph269at5_mn',()=>{it('a',()=>{expect(mn269at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn269at5([0,1])).toBe(2);});it('c',()=>{expect(mn269at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn269at5([0])).toBe(1);});it('e',()=>{expect(mn269at5([1])).toBe(0);});});
function mn270at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph270at5_mn',()=>{it('a',()=>{expect(mn270at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn270at5([0,1])).toBe(2);});it('c',()=>{expect(mn270at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn270at5([0])).toBe(1);});it('e',()=>{expect(mn270at5([1])).toBe(0);});});
function mn271at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph271at5_mn',()=>{it('a',()=>{expect(mn271at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn271at5([0,1])).toBe(2);});it('c',()=>{expect(mn271at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn271at5([0])).toBe(1);});it('e',()=>{expect(mn271at5([1])).toBe(0);});});
function mn272at5(nums:number[]):number{const n=nums.length;return n*(n+1)/2-nums.reduce((a,b)=>a+b,0);}
describe('ph272at5_mn',()=>{it('a',()=>{expect(mn272at5([3,0,1])).toBe(2);});it('b',()=>{expect(mn272at5([0,1])).toBe(2);});it('c',()=>{expect(mn272at5([9,6,4,2,3,5,7,0,1])).toBe(8);});it('d',()=>{expect(mn272at5([0])).toBe(1);});it('e',()=>{expect(mn272at5([1])).toBe(0);});});
function sn273at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph273at6_sn',()=>{it('a',()=>{expect(sn273at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn273at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn273at6([1])).toBe(1);});it('d',()=>{expect(sn273at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn273at6([3,3,5])).toBe(5);});});
function sn274at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph274at6_sn',()=>{it('a',()=>{expect(sn274at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn274at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn274at6([1])).toBe(1);});it('d',()=>{expect(sn274at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn274at6([3,3,5])).toBe(5);});});
function sn275at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph275at6_sn',()=>{it('a',()=>{expect(sn275at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn275at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn275at6([1])).toBe(1);});it('d',()=>{expect(sn275at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn275at6([3,3,5])).toBe(5);});});
function sn276at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph276at6_sn',()=>{it('a',()=>{expect(sn276at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn276at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn276at6([1])).toBe(1);});it('d',()=>{expect(sn276at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn276at6([3,3,5])).toBe(5);});});
function sn277at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph277at6_sn',()=>{it('a',()=>{expect(sn277at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn277at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn277at6([1])).toBe(1);});it('d',()=>{expect(sn277at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn277at6([3,3,5])).toBe(5);});});
function sn278at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph278at6_sn',()=>{it('a',()=>{expect(sn278at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn278at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn278at6([1])).toBe(1);});it('d',()=>{expect(sn278at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn278at6([3,3,5])).toBe(5);});});
function sn279at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph279at6_sn',()=>{it('a',()=>{expect(sn279at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn279at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn279at6([1])).toBe(1);});it('d',()=>{expect(sn279at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn279at6([3,3,5])).toBe(5);});});
function sn280at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph280at6_sn',()=>{it('a',()=>{expect(sn280at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn280at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn280at6([1])).toBe(1);});it('d',()=>{expect(sn280at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn280at6([3,3,5])).toBe(5);});});
function sn281at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph281at6_sn',()=>{it('a',()=>{expect(sn281at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn281at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn281at6([1])).toBe(1);});it('d',()=>{expect(sn281at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn281at6([3,3,5])).toBe(5);});});
function sn282at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph282at6_sn',()=>{it('a',()=>{expect(sn282at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn282at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn282at6([1])).toBe(1);});it('d',()=>{expect(sn282at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn282at6([3,3,5])).toBe(5);});});
function sn283at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph283at6_sn',()=>{it('a',()=>{expect(sn283at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn283at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn283at6([1])).toBe(1);});it('d',()=>{expect(sn283at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn283at6([3,3,5])).toBe(5);});});
function sn284at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph284at6_sn',()=>{it('a',()=>{expect(sn284at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn284at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn284at6([1])).toBe(1);});it('d',()=>{expect(sn284at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn284at6([3,3,5])).toBe(5);});});
function sn285at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph285at6_sn',()=>{it('a',()=>{expect(sn285at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn285at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn285at6([1])).toBe(1);});it('d',()=>{expect(sn285at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn285at6([3,3,5])).toBe(5);});});
function sn286at6(nums:number[]):number{return nums.reduce((a,b)=>a^b,0);}
describe('ph286at6_sn',()=>{it('a',()=>{expect(sn286at6([2,2,1])).toBe(1);});it('b',()=>{expect(sn286at6([4,1,2,1,2])).toBe(4);});it('c',()=>{expect(sn286at6([1])).toBe(1);});it('d',()=>{expect(sn286at6([0,1,0])).toBe(1);});it('e',()=>{expect(sn286at6([3,3,5])).toBe(5);});});
function hd287at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph287at7_hd',()=>{it('a',()=>{expect(hd287at7(1,4)).toBe(2);});it('b',()=>{expect(hd287at7(3,1)).toBe(1);});it('c',()=>{expect(hd287at7(0,0)).toBe(0);});it('d',()=>{expect(hd287at7(0,15)).toBe(4);});it('e',()=>{expect(hd287at7(7,7)).toBe(0);});});
function hd288at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph288at7_hd',()=>{it('a',()=>{expect(hd288at7(1,4)).toBe(2);});it('b',()=>{expect(hd288at7(3,1)).toBe(1);});it('c',()=>{expect(hd288at7(0,0)).toBe(0);});it('d',()=>{expect(hd288at7(0,15)).toBe(4);});it('e',()=>{expect(hd288at7(7,7)).toBe(0);});});
function hd289at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph289at7_hd',()=>{it('a',()=>{expect(hd289at7(1,4)).toBe(2);});it('b',()=>{expect(hd289at7(3,1)).toBe(1);});it('c',()=>{expect(hd289at7(0,0)).toBe(0);});it('d',()=>{expect(hd289at7(0,15)).toBe(4);});it('e',()=>{expect(hd289at7(7,7)).toBe(0);});});
function hd290at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph290at7_hd',()=>{it('a',()=>{expect(hd290at7(1,4)).toBe(2);});it('b',()=>{expect(hd290at7(3,1)).toBe(1);});it('c',()=>{expect(hd290at7(0,0)).toBe(0);});it('d',()=>{expect(hd290at7(0,15)).toBe(4);});it('e',()=>{expect(hd290at7(7,7)).toBe(0);});});
function hd291at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph291at7_hd',()=>{it('a',()=>{expect(hd291at7(1,4)).toBe(2);});it('b',()=>{expect(hd291at7(3,1)).toBe(1);});it('c',()=>{expect(hd291at7(0,0)).toBe(0);});it('d',()=>{expect(hd291at7(0,15)).toBe(4);});it('e',()=>{expect(hd291at7(7,7)).toBe(0);});});
function hd292at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph292at7_hd',()=>{it('a',()=>{expect(hd292at7(1,4)).toBe(2);});it('b',()=>{expect(hd292at7(3,1)).toBe(1);});it('c',()=>{expect(hd292at7(0,0)).toBe(0);});it('d',()=>{expect(hd292at7(0,15)).toBe(4);});it('e',()=>{expect(hd292at7(7,7)).toBe(0);});});
function hd293at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph293at7_hd',()=>{it('a',()=>{expect(hd293at7(1,4)).toBe(2);});it('b',()=>{expect(hd293at7(3,1)).toBe(1);});it('c',()=>{expect(hd293at7(0,0)).toBe(0);});it('d',()=>{expect(hd293at7(0,15)).toBe(4);});it('e',()=>{expect(hd293at7(7,7)).toBe(0);});});
function hd294at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph294at7_hd',()=>{it('a',()=>{expect(hd294at7(1,4)).toBe(2);});it('b',()=>{expect(hd294at7(3,1)).toBe(1);});it('c',()=>{expect(hd294at7(0,0)).toBe(0);});it('d',()=>{expect(hd294at7(0,15)).toBe(4);});it('e',()=>{expect(hd294at7(7,7)).toBe(0);});});
function hd295at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph295at7_hd',()=>{it('a',()=>{expect(hd295at7(1,4)).toBe(2);});it('b',()=>{expect(hd295at7(3,1)).toBe(1);});it('c',()=>{expect(hd295at7(0,0)).toBe(0);});it('d',()=>{expect(hd295at7(0,15)).toBe(4);});it('e',()=>{expect(hd295at7(7,7)).toBe(0);});});
function hd296at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph296at7_hd',()=>{it('a',()=>{expect(hd296at7(1,4)).toBe(2);});it('b',()=>{expect(hd296at7(3,1)).toBe(1);});it('c',()=>{expect(hd296at7(0,0)).toBe(0);});it('d',()=>{expect(hd296at7(0,15)).toBe(4);});it('e',()=>{expect(hd296at7(7,7)).toBe(0);});});
function hd297at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph297at7_hd',()=>{it('a',()=>{expect(hd297at7(1,4)).toBe(2);});it('b',()=>{expect(hd297at7(3,1)).toBe(1);});it('c',()=>{expect(hd297at7(0,0)).toBe(0);});it('d',()=>{expect(hd297at7(0,15)).toBe(4);});it('e',()=>{expect(hd297at7(7,7)).toBe(0);});});
function hd298at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph298at7_hd',()=>{it('a',()=>{expect(hd298at7(1,4)).toBe(2);});it('b',()=>{expect(hd298at7(3,1)).toBe(1);});it('c',()=>{expect(hd298at7(0,0)).toBe(0);});it('d',()=>{expect(hd298at7(0,15)).toBe(4);});it('e',()=>{expect(hd298at7(7,7)).toBe(0);});});
function hd299at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph299at7_hd',()=>{it('a',()=>{expect(hd299at7(1,4)).toBe(2);});it('b',()=>{expect(hd299at7(3,1)).toBe(1);});it('c',()=>{expect(hd299at7(0,0)).toBe(0);});it('d',()=>{expect(hd299at7(0,15)).toBe(4);});it('e',()=>{expect(hd299at7(7,7)).toBe(0);});});
function hd300at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph300at7_hd',()=>{it('a',()=>{expect(hd300at7(1,4)).toBe(2);});it('b',()=>{expect(hd300at7(3,1)).toBe(1);});it('c',()=>{expect(hd300at7(0,0)).toBe(0);});it('d',()=>{expect(hd300at7(0,15)).toBe(4);});it('e',()=>{expect(hd300at7(7,7)).toBe(0);});});
function hd301at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph301at7_hd',()=>{it('a',()=>{expect(hd301at7(1,4)).toBe(2);});it('b',()=>{expect(hd301at7(3,1)).toBe(1);});it('c',()=>{expect(hd301at7(0,0)).toBe(0);});it('d',()=>{expect(hd301at7(0,15)).toBe(4);});it('e',()=>{expect(hd301at7(7,7)).toBe(0);});});
function hd302at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph302at7_hd',()=>{it('a',()=>{expect(hd302at7(1,4)).toBe(2);});it('b',()=>{expect(hd302at7(3,1)).toBe(1);});it('c',()=>{expect(hd302at7(0,0)).toBe(0);});it('d',()=>{expect(hd302at7(0,15)).toBe(4);});it('e',()=>{expect(hd302at7(7,7)).toBe(0);});});
function hd303at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph303at7_hd',()=>{it('a',()=>{expect(hd303at7(1,4)).toBe(2);});it('b',()=>{expect(hd303at7(3,1)).toBe(1);});it('c',()=>{expect(hd303at7(0,0)).toBe(0);});it('d',()=>{expect(hd303at7(0,15)).toBe(4);});it('e',()=>{expect(hd303at7(7,7)).toBe(0);});});
function hd304at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph304at7_hd',()=>{it('a',()=>{expect(hd304at7(1,4)).toBe(2);});it('b',()=>{expect(hd304at7(3,1)).toBe(1);});it('c',()=>{expect(hd304at7(0,0)).toBe(0);});it('d',()=>{expect(hd304at7(0,15)).toBe(4);});it('e',()=>{expect(hd304at7(7,7)).toBe(0);});});
function hd305at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph305at7_hd',()=>{it('a',()=>{expect(hd305at7(1,4)).toBe(2);});it('b',()=>{expect(hd305at7(3,1)).toBe(1);});it('c',()=>{expect(hd305at7(0,0)).toBe(0);});it('d',()=>{expect(hd305at7(0,15)).toBe(4);});it('e',()=>{expect(hd305at7(7,7)).toBe(0);});});
function hd306at7(x:number,y:number):number{let n=x^y,c=0;while(n){c+=n&1;n>>>=1;}return c;}
describe('ph306at7_hd',()=>{it('a',()=>{expect(hd306at7(1,4)).toBe(2);});it('b',()=>{expect(hd306at7(3,1)).toBe(1);});it('c',()=>{expect(hd306at7(0,0)).toBe(0);});it('d',()=>{expect(hd306at7(0,15)).toBe(4);});it('e',()=>{expect(hd306at7(7,7)).toBe(0);});});
