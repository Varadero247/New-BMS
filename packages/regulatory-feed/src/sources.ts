...
export const REGULATORY_SOURCES: Record<string, RegulatorySource> = {
  uk_hse: {
    ...
    description:
      'UK HSE publishes guidance, regulations, and enforcement notices for workplace health and safety.',
  },
  uk_ea: {
    id: 'uk_ea',
    ...
    description:
      'Environment Agency regulates environmental protection, water quality, and waste management in England.',
  },
  uk_mhra: {
    id: 'uk_mhra',
    name: 'UK MHRA',
    ...
    description:
      'Medicines and Healthcare products Regulatory Agency regulates medicines and medical devices in the UK.',
  },
  eu_oj: {
    id: 'eu_oj',
    ...
    description:
      'Official Journal of the European Union publishes EU legislation, directives, and regulations.',
  },
  uae_mohre: {
    id: 'uae_mohre',
    ...
    description:
      'UAE MOHRE publishes labour regulations, workplace safety standards, and employment laws.',
  },
  uae_dm: {
    id: 'uae_dm',
    ...
    description:
      'Dubai Municipality regulates environmental standards, food safety, and building codes.',
  },
  us_osha: {
    id: 'us_osha',
    name: 'US OSHA',
...
export function getSourcesByCategory(category: string): RegulatorySource[] {
  return Object.values(REGULATORY_SOURCES).filter((s) => s.categories.includes(category));
}
