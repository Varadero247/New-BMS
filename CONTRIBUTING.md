...
Monorepo: 42 API services, 44 web apps, 61 shared packages. Stack: Next.js 15, Express.js, PostgreSQL/Prisma 5.22.0, TypeScript 5, pnpm workspaces. 708,565 unit tests across 712 suites — all passing, 0 TS errors.
...
- **Before submitting a PR**, run:
  ```bash
  pnpm test          # All 708,565 tests must pass
