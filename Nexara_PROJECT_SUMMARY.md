...
**Total Codebase**: 43 API services (+ api-search:4050) · 45 web apps · 394 shared packages · 44 Prisma schemas · ~590 database tables · ~1,203,000 unit tests (all passing)
**Last Updated**: February 28, 2026 (Phase 125 complete — Knowledge Base: 801 articles + Module Owner & End User Training programmes)

> **Note:** The detailed module descriptions below were written at an early phase (Feb 17, 2026) covering the initial 9 core services. The platform has since grown to 43 API services + api-search, 45 web apps, and 394 shared packages. See `SYSTEM_STATE.md` for the authoritative current state.
...
| `pnpm test`           | Run Jest tests (~1,203,000 across ~1,085 suites / 439 projects) |
...
**Jest Unit Tests**: ~1,203,000 tests across ~1,085 suites / 439 projects (all passing)
