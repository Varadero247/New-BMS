...
|---|---|---|---|
| Unit tests | ~1,203,000 tests / ~1,085 suites / 439 projects | Jest + Supertest | `pnpm test` |
...
```bash
# All ~1,085 suites / 439 projects from the repo root
pnpm test
...
| Unit tests + coverage | every push/PR | `pnpm test --coverage` — all ~1,085 suites / 439 projects |
