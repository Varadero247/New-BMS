...
|---|---|---|---|
| Unit tests | 1,196,395 tests / 1,079 suites / 442 projects | Jest + Supertest | `pnpm test` |
...
```bash
# All 1,079 suites / 442 projects from the repo root
pnpm test
...
| Unit tests + coverage | every push/PR | `pnpm test --coverage` — all 1,079 suites / 442 projects |
