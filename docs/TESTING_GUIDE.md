...
|---|---|---|---|
| Unit tests | ~1,220,715 tests / 1,117 suites / 480 projects | Jest + Supertest | `pnpm test` |
...
```bash
# All 1,117 suites / 480 projects from the repo root
pnpm test
...
| Unit tests + coverage | every push/PR | `pnpm test --coverage` — all 1,117 suites / 480 projects |
