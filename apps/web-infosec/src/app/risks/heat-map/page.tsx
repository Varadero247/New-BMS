      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4 overflow-y-auto max-h-[600px]">
          <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
            {selectedCell
              ? `Risks at L${selectedCell.l} x I${selectedCell.i}`
              : selectedRisk
                ? 'Risk Details'
                : 'Select a cell'}
          </h2>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-red-50 rounded-lg p-3">
                  ...
                  <p className="text-xs text-red-500">
                    L{selectedRisk.likelihood} x I{selectedRisk.impact}
                  </p>
                </div>
                <div className="bg-green-50 rounded-lg p-3">
                  ...
                  <p className="text-xs text-green-500">
                    L{selectedRisk.residualLikelihood} x I{selectedRisk.residualImpact}
                  </p>
                </div>
              </div>
              <div>
