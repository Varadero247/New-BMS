            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-red-50 rounded-lg p-3">
                  ...
                  <p className="text-xs text-red-500">L{selectedRisk.likelihood} x I{selectedRisk.impact}</p>
                </div>
                <div className="bg-green-50 rounded-lg p-3">
                  ...
                  <p className="text-xs text-green-500">L{selectedRisk.residualLikelihood} x I{selectedRisk.residualImpact}</p>
                </div>
              </div>
              <div>
