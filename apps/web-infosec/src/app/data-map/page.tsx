...
const CATEGORIES: DataCategory[] = [
  {
    id: 'dc-1', name: 'Employee Personal Data', type: 'personal',
    sources: ['HR System', 'Recruitment Portal'], processors: ['HR Team', 'Payroll Provider'],
    legalBasis: 'Contract Performance (Art. 6(1)(b))', retention: '7 years post-employment',
    transfers: ['Payroll SaaS (EU)', 'Benefits Provider (EU)'], subjects: ['Employees', 'Contractors'],
    volume: '~2,500 records',
  },
  {
    id: 'dc-2', name: 'Customer Contact Data', type: 'personal',
    sources: ['CRM', 'Website Forms', 'Sales Calls'], processors: ['Sales Team', 'Marketing Team'],
    legalBasis: 'Legitimate Interest (Art. 6(1)(f))', retention: '3 years post-last interaction',
    transfers: ['Email SaaS (US - SCCs)', 'CRM SaaS (EU)'], subjects: ['Customers', 'Prospects'],
    volume: '~18,000 records',
  },
  {
    id: 'dc-3', name: 'Health & Safety Records', type: 'sensitive',
    sources: ['H&S Module', 'Incident Reports'], processors: ['H&S Team', 'Occupational Health'],
    legalBasis: 'Legal Obligation (Art. 6(1)(c)) + Art. 9(2)(b)', retention: '40 years (injury records)',
    transfers: ['None (on-premise)'], subjects: ['Employees', 'Visitors'],
    volume: '~850 records',
  },
  {
    id: 'dc-4', name: 'Supplier Due Diligence', type: 'personal',
    sources: ['Supplier Portal', 'Background Checks'], processors: ['Procurement', 'Compliance'],
    legalBasis: 'Legitimate Interest (Art. 6(1)(f))', retention: '5 years post-contract',
    transfers: ['Background Check Provider (UK)'], subjects: ['Supplier Contacts', 'Directors'],
    volume: '~1,200 records',
  },
  {
    id: 'dc-5', name: 'CCTV Footage', type: 'personal',
    sources: ['CCTV Cameras'], processors: ['Security Team'],
    legalBasis: 'Legitimate Interest (Art. 6(1)(f))', retention: '30 days rolling',
    transfers: ['Cloud Storage (EU)'], subjects: ['Employees', 'Visitors', 'Public'],
    volume: '~90 TB/year',
  },
  {
    id: 'dc-6', name: 'Training & Competence Records', type: 'personal',
    sources: ['HR Module', 'LMS', 'External Certifications'], processors: ['HR Team', 'Managers'],
    legalBasis: 'Legal Obligation (Art. 6(1)(c))', retention: '6 years post-employment',
    transfers: ['LMS SaaS (EU)'], subjects: ['Employees'],
    volume: '~4,500 records',
  },
  {
    id: 'dc-7', name: 'Whistleblower Reports', type: 'special-category',
    sources: ['Anonymous Reporting Portal'], processors: ['Compliance Officer', 'Legal'],
    legalBasis: 'Legal Obligation (Art. 6(1)(c)) + Art. 9(2)(g)', retention: '10 years',
    transfers: ['None (air-gapped)'], subjects: ['Reporters', 'Subjects of Reports'],
    volume: '~15 records',
  },
];
...
export default function DataMapPage() {
  ...
  const [filter, setFilter] = useState<'all' | 'personal' | 'sensitive' | 'special-category'>('all');
