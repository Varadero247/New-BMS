...
const controls: SoAControl[] = [
  {
    ...
    applicable: true,
    justification: 'Required for governance framework',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'IS-POL-001',
    riskRef: 'R-001',
    owner: 'CISO',
  },
  {
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Prevents fraud and errors',
    implemented: true,
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Required for leadership commitment',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'MGT-001',
    riskRef: 'R-001',
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Industry collaboration',
    implemented: false,
    implementationStatus: 'partial',
    evidenceRef: '',
    riskRef: 'R-006',
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Proactive threat management',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'TI-001',
    riskRef: 'R-007',
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Secure-by-design requirement',
    implemented: false,
    implementationStatus: 'partial',
    evidenceRef: 'PM-SEC-001',
    riskRef: 'R-008',
    owner: 'PMO Lead',
  },
  {
    ...
    title: 'Screening',
    applicable: true,
    justification: 'Pre-employment verification',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'HR-SCR-001',
    riskRef: 'R-009',
    owner: 'HR Manager',
  },
  {
    ...
    applicable: true,
    justification: 'Contractual obligations',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'HR-T&C-001',
    riskRef: 'R-010',
    owner: 'HR Manager',
  },
  {
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Ongoing confidentiality',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'HR-TERM-001',
    riskRef: 'R-013',
    owner: 'HR Manager',
  },
  {
    ...
    applicable: true,
    justification: 'Data centre protection',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'PHYS-001',
    riskRef: 'R-014',
    owner: 'Facilities',
  },
  {
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Surveillance requirement',
    implemented: true,
    implementationStatus: 'partial',
    evidenceRef: 'CCTV-001',
    riskRef: 'R-017',
    owner: 'Facilities',
  },
  {
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Need-to-know basis',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'RBAC-001',
    riskRef: 'R-020',
    owner: 'IT Manager',
  },
  {
  ...
  },
  {
    ...
    applicable: true,
    justification: 'Endpoint protection',
    implemented: true,
    implementationStatus: 'fully',
    evidenceRef: 'AV-001',
    riskRef: 'R-024',
  ...
  },
  {
    ...
    title: 'Data masking',
    applicable: false,
    justification: 'No PII processing requiring masking at this time',
    implemented: false,
  ...
  const filtered = useMemo(() => {
    return controls.filter((c) => {
      ...
      const matchesApplicable =
        filterApplicable === 'all' || (filterApplicable === 'yes' ? c.applicable : !c.applicable);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            ISO 27001:2022 Annex A controls — applicability and implementation status
          </p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-800">
              <tr>
                <th className="text-left px-4 py-3 font-medium text-gray-500 dark:text-gray-400 w-20">
                  Clause
                </th>
                ...
                <th className="text-left px-4 py-3 font-medium text-gray-500 dark:text-gray-400 w-48">
                  Justification
                </th>
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-gray-400 w-36">
                  Status
                </th>
              ...
              {filtered.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-xs text-gray-500 dark:text-gray-400 max-w-[12rem] truncate">
                      {c.justification}
                    </td>
                    <td className="px-4 py-2.5 text-center">
