...
const controlSchema = z.object({
  ...
  lastTestedDate: z.string().trim().datetime({ offset: true }).optional().or(z.string().trim().datetime({ offset: true }).optional()),
  testingFrequency: z.string().optional(),
  testingMethod: z.string().optional(),
  nextTestDate: z.string().trim().datetime({ offset: true }).optional().or(z.string().trim().datetime({ offset: true }).optional()),
