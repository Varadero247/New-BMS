...
describe('GET /api/capa', () => {
  it('should return CAPAs', async () => {
    (prisma as any).riskCapa.findMany.mockResolvedValue([
...
describe('GET /api/capa/:id', () => {
  ...
  it('should return item by id', async () => {
    (prisma as any).riskCapa.findFirst.mockResolvedValue({
...
describe('POST /api/capa', () => {
  it('should create', async () => {
    ...
    (prisma as any).riskCapa.create.mockResolvedValue({
      id: '00000000-0000-0000-0000-000000000001',
      title: 'New',
    });
...
describe('PUT /api/capa/:id', () => {
  it('should update', async () => {
    ...
    (prisma as any).riskCapa.update.mockResolvedValue({
      id: '00000000-0000-0000-0000-000000000001',
      title: 'Updated',
    });
