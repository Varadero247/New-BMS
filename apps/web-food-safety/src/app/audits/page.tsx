                    ...
                    {filtered.map((a) => (
                      <tr key={a.id} className="border-b hover:bg-gray-50 dark:bg-gray-800">
                        <td className="py-3 px-4">
                          ...
                          {a.scope && (
                            <p className="text-xs text-gray-500 dark:text-gray-400">{a.scope}</p>
                          )}
                        </td>
                        <td className="py-3 px-4">
                        ...
                        <td className="py-3 px-4">
                          <span
                            className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${statusColors[a.status] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}
                          >
