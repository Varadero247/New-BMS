...
export default function RisksClient() {
  ...
  async function handleSubmit() {
    ...
    try {
      const score =
        (LIKELIHOOD_SCORES[form.likelihood] || 3) * (CONSEQUENCE_SCORES[form.consequence] || 3);
      const payload = {
        ...form,
        inherentScore: score,
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              ISO 31000 risk identification and assessment
            </p>
          </div>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-red-600">
                {risks.filter((r) => r.inherentScore >= 15).length}
              </p>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-orange-600">
                {risks.filter((r) => r.inherentScore >= 8 && r.inherentScore < 15).length}
              </p>
                  ...
                  <TableBody>
                    {risks.map((risk) => (
                      <TableRow key={risk.id}>
                        ...
                        <TableCell>
                          <span
                            className={`px-2 py-1 rounded-full text-xs font-medium ${getRiskColor(risk.inherentScore || 0)}`}
                          >
                            {risk.inherentScore || '-'}
                          </span>
                        </TableCell>
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                            <Button size="sm" variant="outline" onClick={() => openEdit(risk)}>
                              Edit
                            </Button>
                            <Button
                              size="sm"
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  ...
                  <span className="font-bold text-lg">
                    {(LIKELIHOOD_SCORES[form.likelihood] || 3) *
                      (CONSEQUENCE_SCORES[form.consequence] || 3)}
                  </span>
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={2}
                  placeholder="How will this risk be treated?"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
