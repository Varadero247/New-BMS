...
const createRiskSchema = z.object({
  ...
  aspectType: z.string().trim().optional(),
  ...
  processOwner: z.string().trim().optional(),
  processInputs: z.string().trim().optional(),
  processOutputs: z.string().trim().optional(),
  kpis: z.string().trim().optional(),
  existingControls: z.string().trim().optional(),
  additionalControls: z.string().trim().optional(),
  reviewDate: z.string().trim().datetime({ offset: true }).optional(),
});
