...
import { MessageSquareWarning, ListChecks, Clock, Scale, AlertTriangle, CheckCircle } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const kpis = [
    { label: 'Total Complaints', value: stats.totalComplaints ?? 0, icon: MessageSquareWarning, color: 'orange' },
    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Complaints Dashboard</h1>
          ...
          {Object.keys(stats).length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Object.entries(stats)
                .filter(([k]) => !['totalComplaints', 'totalActions', 'overdueSla', 'regulatoryCount', 'openComplaints', 'resolvedComplaints'].includes(k))
                .map(([key, value]) => (
