          ...
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="flex gap-2 print:hidden">
              ...
              >
                ...
                {actionLoading === 'supersede' ? 'Creating...' : 'Supersede'}
              </button>
              <button
              ...
              >
                ...
                {actionLoading === 'review' ? 'Saving...' : 'Mark Reviewed'}
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent className="p-6">
                ...
                <dl className="space-y-3">
                  <div className="flex justify-between">
                    <dt className="text-sm text-gray-500 dark:text-gray-400">Chemical</dt>
                    <dd className="text-sm font-medium text-gray-900 dark:text-gray-100">
                      {coshh.chemicalName}
                    </dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-sm text-gray-500 dark:text-gray-400">CAS Number</dt>
                    <dd className="text-sm text-gray-900 dark:text-gray-100 font-mono">
                      {coshh.casNumber || '-'}
                    </dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-sm text-gray-500 dark:text-gray-400">Activity</dt>
                    <dd className="text-sm text-gray-900 dark:text-gray-100">{coshh.activity}</dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-sm text-gray-500 dark:text-gray-400">Location</dt>
                    <dd className="text-sm text-gray-900 dark:text-gray-100">{coshh.location}</dd>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <dd>
                      <span
                        className={`text-xs font-medium px-2 py-1 rounded-full ${coshh.status === 'APPROVED' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : coshh.status === 'DRAFT' ? 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400' : 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300'}`}
                      >
                        {coshh.status?.replace('_', ' ')}
                      </span>
                    </dd>
                  </div>
                </dl>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <dl className="space-y-3">
                  <div className="flex justify-between">
                    <dt className="text-sm text-gray-500 dark:text-gray-400">Persons Exposed</dt>
                    <dd className="text-sm text-gray-900 dark:text-gray-100">
                      {coshh.personsExposed}
                    </dd>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div>
                    ...
                    <dd className="flex flex-wrap gap-1">
                      {(coshh.exposureRoutes || []).map((r) => (
                        <span
                          key={r}
                          className="text-xs px-2 py-1 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 rounded"
                        >
                          {r}
                        </span>
                      ))}
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                      {coshh.inherentRiskScore}
                    </p>
                  </div>
                  <span
                    className={`text-sm font-medium px-3 py-1.5 rounded-lg ${getRiskColor(coshh.inherentRiskLevel)}`}
                  >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Score</p>
                    <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                      {coshh.residualRiskScore}
                    </p>
                  </div>
                  <span
                    className={`text-sm font-medium px-3 py-1.5 rounded-lg ${getRiskColor(coshh.residualRiskLevel)}`}
                  >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-500 dark:text-gray-400">Severity</span>
                    <span className="text-gray-900 dark:text-gray-100">
                      {coshh.residualSeverity}/5
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500 dark:text-gray-400">Likelihood</span>
                    <span className="text-gray-900 dark:text-gray-100">
                      {coshh.residualLikelihood}/5
                    </span>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {(coshh.controls || []).map((c, i) => (
                        ...
                        >
                          <span className="flex items-center justify-center w-5 h-5 rounded-full bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-xs font-bold">
                            {i + 1}
                          </span>
                          {c}
                        </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(coshh.ppeRequired || []).map((ppe) => (
                        <span
                          key={ppe}
                          className="text-xs px-2 py-1 bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 border border-orange-200 dark:border-orange-800 rounded"
                        >
                          {ppe}
                        </span>
                      ))}
            ...
            <Card className="md:col-span-2">
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    <p className="text-gray-500 dark:text-gray-400">Assessor</p>
                    <p className="font-medium text-gray-900 dark:text-gray-100">
                      {coshh.assessorName || '-'}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-500 dark:text-gray-400">Approver</p>
                    <p className="font-medium text-gray-900 dark:text-gray-100">
                      {coshh.approverName || '-'}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-gray-100">
                      {coshh.createdAt ? new Date(coshh.createdAt).toLocaleDateString() : '-'}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-500 dark:text-gray-400">Review Date</p>
                    <p
                      className={`font-medium ${coshh.reviewDate && new Date(coshh.reviewDate) < new Date() ? 'text-red-600' : 'text-gray-900 dark:text-gray-100'}`}
                    >
                      {coshh.reviewDate ? new Date(coshh.reviewDate).toLocaleDateString() : '-'}
                    </p>
                  </div>
                </div>
              </CardContent>
