...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    collapsible: true,
    items: [
      { name: 'Chemical Register', href: '/register', icon: FlaskConical },
      { name: 'SDS Library', href: '/sds', icon: FileText },
    ],
  },
  {
    title: 'Risk Assessment (Cl. 6.1)',
    clause: '6.1',
    collapsible: true,
    items: [
      { name: 'COSHH Assessments', href: '/coshh', icon: ShieldAlert },
      { name: 'Exposure Monitoring', href: '/monitoring', icon: Beaker },
    ],
  },
  {
    ...
    collapsible: true,
    items: [
      { name: 'Chemical Inventory', href: '/inventory', icon: Warehouse },
      { name: 'Disposal Records', href: '/disposal', icon: Trash2 },
    ],
  },
  {
    title: 'Incidents',
