        ...
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-500 mt-1">Manage customer accounts and service history</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Inactive', value: stats.inactive, icon: Globe, bg: 'bg-gray-50', color: 'text-gray-600', border: 'border-gray-200' },
                    ...
                    <tbody>
                      {filtered.map(item => (
                        <tr key={item.id} className="border-b hover:bg-sky-50 transition-colors">
                          <td className="py-3 px-4 font-medium text-gray-900">{item.name || item.companyName || '-'}</td>
                          ...
                          <td className="py-3 px-4">
                            <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${item.status === 'ACTIVE' ? 'bg-green-100 text-green-700' : item.status === 'INACTIVE' ? 'bg-gray-100 text-gray-600' : 'bg-red-100 text-red-700'}`}>
                              {item.status || '-'}
                            </span>
                          </td>
                          <td className="py-3 px-4">
