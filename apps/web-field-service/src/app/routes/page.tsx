...
export default function RoutesPage() {
  ...
  const openEdit = (item: ServiceRoute) => {
    ...
    setForm({
      ...
      stops: item.stops || item.stopCount || '',
  ...
  const handleDelete = async () => {
    ...
    try {
      await api.delete(`/routes/${deleteItem.id}`);
      setDeleteItem(null);
      await load();
    } catch (e) {
      console.error(e);
  ...
  return (
    <div className="flex min-h-screen">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">
                Plan and optimize service routes
              </p>
            </div>
            <button
              onClick={openCreate}
      ...
      <Modal
        ...
        title={editItem ? 'Edit Route' : 'Plan Route'}
        size="lg"
      >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <input
                ...
                placeholder="e.g. North Industrial Route"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                rows={2}
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500"
                placeholder="Route instructions or notes..."
              />
            </div>
          </div>
        </div>
      ...
      >
        <p className="text-sm text-gray-600">
          ...
          <span className="font-semibold">{deleteItem?.name}</span>? This action cannot be undone.
        </p>
        <ModalFooter>
          <button
