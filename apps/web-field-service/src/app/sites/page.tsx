...
export default function SitesPage() {
  ...
  const filtered = items.filter((i) => {
    ...
    return (!q || JSON.stringify(i).toLowerCase().includes(q)) && (!typeFilter || t === typeFilter);
  });
  ...
  const openEdit = (item: Site) => {
    ...
    setForm({
      ...
      type: item.type || item.siteType || 'COMMERCIAL',
  ...
  const handleDelete = async () => {
    ...
    try {
      await api.delete(`/sites/${deleteItem.id}`);
      setDeleteItem(null);
      await load();
    } catch (e) {
      console.error(e);
  ...
  return (
    <div className="flex min-h-screen">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">
                Service locations and site details
              </p>
            </div>
            <button
              onClick={openCreate}
      ...
      <Modal
        ...
        title={editItem ? 'Edit Site' : 'Add Site'}
        size="lg"
      >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <input
                ...
                placeholder="e.g. Unit 5, Industrial Park"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
