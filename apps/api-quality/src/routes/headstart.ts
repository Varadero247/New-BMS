...
const STANDARD_TEMPLATES: Record<
  string,
  {
    name: string;
...
> = {
  ISO_9001: {
    ...
    clauses: [
      ...
      },
      {
        ...
        description: 'Define the boundaries and applicability of the QMS',
      },
      {
        number: '4.4',
      ...
      },
      {
        ...
        description: 'Establish, implement and maintain a quality policy',
      },
      {
        number: '5.3',
        title: 'Organisational roles, responsibilities and authorities',
        description: 'Assign and communicate roles and responsibilities',
      },
      {
        number: '6.1',
        title: 'Actions to address risks and opportunities',
        description: 'Determine risks and opportunities and plan actions',
      },
      {
        number: '6.2',
        title: 'Quality objectives and planning',
        description: 'Establish quality objectives at relevant functions and levels',
      },
      {
        number: '6.3',
        title: 'Planning of changes',
        description: 'Plan changes to the QMS in a systematic manner',
      },
      {
        number: '7.1',
        title: 'Resources',
        description: 'Determine and provide resources needed for the QMS',
      },
      {
        number: '7.2',
        title: 'Competence',
        description: 'Determine necessary competence and ensure training',
      },
      {
        number: '7.3',
        title: 'Awareness',
        description: 'Ensure persons are aware of quality policy and objectives',
      },
      {
        number: '7.4',
        title: 'Communication',
      ...
      },
      {
        ...
        description: 'Control documented information required by the QMS',
      },
      {
        number: '8.1',
        title: 'Operational planning and control',
        description: 'Plan, implement and control processes needed',
      },
      {
        number: '8.2',
      ...
      },
      {
        ...
        description: 'Ensure externally provided processes conform to requirements',
      },
      {
        number: '8.5',
      ...
      },
      {
        ...
        description: 'Review the QMS at planned intervals',
      },
      {
        number: '10.1',
      ...
      },
      {
        ...
        description: 'Continually improve the QMS',
      },
    ],
    documents: [
      {
        ...
        clause: '4.4',
        description: 'Overview of QMS scope, processes, and interactions',
      },
      {
        title: 'Quality Policy',
        clause: '5.2',
        description: 'Signed quality policy statement from top management',
      },
      {
        title: 'Context of the Organisation',
        clause: '4.1',
        description: 'SWOT analysis and external/internal issues',
      },
      {
        title: 'Interested Parties Register',
        clause: '4.2',
        description: 'Register of interested parties and their requirements',
      },
      {
        title: 'QMS Scope Statement',
        clause: '4.3',
        description: 'Defined scope with justification for exclusions',
      },
      {
        title: 'Process Interaction Map',
        clause: '4.4',
        description: 'Turtle diagram or SIPOC for key processes',
      },
      {
        title: 'Organisational Chart',
        clause: '5.3',
        description: 'Roles, responsibilities and authorities',
      },
      {
        title: 'Risk and Opportunity Register',
        clause: '6.1',
        description: 'Risk assessment with treatment plans',
      },
      {
        title: 'Quality Objectives',
        clause: '6.2',
        description: 'SMART objectives with measurement plans',
      },
      {
        title: 'Competency Matrix',
        clause: '7.2',
        description: 'Skills matrix with training records',
      },
      {
        title: 'Document Control Procedure',
        clause: '7.5',
        description: 'Procedure for creating, reviewing and approving documents',
      },
      {
        title: 'Supplier Evaluation Procedure',
        clause: '8.4',
        description: 'Criteria for selecting and evaluating suppliers',
      },
      {
        title: 'NCR Procedure',
        clause: '8.7',
        description: 'Procedure for handling nonconforming products/services',
      },
      {
        title: 'Internal Audit Procedure',
        clause: '9.2',
        description: 'Procedure for planning and conducting internal audits',
      },
      {
        title: 'Management Review Procedure',
        clause: '9.3',
        description: 'Agenda and minutes template for management review',
      },
      {
    ...
    risks: [
      {
        title: 'Customer requirements not fully understood',
        clause: '8.2',
        likelihood: 3,
        impact: 4,
      ...
      {
        title: 'Supplier delivers nonconforming material',
        clause: '8.4',
        likelihood: 3,
        impact: 3,
      ...
      {
        title: 'Key person dependency for critical processes',
        clause: '7.2',
        likelihood: 2,
        impact: 4,
        category: 'PEOPLE',
      ...
      {
        title: 'Inadequate calibration of measurement equipment',
        clause: '7.1.5',
        likelihood: 2,
        impact: 4,
        category: 'EQUIPMENT',
      ...
      {
        title: 'Document control failure — obsolete documents in use',
        clause: '7.5',
        likelihood: 2,
        impact: 3,
        category: 'SYSTEM',
      ...
      {
        title: 'Loss of customer due to quality failures',
        clause: '9.1.2',
        likelihood: 2,
        impact: 5,
        category: 'STRATEGIC',
    ...
    objectives: [
      {
        title: 'Customer satisfaction score ≥ 85%',
        clause: '9.1.2',
        target: '≥ 85%',
        frequency: 'QUARTERLY',
      },
      ...
      {
        title: 'Supplier on-time delivery ≥ 95%',
        clause: '8.4',
        target: '≥ 95%',
        frequency: 'MONTHLY',
      },
      {
        title: 'CAPA closure within 30 days ≥ 90%',
        clause: '10.1',
        target: '≥ 90%',
        frequency: 'MONTHLY',
      },
      {
        title: 'Internal audit programme 100% complete',
        clause: '9.2',
        target: '100%',
        frequency: 'ANNUAL',
      },
      {
        title: 'Training plan completion ≥ 95%',
        clause: '7.2',
        target: '≥ 95%',
        frequency: 'QUARTERLY',
      },
  ...
  ISO_14001: {
    ...
    clauses: [
      {
        number: '4.1',
        title: 'Understanding the organisation and its context',
        description: 'Determine environmental conditions and external/internal issues',
      },
      {
        number: '4.2',
        title: 'Understanding needs and expectations of interested parties',
        description: 'Identify interested parties relevant to the EMS',
      },
      {
        number: '4.3',
        title: 'Determining the scope of the EMS',
        description: 'Define boundaries considering environmental aspects',
      },
      {
        number: '4.4',
        title: 'Environmental management system',
        description: 'Establish, implement, maintain and improve the EMS',
      },
      {
        number: '5.1',
        title: 'Leadership and commitment',
        description: 'Top management environmental leadership',
      },
      {
        number: '5.2',
        title: 'Environmental policy',
        description: 'Establish environmental policy with commitments',
      },
      {
        number: '6.1',
        title: 'Actions to address risks, opportunities and environmental aspects',
        description: 'Determine significant environmental aspects and compliance obligations',
      },
      {
        number: '6.2',
        title: 'Environmental objectives and planning',
        description: 'Establish measurable environmental objectives',
      },
      ...
      { number: '7.2', title: 'Competence', description: 'Ensure environmental competence' },
      {
        number: '7.5',
        title: 'Documented information',
        description: 'Control EMS documented information',
      },
      {
        number: '8.1',
        title: 'Operational planning and control',
        description: 'Plan and control operations for significant aspects',
      },
      {
        number: '8.2',
        title: 'Emergency preparedness and response',
        description: 'Prepare for and respond to environmental emergencies',
      },
      {
        number: '9.1',
        title: 'Monitoring, measurement, analysis and evaluation',
      ...
      { number: '9.3', title: 'Management review', description: 'Review EMS at planned intervals' },
      {
        number: '10.1',
        title: 'Nonconformity and corrective action',
        description: 'Address EMS nonconformities',
      },
    ...
    documents: [
      {
        title: 'Environmental Policy',
        clause: '5.2',
        description: 'Signed environmental policy with pollution prevention commitment',
      },
      {
        title: 'Environmental Aspects & Impacts Register',
        clause: '6.1.2',
        description: 'Significance scoring matrix for all aspects',
      },
      {
        title: 'Legal & Compliance Obligations Register',
        clause: '6.1.3',
        description: 'Environmental legislation and permits',
      },
      {
        title: 'Environmental Objectives & Targets',
        clause: '6.2',
        description: 'Measurable targets with action plans',
      },
      {
        title: 'Emergency Response Plan',
        clause: '8.2',
        description: 'Spill response, fire, chemical release procedures',
      },
      {
        title: 'Waste Management Procedure',
        clause: '8.1',
        description: 'Waste segregation, storage, disposal and duty of care',
      },
      {
        title: 'Environmental Monitoring Procedure',
        clause: '9.1',
        description: 'Monitoring schedule for emissions, discharges, waste',
      },
    ],
    risks: [
      {
        title: 'Chemical spill to watercourse',
        clause: '8.2',
        likelihood: 2,
        impact: 5,
      ...
      {
        title: 'Breach of environmental permit conditions',
        clause: '6.1.3',
        likelihood: 2,
        impact: 4,
        category: 'COMPLIANCE',
      ...
      {
        title: 'Uncontrolled waste disposal by contractor',
        clause: '8.1',
        likelihood: 3,
        impact: 3,
        category: 'SUPPLY_CHAIN',
    ...
    objectives: [
      {
        title: 'Reduce carbon emissions by 10% year-on-year',
        clause: '6.2',
        target: '10% reduction',
        frequency: 'ANNUAL',
      },
      {
        title: 'Zero environmental permit breaches',
        clause: '6.1.3',
        target: '0 breaches',
        frequency: 'ANNUAL',
      },
      {
        title: 'Waste recycling rate ≥ 80%',
        clause: '8.1',
        target: '≥ 80%',
        frequency: 'QUARTERLY',
      },
      {
        title: 'Environmental training completion 100%',
        clause: '7.2',
        target: '100%',
        frequency: 'ANNUAL',
      },
    ...
    auditSchedule: [
      {
        area: 'Environmental Aspects & Legal Compliance',
        clause: '6.1',
        frequency: 'SEMI_ANNUAL',
        month: 2,
      },
      {
        area: 'Operational Controls & Emergency Response',
        clause: '8',
        frequency: 'ANNUAL',
        month: 5,
      },
  ...
  ISO_45001: {
    ...
    clauses: [
      {
        number: '4.1',
        title: 'Understanding the organisation and its context',
        description: 'Determine OH&S issues and conditions',
      },
      {
        number: '4.2',
        title: 'Understanding needs and expectations of workers and interested parties',
        description: 'Consult with workers on OH&S matters',
      },
      {
        number: '4.3',
        title: 'Determining the scope of the OH&S MS',
        description: 'Define OH&S management system scope',
      },
      {
        number: '5.1',
        title: 'Leadership, commitment and worker participation',
        description: 'Top management OH&S leadership and worker consultation',
      },
      {
        number: '5.2',
        title: 'OH&S policy',
        description: 'Establish OH&S policy with commitments',
      },
      {
        number: '6.1',
        title: 'Actions to address risks and opportunities',
        description: 'Hazard identification, risk assessment, legal requirements',
      },
      {
        number: '6.2',
        title: 'OH&S objectives and planning',
        description: 'Establish measurable OH&S objectives',
      },
      ...
      {
        number: '7.4',
        title: 'Communication, participation and consultation',
        description: 'Internal and external OH&S communications',
      },
      {
        number: '8.1',
        title: 'Operational planning and control',
        description: 'Hierarchy of controls implementation',
      },
      {
        number: '8.2',
        title: 'Emergency preparedness and response',
        description: 'Emergency plans including first aid and evacuation',
      },
      {
        number: '9.1',
        title: 'Monitoring, measurement, analysis and evaluation',
        description: 'Monitor OH&S performance indicators',
      },
      { number: '9.2', title: 'Internal audit', description: 'Conduct OH&S internal audits' },
      {
        number: '9.3',
        title: 'Management review',
        description: 'Review OH&S MS at planned intervals',
      },
      {
        number: '10.1',
        title: 'Incident investigation',
        description: 'Investigate incidents and determine root causes',
      },
      {
        number: '10.2',
        title: 'Nonconformity and corrective action',
        description: 'Address OH&S nonconformities',
      },
      {
        number: '10.3',
        title: 'Continual improvement',
        description: 'Continually improve OH&S MS',
      },
    ],
    documents: [
      { title: 'OH&S Policy', clause: '5.2', description: 'Signed health & safety policy' },
      {
        title: 'Hazard Identification & Risk Assessment Register',
        clause: '6.1.2',
        description: 'HIRA with hierarchy of controls',
      },
      {
        title: 'Legal Requirements Register',
        clause: '6.1.3',
        description: 'OH&S legislation and regulations',
      },
      {
        title: 'Emergency Response Plan',
        clause: '8.2',
        description: 'Fire, evacuation, first aid, chemical spill procedures',
      },
      {
        title: 'Incident Investigation Procedure',
        clause: '10.1',
        description: 'Procedure for reporting and investigating incidents',
      },
      {
        title: 'Safety Committee Terms of Reference',
        clause: '5.4',
        description: 'Worker participation and consultation arrangements',
      },
      {
        title: 'Permit to Work Procedure',
        clause: '8.1',
        description: 'Hot work, confined space, working at height',
      },
    ],
    risks: [
      {
        title: 'Slip, trip and fall injuries',
        clause: '6.1.2',
        likelihood: 3,
        impact: 3,
        category: 'PHYSICAL',
    ...
    objectives: [
      ...
      {
        title: 'Zero RIDDOR reportable incidents',
        clause: '9.1',
        target: '0',
        frequency: 'ANNUAL',
      },
      {
        title: 'Safety training completion 100%',
        clause: '7.2',
        target: '100%',
        frequency: 'QUARTERLY',
      },
      {
        title: 'Near-miss reporting rate ≥ 5 per month',
        clause: '10.1',
        target: '≥ 5/month',
        frequency: 'MONTHLY',
      },
      {
        title: 'Risk assessment review 100% complete',
        clause: '6.1.2',
        target: '100%',
        frequency: 'ANNUAL',
      },
  ...
  ISO_27001: {
    ...
    clauses: [
      {
        number: '4.1',
        title: 'Understanding the organisation and its context',
        description: 'ISMS context and information security issues',
      },
      {
        number: '4.2',
        title: 'Understanding needs and expectations of interested parties',
        description: 'Determine ISMS interested parties',
      },
      {
        number: '4.3',
        title: 'Determining the scope of the ISMS',
        description: 'Define ISMS boundaries',
      },
      {
        number: '5.1',
        title: 'Leadership and commitment',
        description: 'Top management information security leadership',
      },
      {
        number: '5.2',
      ...
      },
      {
        number: '6.1',
        title: 'Actions to address risks and opportunities',
        description: 'Information security risk assessment methodology',
      },
      {
        number: '6.2',
        title: 'Information security objectives',
        description: 'Establish ISMS objectives',
      },
      { number: '7.1', title: 'Resources', description: 'Determine and provide ISMS resources' },
      {
        number: '7.2',
        title: 'Competence',
        description: 'Information security competence and awareness',
      },
      {
        number: '7.5',
        title: 'Documented information',
        description: 'ISMS documented information control',
      },
      {
        number: '8.1',
        title: 'Operational planning and control',
        description: 'Implement information security risk treatment plan',
      },
      {
        number: '8.2',
      ...
      },
      {
        number: '9.1',
        title: 'Monitoring, measurement, analysis and evaluation',
        description: 'Monitor ISMS effectiveness',
      },
      ...
      },
      {
        number: '10.1',
        title: 'Continual improvement',
        description: 'Continually improve the ISMS',
      },
      {
        number: '10.2',
        title: 'Nonconformity and corrective action',
        description: 'Address ISMS nonconformities',
      },
    ],
    documents: [
      {
      ...
      },
      {
        ...
        clause: '4.3',
        description: 'Boundaries and applicability of the ISMS',
      },
      {
        title: 'Risk Assessment Methodology',
        clause: '6.1.2',
        description: 'Asset-threat-vulnerability model with 5x5 matrix',
      },
      {
        title: 'Statement of Applicability (SoA)',
        clause: '6.1.3',
        description: 'All 93 Annex A controls with justification',
      },
      {
        title: 'Information Asset Register',
        clause: 'A.5',
        description: 'Classified information assets with owners',
      },
      {
      ...
      },
      {
        ...
        clause: 'A.5.24',
        description: 'Security incident management and GDPR notification',
      },
      {
      ...
      },
      {
        ...
        clause: 'A.5.10',
        description: 'Acceptable use of information and assets',
      },
    ],
    risks: [
      {
        title: 'Ransomware attack encrypts critical data',
        clause: '8.2',
        likelihood: 3,
        impact: 5,
        category: 'CYBER',
      ...
      {
        title: 'Phishing attack compromises user credentials',
        clause: '8.2',
        likelihood: 4,
        impact: 3,
        category: 'CYBER',
      ...
      {
        title: 'Third-party data breach via supply chain',
        clause: '8.2',
        likelihood: 3,
        impact: 4,
        category: 'SUPPLY_CHAIN',
      ...
      {
        title: 'Loss of availability — system outage',
        clause: '8.2',
        likelihood: 3,
        impact: 3,
        category: 'TECHNICAL',
    ...
    objectives: [
      ...
      {
        title: 'Security awareness training 100% complete',
        clause: '7.2',
        target: '100%',
        frequency: 'ANNUAL',
      },
      {
        title: 'Vulnerability remediation SLA ≤ 30 days (critical)',
        clause: '9.1',
        target: '≤ 30 days',
        frequency: 'MONTHLY',
      },
      {
        title: 'ISMS internal audit programme 100% complete',
        clause: '9.2',
        target: '100%',
        frequency: 'ANNUAL',
      },
    ...
    auditSchedule: [
      {
        area: 'Access Control & Authentication (A.8)',
        clause: 'A.8',
        frequency: 'SEMI_ANNUAL',
        month: 2,
      },
  ...
  ISO_22000: {
    ...
    clauses: [
      {
        number: '4.1',
        title: 'Understanding the organisation and its context',
        description: 'Food safety context and issues',
      },
      {
        number: '5.1',
        title: 'Leadership and commitment',
        description: 'Top management food safety commitment',
      },
      { number: '5.2', title: 'Food safety policy', description: 'Establish food safety policy' },
      {
        number: '6.1',
        title: 'Actions to address risks and opportunities',
        description: 'Food safety risks and PRPs',
      },
      {
        number: '7.1',
        title: 'Resources',
        description: 'Food safety resources including infrastructure and work environment',
      },
      {
        number: '8.1',
        title: 'Operational planning and control',
        description: 'PRPs, traceability, emergency preparedness',
      },
      {
        number: '8.2',
        title: 'Prerequisite programmes (PRPs)',
        description: 'Cleaning, pest control, personal hygiene',
      },
      {
        number: '8.5',
        title: 'Hazard analysis',
        description: 'HACCP 7 principles — hazard identification and CCP determination',
      },
      {
        number: '8.8',
        title: 'Verification planning',
        description: 'Verify HACCP plan and PRPs are effective',
      },
      {
        number: '9.1',
        title: 'Monitoring, measurement, analysis and evaluation',
        description: 'Food safety performance monitoring',
      },
      {
        number: '9.2',
        title: 'Internal audit',
        description: 'Conduct food safety internal audits',
      },
      {
        number: '9.3',
        title: 'Management review',
        description: 'Review FSMS at planned intervals',
      },
      {
        number: '10.1',
        title: 'Nonconformity and corrective action',
        description: 'Address food safety nonconformities',
      },
    ],
    documents: [
      {
        ...
        clause: '5.2',
        description: 'Food safety policy and objectives',
      },
      {
        title: 'HACCP Plan',
        clause: '8.5',
        description: 'Hazard analysis, CCPs, critical limits, monitoring',
      },
      {
        title: 'PRP Manual',
        clause: '8.2',
        description: 'Prerequisite programmes for food safety',
      },
      {
        title: 'Allergen Management Procedure',
        clause: '8.5',
        description: 'Allergen identification and control',
      },
      {
        title: 'Traceability Procedure',
        clause: '8.3',
        description: 'Forward and backward traceability',
      },
      {
        title: 'Product Recall Procedure',
        clause: '8.4',
        description: 'Recall and withdrawal procedures',
      },
    ],
    risks: [
      {
      ...
      {
        title: 'Foreign body contamination',
        clause: '8.5',
        likelihood: 2,
        impact: 5,
        category: 'PHYSICAL',
      ...
      {
        title: 'Pathogen growth due to temperature abuse',
        clause: '8.5',
        likelihood: 3,
        impact: 5,
        category: 'BIOLOGICAL',
      ...
      {
        title: 'Chemical contamination from cleaning agents',
        clause: '8.2',
        likelihood: 2,
        impact: 4,
        category: 'CHEMICAL',
    ...
    objectives: [
      ...
      {
        title: 'CCP monitoring compliance 100%',
        clause: '8.5',
        target: '100%',
        frequency: 'DAILY',
      },
      {
        title: 'Food safety audit score ≥ AA (BRC)',
        clause: '9.2',
        target: '≥ AA',
        frequency: 'ANNUAL',
      },
  ...
  ISO_50001: {
    ...
    clauses: [
      {
        number: '4.1',
        title: 'Understanding the organisation and its context',
        description: 'Energy context and issues',
      },
      {
        number: '5.1',
        title: 'Leadership and commitment',
        description: 'Top management energy management commitment',
      },
      { number: '5.2', title: 'Energy policy', description: 'Establish energy policy' },
      {
        number: '6.1',
        title: 'Actions to address risks and opportunities',
        description: 'Energy risks and opportunities',
      },
      {
        number: '6.2',
        title: 'Energy objectives, targets and action plans',
        description: 'Establish energy performance targets',
      },
      { number: '6.3', title: 'Energy review', description: 'Analyse energy use and consumption' },
      {
        number: '6.4',
        title: 'Energy performance indicators (EnPIs)',
        description: 'Establish and monitor EnPIs',
      },
      { number: '6.5', title: 'Energy baseline (EnB)', description: 'Establish energy baselines' },
      {
        number: '6.6',
        title: 'Planning for collection of energy data',
        description: 'Data collection plan for energy management',
      },
      {
        number: '8.1',
        title: 'Operational planning and control',
        description: 'Control significant energy uses',
      },
      ...
      { number: '8.3', title: 'Procurement', description: 'Energy performance in procurement' },
      {
        number: '9.1',
        title: 'Monitoring, measurement, analysis and evaluation',
        description: 'Monitor energy performance',
      },
      { number: '9.2', title: 'Internal audit', description: 'Conduct EnMS internal audits' },
      {
        number: '9.3',
        title: 'Management review',
        description: 'Review EnMS at planned intervals',
      },
    ],
    documents: [
      {
        title: 'Energy Policy',
        clause: '5.2',
        description: 'Energy policy with commitment to improve energy performance',
      },
      {
        title: 'Energy Review Report',
        clause: '6.3',
        description: 'Analysis of energy use, consumption and efficiency',
      },
      {
        title: 'Significant Energy Use (SEU) Register',
        clause: '6.3',
        description: 'Equipment/processes with significant energy use',
      },
      {
        title: 'EnPI & Baseline Documentation',
        clause: '6.4',
        description: 'Energy performance indicators and baselines',
      },
    ],
    risks: [
      {
      ...
      {
        title: 'Non-compliance with ESOS regulations',
        clause: '6.1',
        likelihood: 2,
        impact: 4,
        category: 'COMPLIANCE',
      ...
      {
        title: 'Equipment efficiency degradation',
        clause: '8.1',
        likelihood: 3,
        impact: 3,
        category: 'OPERATIONAL',
    ...
    objectives: [
      {
        title: 'Reduce energy intensity by 5% year-on-year',
        clause: '6.2',
        target: '5% reduction',
        frequency: 'ANNUAL',
      },
      {
        title: 'EnPI improvement for top 3 SEUs',
        clause: '6.4',
    ...
    auditSchedule: [
      ...
      {
        area: 'EnPI Monitoring & Baselines',
        clause: '6.4-6.5',
        frequency: 'SEMI_ANNUAL',
        month: 5,
      },
  ...
  ISO_42001: {
    ...
    clauses: [
      {
        number: '4.1',
        title: 'Understanding the organisation and its context',
        description: 'AI context, stakeholders and regulatory landscape',
      },
      {
        number: '4.2',
        title: 'Understanding needs and expectations of interested parties',
        description: 'AI stakeholders and their concerns',
      },
      {
        number: '5.1',
        title: 'Leadership and commitment',
        description: 'Top management AI governance leadership',
      },
      { number: '5.2', title: 'AI policy', description: 'Establish responsible AI policy' },
      {
        number: '6.1',
        title: 'Actions to address risks and opportunities',
        description: 'AI-specific risks including bias, safety, privacy',
      },
      {
        number: '6.2',
        title: 'AIMS objectives',
        description: 'Establish AI management objectives',
      },
      ...
      },
      {
        number: '9.1',
        title: 'Monitoring, measurement, analysis and evaluation',
        description: 'Monitor AI system performance and fairness',
      },
      { number: '9.2', title: 'Internal audit', description: 'Conduct AIMS internal audits' },
      {
        number: '10.1',
        title: 'Nonconformity and corrective action',
        description: 'Address AI incidents and nonconformities',
      },
    ],
    documents: [
      {
        title: 'AI Policy',
        clause: '5.2',
        description: 'Responsible AI use policy with ethical principles',
      },
      {
        title: 'AI System Register',
        clause: '8.1',
        description: 'Inventory of all AI systems in use',
      },
      {
        title: 'AI Risk Assessment Framework',
        clause: '6.1',
        description: 'AI-specific risk categories and assessment',
      },
      {
        title: 'AI Impact Assessment Template',
        clause: '8.1',
        description: 'For high-risk AI per EU AI Act classification',
      },
    ],
    risks: [
      {
        title: 'AI bias in decision-making outputs',
        clause: '6.1',
        likelihood: 3,
        impact: 4,
        category: 'ETHICAL',
      ...
      {
        title: 'AI hallucination providing incorrect compliance advice',
        clause: '6.1',
        likelihood: 3,
        impact: 4,
        category: 'ACCURACY',
      ...
      {
        title: 'Privacy violation through AI data processing',
        clause: '6.1',
        likelihood: 2,
        impact: 5,
        category: 'PRIVACY',
      ...
      {
        title: 'Non-compliance with EU AI Act',
        clause: '6.1',
        likelihood: 2,
        impact: 4,
        category: 'REGULATORY',
    ...
    objectives: [
      {
        title: 'AI incident response time ≤ 4 hours',
        clause: '10.1',
        target: '≤ 4 hours',
        frequency: 'MONTHLY',
      },
      {
        title: 'AI system register 100% complete',
        clause: '8.1',
        target: '100%',
        frequency: 'QUARTERLY',
      },
      {
        title: 'AI ethics training completion 100%',
        clause: '7.2',
        target: '100%',
        frequency: 'ANNUAL',
      },
    ...
    auditSchedule: [
      {
        area: 'AI System Inventory & Risk Assessment',
        clause: '6.1,8.1',
        frequency: 'SEMI_ANNUAL',
        month: 3,
      },
  ...
  ISO_37001: {
    ...
    clauses: [
      {
        number: '4.1',
        title: 'Understanding the organisation and its context',
        description: 'Bribery risk context',
      },
      {
        number: '4.5',
        title: 'Bribery risk assessment',
        description: 'Assess bribery risks for functions and categories',
      },
      {
        number: '5.1',
        title: 'Leadership and commitment',
        description: 'Top management anti-bribery commitment',
      },
      { number: '5.2', title: 'Anti-bribery policy', description: 'Establish anti-bribery policy' },
      {
        number: '5.3',
        title: 'Anti-bribery compliance function',
        description: 'Appoint compliance officer',
      },
      { number: '7.2', title: 'Competence', description: 'Anti-bribery competence and training' },
      {
        number: '7.3',
        title: 'Awareness',
        description: 'Anti-bribery awareness for all personnel',
      },
      {
        number: '8.1',
        title: 'Operational planning and control',
        description: 'Anti-bribery controls and due diligence',
      },
      {
        number: '8.2',
        title: 'Due diligence',
        description: 'Due diligence on business associates',
      },
      {
        number: '8.7',
        title: 'Gifts, hospitality and donations',
        description: 'Controls on gifts and hospitality',
      },
      ...
      },
      {
        number: '9.1',
        title: 'Monitoring, measurement, analysis and evaluation',
        description: 'Monitor anti-bribery performance',
      },
      { number: '9.2', title: 'Internal audit', description: 'Conduct ABMS internal audits' },
      {
        number: '10.1',
        title: 'Nonconformity and corrective action',
        description: 'Address ABMS nonconformities',
      },
    ],
    documents: [
      {
        ...
        clause: '5.2',
        description: 'Zero-tolerance anti-bribery policy',
      },
      {
        title: 'Due Diligence Procedure',
        clause: '8.2',
        description: 'Third-party due diligence assessment',
      },
      {
        title: 'Gifts & Hospitality Register',
        clause: '8.7',
        description: 'Register for recording and approving gifts',
      },
      {
        title: 'Whistleblowing Procedure',
        clause: '8.9',
        description: 'Confidential reporting mechanism',
      },
      {
        title: 'Bribery Risk Assessment',
        clause: '4.5',
        description: 'Assessment by function and jurisdiction',
      },
    ],
    risks: [
      {
        title: 'Facilitation payments in high-risk jurisdictions',
        clause: '4.5',
        likelihood: 3,
        impact: 5,
        category: 'BRIBERY',
      ...
      {
        title: 'Gifts/hospitality exceeding thresholds',
        clause: '8.7',
        likelihood: 3,
        impact: 3,
        category: 'GIFTS',
      ...
      {
        title: 'Third-party agent bribery on behalf of organisation',
        clause: '8.2',
        likelihood: 2,
        impact: 5,
        category: 'SUPPLY_CHAIN',
      ...
      {
        title: 'Failure to report suspected bribery',
        clause: '8.9',
        likelihood: 2,
        impact: 4,
        category: 'GOVERNANCE',
    ...
    objectives: [
      {
        title: 'Anti-bribery training completion 100%',
        clause: '7.2',
        target: '100%',
        frequency: 'ANNUAL',
      },
      {
        title: 'Due diligence completion for all high-risk third parties',
        clause: '8.2',
        target: '100%',
        frequency: 'QUARTERLY',
      },
      {
        title: 'Gifts register 100% up to date',
        clause: '8.7',
        target: '100%',
        frequency: 'MONTHLY',
      },
    ...
    auditSchedule: [
      ...
      {
        area: 'Whistleblowing & Investigations',
        clause: '8.9-8.10',
        frequency: 'ANNUAL',
        month: 11,
      },
    ...
    legalRegister: [
      ...
      {
        title: 'UAE Federal Decree-Law No. 20/2018 on Anti-Money Laundering',
        jurisdiction: 'UAE',
        clause: '6.1.3',
      },
    ],
...
const INDUSTRY_RISKS: Record<
  string,
  { title: string; clause: string; likelihood: number; impact: number; category: string }[]
> = {
  MANUFACTURING: [
    {
      title: 'Production line stoppage due to quality failure',
      clause: '8.1',
      likelihood: 3,
      impact: 4,
      category: 'OPERATIONAL',
    ...
    {
      title: 'Raw material supply disruption',
      clause: '8.4',
      likelihood: 3,
      impact: 4,
      category: 'SUPPLY_CHAIN',
  ...
  FOOD_BEVERAGE: [
    {
      title: 'Food safety incident requiring recall',
      clause: '8.1',
      likelihood: 2,
      impact: 5,
    ...
    {
      title: 'Allergen labelling error',
      clause: '8.5',
      likelihood: 3,
      impact: 5,
      category: 'LABELLING',
  ...
  CONSTRUCTION: [
    {
      title: 'Site accident — working at height',
      clause: '8.1',
      likelihood: 3,
      impact: 5,
      category: 'SAFETY',
    ...
    {
      title: 'Building regulation non-compliance',
      clause: '6.1.3',
      likelihood: 2,
      impact: 4,
      category: 'COMPLIANCE',
...
router.get('/', scopeToUser, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Failed to list headstart assessments', {
      error: error instanceof Error ? error.message : 'Unknown error',
    });
    res.status(500).json({
      success: false,
...
router.get('/standards', async (_req, res: Response) => {
  try {
    ...
    logger.error('Failed to list headstart standards', {
      error: error instanceof Error ? error.message : 'Unknown error',
    });
    res.status(500).json({
      success: false,
      error: { code: 'INTERNAL_ERROR', message: 'Failed to list available standards' },
    });
  }
});
...
router.get('/:id', scopeToUser, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Failed to get headstart assessment', {
      error: error instanceof Error ? error.message : 'Unknown error',
    });
    res.status(500).json({
      success: false,
