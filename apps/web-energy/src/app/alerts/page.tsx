        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Consumption alerts and anomaly detection
            </p>
          </div>
          <button
            onClick={() => {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            <CardContent className="pt-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Critical Open</p>
                    ...
                    {filtered.map((item) => {
                      ...
                      return (
                        <tr key={item.id} className="border-b hover:bg-yellow-50 transition-colors">
                          ...
                          <td className="py-3 px-4">
                            <span
                              className={`inline-flex px-2 py-0.5 rounded text-xs font-bold ${severityConfig[item.severity] || 'bg-gray-100 dark:bg-gray-800 text-gray-600'}`}
                            >
                              {item.severity}
                            </span>
                          </td>
                            ...
                            <div className="flex gap-1 justify-end">
                              ...
                              {(item.status === 'OPEN' || item.status === 'ACKNOWLEDGED') && (
                                <button
                                  ...
                                  className="px-2 py-1 text-xs rounded bg-green-50 text-green-700 hover:bg-green-100 flex items-center gap-1"
                                  title="Resolve"
                                >
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. High consumption threshold exceeded"
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setEditItem((p) => ({ ...p, severity: e.target.value }))}
                className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400"
              >
                {SEVERITY_OPTIONS.map((s) => (
                  <option key={s} value={s}>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditItem((p) => ({ ...p, threshold: Number(e.target.value) }))}
                className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
            </div>
            <div>
              ...
              <input
                type="number"
                value={editItem.actualValue || ''}
                onChange={(e) =>
                  setEditItem((p) => ({ ...p, actualValue: Number(e.target.value) }))
                }
                className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
            </div>
