        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Generate, review, and manage energy performance reports — ISO 50001 §9.1
            </p>
          </div>
          <button
            onClick={openCreate}
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between">
              ...
              {(() => {
                ...
                return (
                  <span
                    className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${sc.color}`}
                  >
            ...
            <div className="grid grid-cols-2 gap-4 bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-sm">
              <div>
                ...
                <p className="text-gray-900 dark:text-gray-100 mt-0.5">
                  {formatDate(viewItem.periodStart)} – {formatDate(viewItem.periodEnd)}
                </p>
              </div>
              <div>
                <span className="text-gray-500 dark:text-gray-400 text-xs font-medium uppercase tracking-wide">
              ...
              {viewItem.generatedAt && (
                <div>
                  ...
                  <p className="text-gray-900 dark:text-gray-100 mt-0.5">
                    {formatDate(viewItem.generatedAt)}
                  </p>
                </div>
              )}
              {viewItem.scope && (
