...
const MOCK_BASELINES: Baseline[] = [
  {
    id: '1',
    name: 'Airframe Assembly Baseline',
    version: 'v4.2.0',
    status: 'current',
    createdDate: '2026-01-10',
    approvedDate: '2026-01-12',
    itemCount: 247,
    changesSinceLastBaseline: 0,
    description:
      'Current approved configuration for the main airframe assembly including all structural components and interfaces.',
    approvedBy: 'C. Rodriguez',
  },
  {
    id: '2',
    name: 'Airframe Assembly Baseline',
    ...
    itemCount: 241,
    changesSinceLastBaseline: 6,
    description:
      'Previous baseline superseded after ECR-2025-044 material substitution and ECR-2025-051 tolerance updates.',
    approvedBy: 'C. Rodriguez',
  },
  {
    id: '3',
    name: 'Avionics Software Baseline',
    version: 'v2.5.1',
    status: 'current',
    ...
    itemCount: 93,
    changesSinceLastBaseline: 0,
    description: 'Certified software configuration baseline for DO-178C Level A compliance.',
    approvedBy: 'P. Nakamura',
  },
  {
    id: '4',
    name: 'Propulsion System Baseline',
    version: 'v3.0.0',
    status: 'draft',
    createdDate: '2026-02-01',
    approvedDate: null,
    itemCount: 158,
    changesSinceLastBaseline: 14,
    description:
      'Draft baseline for updated propulsion configuration pending FAA DER review and sign-off.',
    approvedBy: null,
  },
  {
    id: '5',
    name: 'Electrical Harness Baseline',
    version: 'v1.8.3',
    status: 'current',
    ...
    changesSinceLastBaseline: 0,
    description:
      'Complete electrical harness routing and connector specification for production release.',
    approvedBy: 'M. Thompson',
  },
  {
    id: '6',
    name: 'Landing Gear System Baseline',
    version: 'v2.2.0',
    status: 'superseded',
    createdDate: '2025-07-01',
    approvedDate: '2025-07-03',
    itemCount: 87,
    changesSinceLastBaseline: 8,
    description:
      'Superseded baseline — emergency revision required after ECR-2025-089 safety assessment.',
    approvedBy: 'A. Smith',
  },
];
...
export default function BaselinesClient() {
  ...
  const counts = {
    ...
    totalItems: MOCK_BASELINES.filter((b) => b.status === 'current').reduce(
      (s, b) => s + b.itemCount,
      0
    ),
  };
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
              AS9100D Clause 8.3 — Design & Development Baselines
            </p>
          </div>
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-3xl font-bold text-blue-600 mt-1">
              {counts.totalItems.toLocaleString()}
            </p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-4 flex gap-3">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              aria-label="Search baseline name or version..."
              placeholder="Search baseline name or version..."
              value={search}
        ...
        <div className="grid grid-cols-2 gap-4">
          {filtered.map((baseline) => {
            ...
            return (
              <div
                key={baseline.id}
                className={`bg-white dark:bg-gray-900 rounded-lg border ${sc.border} overflow-hidden hover:shadow-md transition-shadow`}
              >
                <div className={`px-5 py-3 ${sc.bg} flex items-center justify-between`}>
                  ...
                  <span
                    className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${sc.bg} ${sc.text} border ${sc.border}`}
                  >
                  ...
                  <div className="grid grid-cols-3 gap-3 text-center border-t border-gray-100 dark:border-gray-700 pt-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {baseline.approvedBy ? `By ${baseline.approvedBy}` : 'Pending'}
                      </p>
                    </div>
                  </div>
                </div>
