...
const MOCK_PROCESSES: SpecialProcess[] = [
  {
    id: '1',
    processName: 'Electron Beam Welding',
    type: 'welding',
    certification: 'NADCAP',
    expiryDate: '2026-09-30',
    status: 'active',
    lastAudit: '2025-09-15',
    performedBy: 'PrecisionWeld Inc.',
    accreditationNumber: 'NADCAP-W-21045',
  },
  {
    id: '2',
    processName: 'Fluorescent Penetrant Inspection (FPI)',
    type: 'NDT',
    certification: 'NADCAP',
    expiryDate: '2026-03-31',
    status: 'expiring-soon',
    lastAudit: '2025-03-20',
    performedBy: 'AeroNDT Services',
    accreditationNumber: 'NADCAP-NDT-18932',
  },
  {
    id: '3',
    processName: 'Vacuum Heat Treatment',
    type: 'heat-treat',
    certification: 'NADCAP',
    expiryDate: '2025-12-31',
    status: 'expired',
    lastAudit: '2024-12-10',
    performedBy: 'ThermoAero LLC',
    accreditationNumber: 'NADCAP-HT-14567',
  },
  {
    id: '4',
    processName: 'Hard Anodising (MIL-A-8625 Type III)',
    type: 'surface-treatment',
    certification: 'NADCAP',
    expiryDate: '2026-11-15',
    status: 'active',
    lastAudit: '2025-11-02',
    performedBy: 'AeroCoat Technologies',
    accreditationNumber: 'NADCAP-CT-29843',
  },
  {
    id: '5',
    processName: 'Carbon Fibre Lay-up (Autoclave)',
    type: 'composites',
    certification: 'customer-approved',
    expiryDate: '2026-06-30',
    status: 'active',
    lastAudit: '2025-06-12',
    performedBy: 'CompositeTech Corp.',
    accreditationNumber: 'CA-BOEING-7734',
  },
  {
    id: '6',
    processName: 'Cadmium Plating',
    type: 'chemical-processing',
    certification: 'NADCAP',
    expiryDate: '2026-05-01',
    status: 'pending',
    lastAudit: '2025-04-22',
    performedBy: 'ChemFinish Ltd.',
    accreditationNumber: 'NADCAP-CP-33201',
  },
  {
    id: '7',
    processName: 'Magnetic Particle Inspection (MPI)',
    type: 'NDT',
    certification: 'internal',
    expiryDate: '2026-08-31',
    status: 'active',
    lastAudit: '2025-08-14',
    performedBy: 'In-house QA Team',
    accreditationNumber: 'INT-NDT-MPI-001',
  },
  {
    id: '8',
    processName: 'Resistance Spot Welding',
    type: 'welding',
    certification: 'customer-approved',
    expiryDate: '2026-04-15',
    status: 'expiring-soon',
    lastAudit: '2025-04-01',
    performedBy: 'StructWeld Partners',
    accreditationNumber: 'CA-AIRBUS-1192',
  },
];
  ...
  const filtered = useMemo(() => {
    return MOCK_PROCESSES.filter((p) => {
      const matchSearch =
        ...
        p.performedBy.toLowerCase().includes(search.toLowerCase()) ||
        p.accreditationNumber.toLowerCase().includes(search.toLowerCase());
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
              AS9100D Clause 8.5.1 — NADCAP & Customer-Approved Special Processes
            </p>
          </div>
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-4 flex flex-wrap gap-3">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              type="text"
              aria-label="Search process, supplier, accreditation #..."
              ...
              {filtered.map((proc) => {
                ...
                return (
                  <tr key={proc.id} className="hover:bg-gray-50 dark:bg-gray-800">
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-bold border ${cc.bg} ${cc.text} ${cc.border}`}
                      >
