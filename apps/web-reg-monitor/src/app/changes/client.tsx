      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Total Changes</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-red-600">
                {items.filter((r) => r.impact === 'CRITICAL' || r.impact === 'HIGH').length}
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">High/Critical Impact</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-sky-600">
                {items.filter((r) => r.status === 'NEW' || r.status === 'UNDER_REVIEW').length}
              </p>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-green-600">
                {items.filter((r) => r.status === 'IMPLEMENTED').length}
              </p>
        ...
        {modalOpen && (
          <Modal
            ...
            title={editId ? 'Edit Regulatory Change' : 'Add Regulatory Change'}
            size="lg"
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setForm((p) => ({ ...p, affectedAreas: e.target.value }))}
                  placeholder="e.g. Quality, Environment, H&S"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setForm((p) => ({ ...p, actionRequired: e.target.value }))}
                  rows={2}
