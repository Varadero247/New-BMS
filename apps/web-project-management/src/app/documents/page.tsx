        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Project document library and version control
            </p>
          </div>
                  ...
                  <tbody>
                    {filtered.map((d) => (
                      <tr key={d.id} className="border-b hover:bg-gray-50 dark:bg-gray-800">
                        ...
                        <td className="py-3 px-4">
                          <span
                            className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${typeColors[d.type || d.category || ''] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}
                          >
                            {(d.type || d.category || '—').replace(/_/g, ' ')}
                          </span>
                        </td>
                        ...
                        <td className="py-3 px-4">
                          <span
                            className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${statusColors[d.status] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}
                          >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
              placeholder="e.g. planning, phase-1, stakeholder"
            />
          </div>
        </div>
        <ModalFooter>
