...
import {
  FileText, FolderOpen, Upload, Download, Clock, CheckCircle, AlertTriangle,
  Search, Filter, Eye, Lock, Edit3
} from 'lucide-react';

type DocStatus = 'draft' | 'under-review' | 'approved' | 'archived';
type DocType = 'charter' | 'plan' | 'report' | 'specification' | 'meeting-minutes' | 'change-request' | 'risk-register' | 'other';
...
const documents: Document[] = [
  {
    id: 'd1', name: 'Project Charter — ERP Migration', type: 'charter', project: 'ERP Migration', status: 'approved', version: '2.1',
    author: 'Emma Clarke', lastModified: '2025-09-15', size: '245 KB', approver: 'David Hughes', approvedDate: '2025-09-20',
    tags: ['Charter', 'ERP', 'Phase 1'],
    revisions: [
      { version: '2.1', date: '2025-09-15', author: 'Emma Clarke', changes: 'Updated budget section and stakeholder matrix' },
      { version: '2.0', date: '2025-07-01', author: 'Emma Clarke', changes: 'Major revision — expanded scope to include HR module' },
      { version: '1.0', date: '2025-03-10', author: 'Emma Clarke', changes: 'Initial release' },
    ],
  },
  {
    id: 'd2', name: 'Risk Register — New Factory Build', type: 'risk-register', project: 'New Factory Build', status: 'approved', version: '3.4',
    author: 'Tom Parker', lastModified: '2026-01-20', size: '180 KB', approver: 'Sarah Chen', approvedDate: '2026-01-22',
    tags: ['Risk', 'Factory', 'Construction'],
    revisions: [
      { version: '3.4', date: '2026-01-20', author: 'Tom Parker', changes: 'Added 3 new supply chain risks post-review' },
      { version: '3.3', date: '2025-12-01', author: 'Tom Parker', changes: 'Monthly update — closed 2 risks' },
    ],
  },
  {
    id: 'd3', name: 'Phase 2 Specification — Mobile App', type: 'specification', project: 'Mobile App v3', status: 'under-review', version: '1.2',
    author: 'Liam Chen', lastModified: '2026-02-05', size: '512 KB', approver: null, approvedDate: null,
    tags: ['Mobile', 'Phase 2', 'API'],
    revisions: [
      { version: '1.2', date: '2026-02-05', author: 'Liam Chen', changes: 'Addressed reviewer comments on API endpoints' },
      { version: '1.1', date: '2026-01-28', author: 'Liam Chen', changes: 'Added offline sync specifications' },
      { version: '1.0', date: '2026-01-15', author: 'Liam Chen', changes: 'Initial draft' },
    ],
  },
  {
    id: 'd4', name: 'Monthly Status Report — January 2026', type: 'report', project: 'ERP Migration', status: 'approved', version: '1.0',
    author: 'Emma Clarke', lastModified: '2026-02-01', size: '89 KB', approver: 'David Hughes', approvedDate: '2026-02-02',
    tags: ['Report', 'Monthly', 'Status'],
    revisions: [{ version: '1.0', date: '2026-02-01', author: 'Emma Clarke', changes: 'January 2026 status report' }],
  },
  {
    id: 'd5', name: 'Project Management Plan — ISO 27001', type: 'plan', project: 'ISO 27001 Certification', status: 'draft', version: '0.3',
    author: 'Alex Kim', lastModified: '2026-02-10', size: '324 KB', approver: null, approvedDate: null,
    tags: ['InfoSec', 'ISO 27001', 'Plan'],
    revisions: [
      { version: '0.3', date: '2026-02-10', author: 'Alex Kim', changes: 'Added resource plan and RACI matrix' },
      { version: '0.2', date: '2026-01-25', author: 'Alex Kim', changes: 'WBS and schedule baseline' },
      { version: '0.1', date: '2026-01-10', author: 'Alex Kim', changes: 'Initial outline' },
    ],
  },
  {
    id: 'd6', name: 'Steering Committee Minutes — Feb 2026', type: 'meeting-minutes', project: 'New Factory Build', status: 'approved', version: '1.0',
    author: 'Priya Patel', lastModified: '2026-02-08', size: '42 KB', approver: 'Tom Parker', approvedDate: '2026-02-09',
    tags: ['Minutes', 'Steering', 'Monthly'],
    revisions: [{ version: '1.0', date: '2026-02-08', author: 'Priya Patel', changes: 'Meeting minutes from Feb 6th steering committee' }],
  },
  {
    id: 'd7', name: 'Change Request CR-042 — Scope Extension', type: 'change-request', project: 'Mobile App v3', status: 'under-review', version: '1.0',
    author: 'Liam Chen', lastModified: '2026-02-11', size: '67 KB', approver: null, approvedDate: null,
    tags: ['Change', 'Scope', 'CR'],
    revisions: [{ version: '1.0', date: '2026-02-11', author: 'Liam Chen', changes: 'Request to add biometric login feature' }],
  },
  {
    id: 'd8', name: 'Lessons Learned — Phase 1', type: 'report', project: 'ERP Migration', status: 'archived', version: '1.0',
    author: 'Emma Clarke', lastModified: '2025-12-20', size: '156 KB', approver: 'David Hughes', approvedDate: '2025-12-22',
    tags: ['Lessons', 'Phase 1', 'Archive'],
    revisions: [{ version: '1.0', date: '2025-12-20', author: 'Emma Clarke', changes: 'Phase 1 lessons learned compilation' }],
  },
];
...
const typeLabels: Record<DocType, string> = {
  charter: 'Charter', plan: 'Plan', report: 'Report', specification: 'Specification',
  'meeting-minutes': 'Meeting Minutes', 'change-request': 'Change Request', 'risk-register': 'Risk Register', other: 'Other',
};
...
export default function DocumentsClient() {
  ...
  const filtered = documents.filter((d) => {
    ...
    const matchesSearch = !searchTerm || d.name.toLowerCase().includes(searchTerm.toLowerCase()) || d.project.toLowerCase().includes(searchTerm.toLowerCase()) || d.tags.some((t) => t.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input type="text" aria-label="Search documents, projects, tags..." placeholder="Search documents, projects, tags..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
        <select aria-label="Filter by type" value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
