...
describe('GET /api/ccps', () => {
  it('should return a list of CCPs with pagination', async () => {
    const ccps = [
      { id: '00000000-0000-0000-0000-000000000001', name: 'Cooking Temperature', number: 'CCP-001', isActive: true },
    ];
...
describe('POST /api/ccps', () => {
  it('should create a CCP with auto-generated number', async () => {
    ...
    const created = { id: '00000000-0000-0000-0000-000000000001', name: 'Cooking Temp', number: 'CCP-006', processStep: 'Cooking', criticalLimit: '75C', monitoringMethod: 'Thermometer', monitoringFrequency: 'PER_BATCH' };
...
describe('GET /api/ccps/:id', () => {
  it('should return a CCP with monitoring records', async () => {
    const ccp = { id: '00000000-0000-0000-0000-000000000001', name: 'Cooking Temp', hazard: null, monitoringRecords: [] };
...
describe('PUT /api/ccps/:id', () => {
  it('should update a CCP', async () => {
    (prisma as any).fsCcp.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).fsCcp.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', name: 'Updated' });

    const res = await request(app).put('/api/ccps/00000000-0000-0000-0000-000000000001').send({ name: 'Updated' });
    expect(res.status).toBe(200);
    expect(res.body.success).toBe(true);
  });
  ...
  it('should return 404 for non-existent CCP', async () => {
    ...
    const res = await request(app).put('/api/ccps/00000000-0000-0000-0000-000000000099').send({ name: 'Test' });
    expect(res.status).toBe(404);
  });
  ...
  it('should reject invalid update', async () => {
    ...
    const res = await request(app).put('/api/ccps/00000000-0000-0000-0000-000000000001').send({ monitoringFrequency: 'INVALID' });
    expect(res.status).toBe(400);
  });
});
...
describe('DELETE /api/ccps/:id', () => {
  it('should soft delete a CCP', async () => {
    (prisma as any).fsCcp.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).fsCcp.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', deletedAt: new Date() });
...
describe('GET /api/ccps/:id/monitoring-records', () => {
  ...
  it('should return 404 if CCP not found', async () => {
    ...
    const res = await request(app).get('/api/ccps/00000000-0000-0000-0000-000000000099/monitoring-records');
    expect(res.status).toBe(404);
  });
});
...
describe('POST /api/ccps/:id/monitoring-records', () => {
  it('should create a monitoring record for a CCP', async () => {
    ...
    const res = await request(app).post('/api/ccps/00000000-0000-0000-0000-000000000001/monitoring-records').send({
  ...
  it('should return 404 if CCP not found', async () => {
    ...
    const res = await request(app).post('/api/ccps/00000000-0000-0000-0000-000000000099/monitoring-records').send({
