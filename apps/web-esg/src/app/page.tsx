    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Environmental, Social & Governance overview</p>
        </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <Link href="/emissions" className="flex flex-col items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                  ...
                  <span className="text-sm font-medium text-gray-700">Log Emissions</span>
                </Link>
                <Link href="/targets" className="flex flex-col items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                  ...
                  <span className="text-sm font-medium text-gray-700">Set Target</span>
                </Link>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-gray-900">Environmental</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-gray-900">Governance</span>
                  </div>
