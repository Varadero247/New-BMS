      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">Track governance metrics, board composition, and compliance indicators</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            { label: 'Total Indicators', value: metrics.length, color: 'text-gray-800', bg: 'bg-gray-50' },
            ...
            <Card key={c.label}><CardContent className={`pt-5 pb-4 ${c.bg} rounded-lg`}>
              ...
              {c.label === 'Compliant' && <p className="text-xs text-gray-400 mt-1">{compliancePct}% compliance rate</p>}
            </CardContent></Card>
          ))}
        </div>
        ...
        <Card className="mb-6"><CardContent className="pt-4 pb-4">
          <div className="flex flex-wrap gap-3 items-center">
            <div className="flex-1 min-w-[200px] relative">
              ...
              <input type="text" placeholder="Search governance indicators..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            ...
            <select value={complianceFilter} onChange={e => setComplianceFilter(e.target.value)} className="border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    {filtered.map(m => {
                      ...
                      return (
                        <tr key={m.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4 font-medium text-gray-900">{m.indicator}</td>
                          ...
                          <td className="py-3 px-4"><span className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${m.status === 'ACTIVE' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'}`}>{m.status}</span></td>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={editing ? 'Edit Governance Indicator' : 'Add Governance Indicator'} size="lg">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Indicator Name *</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Value / Measurement</label>
            ...
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Compliance</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Responsible Person</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Last Review Date</label>
            ...
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Next Review Date</label>
