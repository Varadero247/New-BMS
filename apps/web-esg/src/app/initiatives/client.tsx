...
import {
  ...
  ChevronDown, ChevronRight, Search, Filter, Users
} from 'lucide-react';
...
const initiatives: Initiative[] = [
  {
    id: 'INI-001', name: 'Carbon Neutrality Programme', description: 'Achieve net-zero Scope 1 & 2 emissions by 2030 through renewable energy procurement, energy efficiency, and carbon offsets',
    pillar: 'environmental', priority: 'critical', status: 'in-progress', owner: 'Sarah Chen', startDate: '2024-01-15', targetDate: '2030-12-31',
    budget: 2500000, spent: 850000, progress: 34,
    impactMetrics: [{ label: 'CO₂ Reduced', value: '1,240', unit: 'tCO₂e' }, { label: 'Renewable %', value: '62', unit: '%' }],
    sdgs: [7, 13], tags: ['Net Zero', 'Science-Based Target'],
  },
  {
    id: 'INI-002', name: 'Circular Economy Transition', description: 'Reduce waste to landfill to <5% and increase recycling rate to 95% across all operations',
    pillar: 'environmental', priority: 'high', status: 'in-progress', owner: 'James Wilson', startDate: '2024-06-01', targetDate: '2027-12-31',
    budget: 800000, spent: 320000, progress: 45,
    impactMetrics: [{ label: 'Waste Diverted', value: '89', unit: '%' }, { label: 'Cost Saved', value: '£145k', unit: '' }],
    sdgs: [12], tags: ['Zero Waste', 'Recycling'],
  },
  {
    id: 'INI-003', name: 'Water Stewardship', description: 'Reduce freshwater consumption by 30% through rainwater harvesting, recycling, and process optimization',
    pillar: 'environmental', priority: 'medium', status: 'planned', owner: 'Maria Garcia', startDate: '2026-01-01', targetDate: '2028-12-31',
    budget: 450000, spent: 0, progress: 0,
    impactMetrics: [{ label: 'Target Reduction', value: '30', unit: '%' }],
    sdgs: [6, 14], tags: ['Water'],
  },
  {
    id: 'INI-004', name: 'Diversity & Inclusion Programme', description: 'Achieve 40% women in leadership, zero pay gap, and improve ethnic diversity metrics by 25%',
    pillar: 'social', priority: 'high', status: 'in-progress', owner: 'Priya Patel', startDate: '2024-03-01', targetDate: '2027-06-30',
    budget: 600000, spent: 280000, progress: 52,
    impactMetrics: [{ label: 'Women in Leadership', value: '35', unit: '%' }, { label: 'Pay Gap', value: '3.2', unit: '%' }],
    sdgs: [5, 10], tags: ['DEI', 'Pay Equity'],
  },
  {
    id: 'INI-005', name: 'Community Investment Fund', description: 'Invest £500k annually in local community projects, education, and skills development',
    pillar: 'social', priority: 'medium', status: 'in-progress', owner: 'Tom Richards', startDate: '2025-01-01', targetDate: '2025-12-31',
    budget: 500000, spent: 210000, progress: 42,
    impactMetrics: [{ label: 'Projects Funded', value: '18', unit: '' }, { label: 'People Reached', value: '4,500', unit: '' }],
    sdgs: [4, 11], tags: ['Community', 'Education'],
  },
  {
    id: 'INI-006', name: 'Supply Chain Transparency', description: 'Map and audit 100% of Tier 1 suppliers and 80% of Tier 2 for ESG compliance',
    pillar: 'governance', priority: 'high', status: 'in-progress', owner: 'Alex Kim', startDate: '2024-09-01', targetDate: '2026-06-30',
    budget: 350000, spent: 180000, progress: 60,
    impactMetrics: [{ label: 'Tier 1 Mapped', value: '100', unit: '%' }, { label: 'Tier 2 Mapped', value: '54', unit: '%' }],
    sdgs: [8, 12], tags: ['Supply Chain', 'Due Diligence'],
  },
  {
    id: 'INI-007', name: 'Board ESG Competency', description: 'Ensure 50% of board members have ESG expertise and link executive compensation to ESG KPIs',
    pillar: 'governance', priority: 'medium', status: 'completed', owner: 'Diana Foster', startDate: '2024-01-01', targetDate: '2025-06-30',
    budget: 120000, spent: 95000, progress: 100,
    impactMetrics: [{ label: 'Board ESG Expertise', value: '60', unit: '%' }, { label: 'Exec KPIs Linked', value: '100', unit: '%' }],
    sdgs: [16], tags: ['Board', 'Compensation'],
  },
  {
    id: 'INI-008', name: 'Renewable Energy Procurement', description: 'Transition to 100% renewable electricity through PPAs and on-site generation',
    pillar: 'environmental', priority: 'critical', status: 'in-progress', owner: 'Sarah Chen', startDate: '2024-04-01', targetDate: '2028-12-31',
    budget: 1800000, spent: 720000, progress: 62,
    impactMetrics: [{ label: 'Renewable %', value: '62', unit: '%' }, { label: 'Solar Installed', value: '450', unit: 'kW' }],
    sdgs: [7], tags: ['Renewable', 'PPA', 'Solar'],
  },
  {
    id: 'INI-009', name: 'Employee Wellbeing Programme', description: 'Launch comprehensive wellbeing programme covering mental health, physical fitness, and financial literacy',
    pillar: 'social', priority: 'high', status: 'in-progress', owner: 'Laura Brown', startDate: '2025-01-01', targetDate: '2025-12-31',
    budget: 250000, spent: 85000, progress: 35,
    impactMetrics: [{ label: 'Participation', value: '72', unit: '%' }, { label: 'Satisfaction', value: '4.2', unit: '/5' }],
    sdgs: [3], tags: ['Wellbeing', 'Mental Health'],
  },
  {
    id: 'INI-010', name: 'Anti-Corruption Framework', description: 'Implement ISO 37001 anti-bribery management system across all operations',
    pillar: 'governance', priority: 'high', status: 'completed', owner: 'Robert Taylor', startDate: '2024-06-01', targetDate: '2025-09-30',
    budget: 200000, spent: 185000, progress: 100,
    impactMetrics: [{ label: 'Training Completed', value: '98', unit: '%' }, { label: 'Certifications', value: '3', unit: 'sites' }],
    sdgs: [16], tags: ['ISO 37001', 'Anti-Bribery'],
  },
];
...
export default function InitiativesClient() {
  ...
  const filtered = initiatives.filter((i) => {
    ...
    const matchesSearch = !searchTerm || i.name.toLowerCase().includes(searchTerm.toLowerCase()) || i.tags.some((t) => t.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-4">
        {(['environmental', 'social', 'governance'] as Pillar[]).map((p) => {
          ...
          const pillarProgress = Math.round(pillarInits.reduce((s, i) => s + i.progress, 0) / pillarInits.length);
          return (
            <button
              key={p}
            ...
            >
              ...
              <div className="mt-3">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className={`h-2 rounded-full ${p === 'environmental' ? 'bg-green-500' : p === 'social' ? 'bg-blue-500' : 'bg-purple-500'}`} style={{ width: `${pillarProgress}%` }} />
                </div>
              </div>
            </button>
          );
      ...
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input type="text" aria-label="Search initiatives, tags..." placeholder="Search initiatives, tags..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500" />
        </div>
                ...
                <div className="flex items-center gap-4 min-w-[160px]">
                  <div className="w-24">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1.5">
                      <div className={`h-1.5 rounded-full ${ini.progress === 100 ? 'bg-green-500' : ini.progress >= 50 ? 'bg-blue-500' : 'bg-amber-500'}`} style={{ width: `${ini.progress}%` }} />
                    </div>
                  </div>
                </div>
              </button>
