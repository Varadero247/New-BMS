...
const frameworkColors: Record<string, string> = {
  ...
  CUSTOM: 'bg-gray-100 dark:bg-gray-800 text-gray-700',
};
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">ESG Reports</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">Generate and manage ESG disclosure reports across frameworks</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            { label: 'Total Reports', value: reports.length, color: 'text-gray-800', bg: 'bg-gray-50 dark:bg-gray-800' },
                    ...
                    {filtered.map(r => (
                      <tr key={r.id} className="border-b hover:bg-gray-50 dark:bg-gray-800">
                        <td className="py-3 px-4">
                          ...
                          <p className="text-xs text-gray-400 dark:text-gray-500">{r.generatedBy}</p>
                        </td>
                        <td className="py-3 px-4"><span className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${frameworkColors[r.framework] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}>{r.framework}</span></td>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={editing ? 'Edit Report' : 'Generate ESG Report'} size="lg">
        <div className="space-y-4">
          <div><label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Report Title *</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Report Type</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Reporting Period</label>
            ...
            <div><label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Prepared By</label>
