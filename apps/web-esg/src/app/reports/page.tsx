  ...
  return (
    <div className="p-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Generate and manage ESG disclosure reports across frameworks
            </p>
          </div>
          <button
            onClick={openCreate}
                  ...
                  <tbody>
                    {filtered.map((r) => (
                      <tr key={r.id} className="border-b hover:bg-gray-50 dark:bg-gray-800">
                        ...
                        <td className="py-3 px-4">
                          <span
                            className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${frameworkColors[r.framework] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}
                          >
                            {r.framework}
                          </span>
                        </td>
      ...
      <Modal
        ...
        title={editing ? 'Edit Report' : 'Generate ESG Report'}
        size="lg"
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                placeholder="e.g. FY 2025, Q1 2026"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              ...
              <input
                ...
                onChange={(e) => setForm((f) => ({ ...f, generatedBy: e.target.value }))}
                className="w-full border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
              placeholder="Report scope and summary..."
            />
          </div>
        </div>
