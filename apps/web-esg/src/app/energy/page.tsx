      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">Track energy usage, renewables, and costs</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            { label: 'Total Consumption', value: `${totalConsumption.toLocaleString()} kWh`, color: 'text-gray-800', bg: 'bg-gray-50' },
                  ...
                  <tbody>
                    {filtered.map(r => (
                      <tr key={r.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4"><span className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${typeColors[r.type] || 'bg-gray-100 text-gray-700'}`}>{r.type?.replace(/_/g, ' ')}</span></td>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={editing ? 'Edit Energy Record' : 'Log Energy Consumption'} size="lg">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Energy Type</label>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Consumption</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-end pb-1"><label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-sm font-medium text-gray-700">Renewable Energy Source</span>
            </label></div>
          </div>
        </div>
