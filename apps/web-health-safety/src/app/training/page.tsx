  ...
  return (
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              OHS training and competency tracking
            </p>
          </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{counts.totalParticipants}</p>
                </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Training Register ({filtered.length})</CardTitle>
          </CardHeader>
              ...
              <Table>
                ...
                <TableBody>
                  {filtered.map((t) => (
                    <TableRow
                      key={t.id}
                      className="cursor-pointer hover:bg-gray-50 dark:bg-gray-800"
                    >
                      ...
                      <TableCell>
                        <Badge variant="outline">{t.trainingType.replace(/_/g, ' ')}</Badge>
                      </TableCell>
                      ...
                      <TableCell>
                        <div className="flex gap-1">
                          <button
                            onClick={() => openEdit(t)}
                            className="text-gray-400 dark:text-gray-500 hover:text-blue-600 p-1 text-xs border rounded hover:border-blue-300"
                          >
                            Edit
                          </button>
                          <button
        ...
        <Modal
          ...
          title={editingId ? 'Edit Training Session' : 'Schedule Training Session'}
          size="lg"
        >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onChange={(e) => updateForm('trainingType', e.target.value)}
                >
                  {TRAINING_TYPES.map((t) => (
                    <option key={t.value} value={t.value}>
                      {t.label}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateForm('completedDate', e.target.value)}
                />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateForm('participants', parseInt(e.target.value) || 0)}
                  min="0"
                />
              </div>
              <div>
