              ...
              <Card key={template.id} className="hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
                <CardContent className="pt-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button size="sm" className="bg-red-600 hover:bg-red-700 text-white" onClick={() => handleUse(template)}>
                      Use
                    </Button>
        ...
        >
          {selectedTemplate && (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <Badge className="bg-red-100 text-red-700 font-mono">{selectedTemplate.code}</Badge>
          ...
          <ModalFooter>
            ...
            <Button className="bg-red-600 hover:bg-red-700 text-white" onClick={() => selectedTemplate && handleUse(selectedTemplate)}>
              Use Template
            </Button>
          </ModalFooter>
        </Modal>
