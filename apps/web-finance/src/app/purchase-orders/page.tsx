            ...
            <table className="w-full text-sm border">
              ...
              <tbody>
                ...
                <tr className="border-t bg-gray-50 dark:bg-gray-800 font-medium">
                  ...
                  <td className="py-2 px-3 text-right">{formatCurrency(poTotal)}</td>
                  <td></td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <p className="font-medium">{viewOrder.supplier?.name || viewOrder.supplierName}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Order Date</p>
                <p className="font-medium">{new Date(viewOrder.orderDate).toLocaleDateString()}</p>
              </div>
              <div>
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="text-xl font-bold">{formatCurrency(viewOrder.total)}</p>
              </div>
