...
describe('GET /api/inspections', () => {
  it('should return inspections list', async () => {
    (prisma as any).assetInspection.findMany.mockResolvedValue([{ id: '00000000-0000-0000-0000-000000000001', referenceNumber: 'AIN-2026-0001' }]);
...
describe('GET /api/inspections/:id', () => {
  it('should return an inspection by id', async () => {
    (prisma as any).assetInspection.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', referenceNumber: 'AIN-2026-0001' });
...
describe('POST /api/inspections', () => {
  it('should create an inspection', async () => {
    (prisma as any).assetInspection.count.mockResolvedValue(0);
    (prisma as any).assetInspection.create.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', referenceNumber: 'AIN-2026-0001' });
...
describe('PUT /api/inspections/:id', () => {
  it('should update an inspection', async () => {
    (prisma as any).assetInspection.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).assetInspection.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', condition: 'EXCELLENT' });
    const res = await request(app).put('/api/inspections/00000000-0000-0000-0000-000000000001').send({ condition: 'EXCELLENT' });
    expect(res.status).toBe(200);
    expect(res.body.success).toBe(true);
  });
  ...
  it('should return 404 if not found', async () => {
    (prisma as any).assetInspection.findFirst.mockResolvedValue(null);
    const res = await request(app).put('/api/inspections/00000000-0000-0000-0000-000000000099').send({ condition: 'GOOD' });
    expect(res.status).toBe(404);
    expect(res.body.success).toBe(false);
  });

  it('should return 400 on validation error (invalid condition)', async () => {
    const res = await request(app).put('/api/inspections/00000000-0000-0000-0000-000000000001').send({ condition: 'BAD_CONDITION' });
    expect(res.status).toBe(400);
    expect(res.body.success).toBe(false);
    expect(res.body.error.code).toBe('VALIDATION_ERROR');
  });
  ...
  it('should return 500 on update error', async () => {
    ...
    const res = await request(app).put('/api/inspections/00000000-0000-0000-0000-000000000001').send({ condition: 'GOOD' });
    expect(res.status).toBe(500);
    expect(res.body.success).toBe(false);
  });
});
...
describe('DELETE /api/inspections/:id', () => {
  it('should soft delete an inspection', async () => {
    (prisma as any).assetInspection.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).assetInspection.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
