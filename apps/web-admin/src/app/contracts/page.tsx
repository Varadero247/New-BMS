      ...
      <main className="ml-64 p-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Manage vendor contracts and licences</p>
            </div>
          </div>
        ...
        <div className="bg-[#0F2440] rounded-xl border border-[#1B3A6B]/30 overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center text-gray-400">No contracts found. Click &quot;Seed Defaults&quot; to add sample data.</div>
          ) : (
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#1B3A6B]/30">
                  ...
                  <th className="text-left px-6 py-3 text-xs font-medium text-gray-400 uppercase">End Date</th>
                  <th className="text-right px-6 py-3 text-xs font-medium text-gray-400 uppercase">Annual Cost</th>
              ...
              <tbody>
                {contracts.map((c) => (
                  <tr key={c.id} className="border-b border-[#1B3A6B]/20 hover:bg-[#1B3A6B]/10 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-400">{c.category}</td>
          ...
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-[#0F2440] rounded-xl border border-[#1B3A6B]/30 w-full max-w-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm text-gray-400 mb-1">Annual Cost ($)</label>
