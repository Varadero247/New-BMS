...
const MOCK_REPORTS: ReportItem[] = [
  { id: '1', name: 'Q1 2026 Compliance Summary', type: 'COMPLIANCE', status: 'PUBLISHED', description: 'Cross-module ISO compliance scores and open action summary', author: 'Alice Johnson', createdAt: '2026-01-01', lastRun: '2026-02-01', format: 'PDF', schedule: 'Monthly' },
  { id: '2', name: 'H&S Performance Dashboard', type: 'PERFORMANCE', status: 'PUBLISHED', description: 'KPI trends, incident rates, and CAPA metrics for H&S module', author: 'Bob Smith', createdAt: '2026-01-15', lastRun: '2026-02-10', format: 'PDF', schedule: 'Weekly' },
  { id: '3', name: 'Supplier Quality Report', type: 'QUALITY', status: 'DRAFT', description: 'Supplier NCR rates, audit findings and performance scorecard', author: 'Carol Davis', createdAt: '2026-02-01', lastRun: null, format: 'XLSX', schedule: null },
  { id: '4', name: 'ESG Emissions Report', type: 'ESG', status: 'PUBLISHED', description: 'Scope 1, 2 and 3 GHG emissions with trend analysis', author: 'Eve Green', createdAt: '2025-12-01', lastRun: '2026-02-01', format: 'PDF', schedule: 'Monthly' },
  { id: '5', name: 'CAPA Effectiveness Review', type: 'QUALITY', status: 'PUBLISHED', description: 'CAPA closure rates and effectiveness verification results', author: 'Ivan Quality', createdAt: '2026-01-20', lastRun: '2026-02-14', format: 'PDF', schedule: 'Fortnightly' },
  { id: '6', name: 'Financial KPI Report', type: 'FINANCE', status: 'DRAFT', description: 'Revenue, cost and profitability KPIs with budget variance', author: 'Jane Finance', createdAt: '2026-02-10', lastRun: null, format: 'XLSX', schedule: null },
  { id: '7', name: 'Energy Management Report', type: 'ENERGY', status: 'PUBLISHED', description: 'ISO 50001 energy performance review and reduction targets', author: 'Heidi Energy', createdAt: '2026-01-01', lastRun: '2026-02-01', format: 'PDF', schedule: 'Monthly' },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {[
            ...
            { label: 'Published', value: items.filter(i => i.status === 'PUBLISHED').length, color: 'bg-green-50 text-green-700' },
            { label: 'Scheduled', value: items.filter(i => i.schedule).length, color: 'bg-blue-50 text-blue-700' },
          ].map(s => (
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <div className="relative flex-1 min-w-48">
            ...
            <input
              type="text"
              aria-label="Search reports..." placeholder="Search reports..."
              value={searchTerm}
