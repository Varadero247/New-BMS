...
import {
  PieChart, FileText, Database, BarChart3, Bell, Download, TrendingUp, Users,
  TrendingDown, Minus, ArrowRight, Sparkles, Activity,
} from 'lucide-react';
...
const MOCK_DATA: DashboardData = {
  totalReports: 24, activeDashboards: 8, datasets: 15, kpis: 42,
  activeAlerts: 3, scheduledExports: 7, avgScore: 84, activeUsers: 18,
};

const MOCK_RECENT: RecentActivity[] = [
  { id: '1', type: 'Report', name: 'Q1 2026 Compliance Summary', module: 'Quality', time: '5m ago', color: 'bg-blue-500' },
  { id: '2', type: 'Alert', name: 'NCR rate exceeded threshold', module: 'Quality', time: '22m ago', color: 'bg-red-500' },
  { id: '3', type: 'Export', name: 'H&S KPI export — Feb 2026', module: 'H&S', time: '1h ago', color: 'bg-green-500' },
  { id: '4', type: 'Dashboard', name: 'Executive Overview updated', module: 'Cross-module', time: '2h ago', color: 'bg-purple-500' },
  { id: '5', type: 'Query', name: 'Overdue CAPA by department', module: 'Quality', time: '3h ago', color: 'bg-amber-500' },
];

const MOCK_KPIS = [
  { name: 'Lost Time Injury Rate', category: 'H&S', value: 0.12, target: 0.0, trend: 'down', unit: 'per 100k hrs' },
  { name: 'Customer Satisfaction', category: 'Quality', value: 88, target: 90, trend: 'up', unit: '%' },
  { name: 'Carbon Intensity', category: 'Environmental', value: 24.8, target: 20, trend: 'down', unit: 'tCO2/£m' },
  { name: 'On-Time Delivery', category: 'Operations', value: 93, target: 95, trend: 'up', unit: '%' },
  { name: 'CAPA Closure Rate', category: 'Quality', value: 76, target: 85, trend: 'stable', unit: '%' },
  { name: 'Supplier Defect Rate', category: 'Quality', value: 2.1, target: 1.0, trend: 'down', unit: 'ppm' },
];
          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              <CardTitle className="flex items-center justify-between text-base">
                ...
                <Link href="/kpis" className="text-xs text-purple-600 hover:text-purple-800 font-medium flex items-center gap-1">
            ...
            <CardContent>
              <div className="space-y-3">
                {MOCK_KPIS.map(kpi => {
                  const pct = kpi.unit === '%' ? kpi.value : Math.min(100, (kpi.value / (kpi.target || 1)) * 100);
                  const onTarget = kpi.unit === '%' ? kpi.value >= kpi.target : kpi.value <= kpi.target;
                  return (
