      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">Create, share and manage data visualisation dashboards</p>
          </div>
          <button
            ...
            {filtered.map(d => (
              <Card key={d.id} className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="pt-5">
                  ...
                  <h3 className="font-semibold text-gray-900 mt-2 mb-1">{d.name}</h3>
                  <p className="text-xs text-gray-500 line-clamp-2">{d.description}</p>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <div className="flex gap-1">
                      <button className="p-1.5 rounded hover:bg-gray-100 text-gray-400" title="Edit">
                  ...
                  <p className="text-xs text-gray-400 mt-1">{d.owner} · Updated {d.lastUpdated}</p>
                </CardContent>
              </Card>
            ))}
          </div>
