...
const MOCK_QUERIES: QueryItem[] = [
  {
    id: '1',
    name: 'Overdue CAPAs by Assignee',
    description: 'Lists all CAPAs past their due date grouped by assignee',
    dataset: 'CAPA Register',
    lastRun: '2026-02-14T09:00:00Z',
    runCount: 47,
    avgDurationMs: 340,
    isFavourite: true,
    owner: 'Alice Johnson',
  ...
  },
  {
    ...
    description: 'Incident count, severity breakdown and open rate by month',
    dataset: 'H&S Incidents',
  ...
  {
    id: '3',
    name: 'Supplier NCR Rate Ranking',
    description: 'Ranks suppliers by NCR rate per 100 deliveries',
    dataset: 'Supplier Performance',
    lastRun: '2026-02-13T08:30:00Z',
    runCount: 8,
    avgDurationMs: 820,
    isFavourite: false,
  ...
  {
    id: '4',
    name: 'GHG Trend by Scope',
    description: 'Monthly Scope 1, 2, 3 emissions over the last 12 months',
  ...
  {
    id: '5',
    name: 'ISO Compliance Score by Module',
    description: 'Current compliance percentage for each active ISO standard',
    dataset: 'ISO Compliance Scores',
  ...
  },
  {
    ...
    description: 'Mandatory training completion rates broken down by department',
    dataset: 'HR Headcount',
  ...
  {
    id: '7',
    name: 'Energy Consumption vs Budget',
    description: 'Compares actual site energy consumption to monthly budget targets',
    dataset: 'Energy Metering',
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Reusable data queries for reports and dashboards
            </p>
          </div>
                      ...
                      <tr key={q.id} className="border-b hover:bg-gray-50 dark:bg-gray-800">
                        <td className="py-3 px-4">
                          <button onClick={() => toggleFavourite(q.id)}>
                            <Star
                              className={`h-4 w-4 ${q.isFavourite ? 'text-yellow-500 fill-yellow-500' : 'text-gray-300 dark:text-gray-600 hover:text-yellow-400'}`}
                            />
                          </button>
                        </td>
                        <td className="py-3 px-4">
                        ...
                        <td className="py-3 px-4 text-center">
                          <span
                            className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${CATEGORY_STYLES[q.category] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}
                          >
                            {q.category}
                          </span>
                        </td>
                        ...
                        <td className="py-3 px-4 text-xs text-gray-500 dark:text-gray-400">
                          {q.lastRun ? (
                            new Date(q.lastRun).toLocaleString()
                          ) : (
                        ...
                        <td className="py-3 px-4 text-right">
                          <div className="flex justify-end gap-1.5">
                            <Link
                              href={`/nlq?query=${encodeURIComponent(q.name)}`}
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl w-full max-w-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Overdue Risk Assessments"
