...
import { Plus, Search, BarChart3, TrendingUp, TrendingDown, Minus, Target, XCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            { label: 'Near Target', value: items.filter(i => i.status === 'NEAR_TARGET').length, color: 'bg-yellow-50 text-yellow-700' },
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <div className="relative flex-1 min-w-48">
            ...
            <input
              type="text"
              aria-label="Search KPIs..." placeholder="Search KPIs..."
              value={searchTerm}
