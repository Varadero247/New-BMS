...
const mainNav = [
  ...
  { name: 'Custom Dashboards', href: '/dashboards', icon: PieChart },
];
const reportsNav = [
  { name: 'Reports', href: '/reports', icon: FileText },
  { name: 'Datasets', href: '/datasets', icon: Database },
  { name: 'Queries', href: '/queries', icon: Code },
  { name: 'Natural Language Query', href: '/nlq', icon: Code },
];
const intelligenceNav = [
  { name: 'Unified Risks', href: '/unified-risks', icon: ShieldAlert },
...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-card border-r border-border flex flex-col">
      <div className="p-6 border-b border-border bg-purple-50 dark:bg-purple-900/10">
        <h1 className="text-xl font-bold font-display text-purple-900 dark:text-purple-100">
          Analytics & BI
        </h1>
        <p className="text-xs text-purple-600 dark:text-purple-400 mt-1">Business Intelligence</p>
      </div>
