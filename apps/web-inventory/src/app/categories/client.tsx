...
const categories: Category[] = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            name: 'Steel',
            code: 'RM-MET-STL',
            description: 'Carbon, stainless, and alloy steels',
            parentId: 'cat-1a',
            itemCount: 45,
            totalValue: 320000,
            status: 'active',
            children: [] },
          {
            ...
            name: 'Aluminium',
            code: 'RM-MET-ALU',
            description: 'Aluminium sheets, bars, and billets',
            parentId: 'cat-1a',
            itemCount: 38,
            totalValue: 210000,
            status: 'active',
            children: [] },
          {
            ...
            name: 'Copper',
            code: 'RM-MET-COP',
            description: 'Copper wire, sheet, and tube',
            parentId: 'cat-1a',
            itemCount: 25,
            totalValue: 95000,
            status: 'active',
            children: [] },
          {
            ...
            name: 'Titanium',
            code: 'RM-MET-TIT',
            description: 'Aerospace-grade titanium alloys',
            parentId: 'cat-1a',
            itemCount: 20,
            totalValue: 55000,
            status: 'active',
        ...
        ] },
      {
        ...
        name: 'Polymers',
        code: 'RM-POL',
        description: 'Plastics, rubbers, and composites',
        parentId: 'cat-1',
        itemCount: 89,
        totalValue: 245000,
        status: 'active',
        children: [] },
      {
        ...
        name: 'Chemicals',
        code: 'RM-CHM',
        description: 'Process chemicals and reagents',
        parentId: 'cat-1',
        itemCount: 67,
        totalValue: 180000,
        status: 'active',
        children: [] },
      {
        ...
        name: 'Timber',
        code: 'RM-TMB',
        description: 'Hardwood and softwood lumber',
        parentId: 'cat-1',
        itemCount: 58,
        totalValue: 145000,
        status: 'active',
    ...
    ] },
  {
    ...
    name: 'Components',
    code: 'CMP',
    description: 'Sub-assemblies and bought-out parts',
    parentId: null,
    itemCount: 567,
    totalValue: 890000,
    status: 'active',
    children: [
      {
        ...
        name: 'Electronics',
        code: 'CMP-ELC',
        description: 'PCBs, ICs, connectors, sensors',
        parentId: 'cat-2',
        itemCount: 234,
        totalValue: 450000,
        status: 'active',
        children: [] },
      {
        ...
        name: 'Mechanical',
        code: 'CMP-MEC',
        description: 'Bearings, gears, fasteners, seals',
        parentId: 'cat-2',
        itemCount: 198,
        totalValue: 280000,
        status: 'active',
        children: [] },
      {
        ...
        name: 'Hydraulics',
        code: 'CMP-HYD',
        description: 'Pumps, valves, hoses, fittings',
        parentId: 'cat-2',
        itemCount: 135,
        totalValue: 160000,
        status: 'active',
    ...
    children: [
      {
        ...
        code: 'FG-STD',
        description: 'Off-the-shelf standard product range',
        parentId: 'cat-3',
        itemCount: 98,
        totalValue: 1800000,
        status: 'active',
        children: [] },
      {
        ...
        code: 'FG-CST',
        description: 'Bespoke customer-specific products',
        parentId: 'cat-3',
        itemCount: 58,
        totalValue: 1400000,
        status: 'active',
    ...
    children: [
      {
        ...
        name: 'Tooling',
        code: 'CON-TLG',
        description: 'Cutting tools, jigs, fixtures',
        parentId: 'cat-4',
        itemCount: 89,
        totalValue: 65000,
        status: 'active',
        ...
        children: [] },
      {
        ...
        name: 'Packaging',
        code: 'CON-PKG',
        description: 'Boxes, pallets, stretch wrap',
        parentId: 'cat-4',
        itemCount: 56,
        totalValue: 22000,
        status: 'active',
        children: [] },
      {
        ...
        name: 'Lubricants',
        code: 'CON-LUB',
        description: 'Oils, greases, cutting fluids',
        parentId: 'cat-4',
        itemCount: 44,
        totalValue: 15000,
        status: 'active',
    ...
    ] },
  {
    ...
    name: 'Spare Parts',
    code: 'SP',
    description: 'Maintenance and repair spares',
    parentId: null,
    itemCount: 412,
    totalValue: 560000,
    status: 'active',
    children: [
      {
        ...
        code: 'SP-CRT',
        description: 'Long-lead, production-critical items',
        parentId: 'cat-5',
        itemCount: 78,
        totalValue: 340000,
        status: 'active',
        children: [] },
      {
        ...
        name: 'General Spares',
        code: 'SP-GEN',
        description: 'Common maintenance items',
        parentId: 'cat-5',
        itemCount: 334,
        totalValue: 220000,
        status: 'active',
    ...
    ] },
  {
    ...
    name: 'Legacy Parts',
    code: 'LEG',
    description: 'Discontinued product spares (retained for warranty)',
    parentId: null,
    itemCount: 89,
    totalValue: 45000,
    status: 'inactive',
...
function CategoryNode({
  ...
  if (
    !matchesSearch &&
    !category.children.some(function check(c: Category): boolean {
      return (
  ...
  return (
    <div>
      <div
        className={`flex items-center justify-between p-3 rounded-lg hover:bg-sky-50 transition-colors ${depth === 0 ? 'bg-white dark:bg-gray-900 border border-gray-200' : ''}`}
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-sky-600 bg-sky-50 px-1.5 py-0.5 rounded">
                {category.code}
              </span>
    ...
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Hierarchical category structure for inventory classification
        </p>
      </div>
            ...
            .map((c, i) => {
              ...
              return (
                <div
                  ...
                  style={{ width: `${pct}%` }}
                  title={`${c.name}: £${(c.totalValue / 1000).toFixed(0)}k (${pct.toFixed(1)}%)`}
                >
                  {pct > 10 && (
