...
import {
  Truck, Star, Clock, AlertTriangle, CheckCircle, Search, Filter,
  ChevronDown, ChevronRight, Globe, Mail, Phone, MapPin
} from 'lucide-react';
...
const suppliers: Supplier[] = [
  {
    ...
    categories: ['Raw Materials', 'Metals'], location: 'Birmingham', country: 'UK',
    contactName: 'John Davies', contactEmail: 'j.davies@metalpro.co.uk', contactPhone: '+44 121 555 0100',
    leadTimeDays: 5, onTimeDelivery: 97, qualityScore: 96, defectRate: 0.3, totalOrders: 1245, totalSpend: 2800000,
    paymentTerms: 'Net 30', lastAudit: '2025-11-15', certifications: ['ISO 9001', 'ISO 14001', 'AS9100D'],
  ...
  },
  {
    ...
    categories: ['Components', 'Electronics'], location: 'Munich', country: 'Germany',
    contactName: 'Hans Weber', contactEmail: 'h.weber@electrocom.de', contactPhone: '+49 89 555 0200',
    leadTimeDays: 8, onTimeDelivery: 95, qualityScore: 98, defectRate: 0.1, totalOrders: 876, totalSpend: 1650000,
    paymentTerms: 'Net 45', lastAudit: '2025-09-20', certifications: ['ISO 9001', 'IATF 16949', 'ISO 14001'],
  ...
  },
  {
    ...
    categories: ['Raw Materials', 'Polymers'], location: 'Shanghai', country: 'China',
    contactName: 'Li Wei', contactEmail: 'l.wei@pacificpoly.cn', contactPhone: '+86 21 5555 0300',
    leadTimeDays: 21, onTimeDelivery: 88, qualityScore: 91, defectRate: 1.2, totalOrders: 432, totalSpend: 890000,
    paymentTerms: 'Net 60', lastAudit: '2025-06-10', certifications: ['ISO 9001'],
  ...
  },
  {
    ...
    categories: ['Components', 'Mechanical'], location: 'Detroit', country: 'USA',
    contactName: 'Mike Johnson', contactEmail: 'm.johnson@precisionparts.com', contactPhone: '+1 313 555 0400',
    leadTimeDays: 14, onTimeDelivery: 78, qualityScore: 82, defectRate: 2.8, totalOrders: 256, totalSpend: 420000,
    paymentTerms: 'Net 30', lastAudit: '2025-12-01', certifications: ['ISO 9001'],
  ...
  },
  {
    ...
    categories: ['Raw Materials', 'Chemicals'], location: 'Oslo', country: 'Norway',
    contactName: 'Erik Larsen', contactEmail: 'e.larsen@nordicchem.no', contactPhone: '+47 22 555 0500',
    leadTimeDays: 7, onTimeDelivery: 99, qualityScore: 99, defectRate: 0.05, totalOrders: 678, totalSpend: 560000,
    paymentTerms: 'Net 30', lastAudit: '2026-01-10', certifications: ['ISO 9001', 'ISO 14001', 'REACH'],
  ...
  },
  {
    ...
    categories: ['Consumables', 'Packaging'], location: 'Manchester', country: 'UK',
    contactName: 'Sarah Green', contactEmail: 's.green@quickpack.co.uk', contactPhone: '+44 161 555 0600',
    leadTimeDays: 3, onTimeDelivery: 94, qualityScore: 90, defectRate: 0.8, totalOrders: 890, totalSpend: 125000,
    paymentTerms: 'Net 14', lastAudit: '2025-08-20', certifications: ['ISO 9001', 'FSC'],
  ...
  },
  {
    ...
    categories: ['Consumables', 'PPE'], location: 'Bristol', country: 'UK',
    contactName: 'David Brown', contactEmail: 'd.brown@safetyfirst.co.uk', contactPhone: '+44 117 555 0700',
    leadTimeDays: 4, onTimeDelivery: 92, qualityScore: 88, defectRate: 1.5, totalOrders: 234, totalSpend: 45000,
    paymentTerms: 'Net 30', lastAudit: '2024-12-15', certifications: ['ISO 9001'],
    notes: 'Audit overdue. Scheduled for March 2026.',
  },
  {
    id: 'sup-8', name: 'TitanForge Aerospace', code: 'SUP-008', status: 'approved', rating: 'A',
    categories: ['Raw Materials', 'Metals'], location: 'Toulouse', country: 'France',
    contactName: 'Pierre Dubois', contactEmail: 'p.dubois@titanforge.fr', contactPhone: '+33 5 555 0800',
    leadTimeDays: 12, onTimeDelivery: 96, qualityScore: 99, defectRate: 0.02, totalOrders: 189, totalSpend: 980000,
    paymentTerms: 'Net 45', lastAudit: '2025-10-05', certifications: ['ISO 9001', 'AS9100D', 'NADCAP'],
...
export default function SuppliersClient() {
  ...
  const filtered = suppliers
    .filter((s) => {
      ...
      const matchesSearch = !searchTerm || s.name.toLowerCase().includes(searchTerm.toLowerCase()) || s.code.toLowerCase().includes(searchTerm.toLowerCase()) || s.categories.some((c) => c.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case 'otd': return b.onTimeDelivery - a.onTimeDelivery;
        default: return a.name.localeCompare(b.name);
      }
    });

  const totalSpend = suppliers.reduce((s, sup) => s + sup.totalSpend, 0);
  const avgOTD = Math.round(suppliers.reduce((s, sup) => s + sup.onTimeDelivery, 0) / suppliers.length);
  const avgQuality = Math.round(suppliers.reduce((s, sup) => s + sup.qualityScore, 0) / suppliers.length);
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input type="text" aria-label="Search suppliers, categories..." placeholder="Search suppliers, categories..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sky-500" />
        </div>
              ...
              {isExpanded && (
                <div className="border-t border-gray-100 dark:border-gray-700 p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      { label: 'On-Time Delivery', value: sup.onTimeDelivery, color: sup.onTimeDelivery >= 95 ? 'bg-green-500' : sup.onTimeDelivery >= 85 ? 'bg-amber-500' : 'bg-red-500' },
                      { label: 'Quality Score', value: sup.qualityScore, color: sup.qualityScore >= 95 ? 'bg-green-500' : sup.qualityScore >= 85 ? 'bg-amber-500' : 'bg-red-500' },
