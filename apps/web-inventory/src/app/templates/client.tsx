      ...
      case 'textarea':
        return (
          <div key={field.name} className="col-span-2">
            ...
            <textarea
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-lime-500 focus:ring-1 focus:ring-lime-500"
              rows={4}
    ...
    <div className="space-y-6">
      ...
      <div className="bg-lime-50 rounded-xl p-6 border border-lime-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Inventory Templates</h1>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex items-center gap-4">
            ...
            <select
              className="rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-lime-500 focus:ring-1 focus:ring-lime-500"
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-white bg-lime-600 hover:bg-lime-700 rounded-lg transition-colors"
                  >
