...
describe('GET /api/approvals', () => {
  it('should return approvals', async () => {
    (prisma as any).docApproval.findMany.mockResolvedValue([{ id: '1', title: 'Test' }]);
...
describe('GET /api/approvals/:id', () => {
  ...
  it('should return item by id', async () => {
    (prisma as any).docApproval.findFirst.mockResolvedValue({ id: '1' });
...
describe('PUT /api/approvals/:id', () => {
  it('should update', async () => {
    (prisma as any).docApproval.findFirst.mockResolvedValue({ id: '1' });
    (prisma as any).docApproval.update.mockResolvedValue({ id: '1', title: 'Updated' });
...
describe('DELETE /api/approvals/:id', () => {
  it('should soft delete', async () => {
    (prisma as any).docApproval.findFirst.mockResolvedValue({ id: '1' });
    (prisma as any).docApproval.update.mockResolvedValue({ id: '1' });
