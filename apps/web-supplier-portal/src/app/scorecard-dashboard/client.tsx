...
import { TrendingUp, TrendingDown, Minus, Award, Star, AlertTriangle, ArrowRight } from 'lucide-react';
...
const MOCK_SUPPLIERS: SupplierScorecard[] = [
  {
    id: 'SUP-001', name: 'Precision Parts Ltd', category: 'Raw Materials', tier: 'Strategic',
    currentScore: 92, previousScore: 88, grade: 'A', riskLevel: 'Low', ncrCount: 1, onTimeDelivery: 97, qualityPpm: 150, leadTimeDays: 5,
    history: [
      { period: 'Q3 2025', quality: 85, delivery: 88, responsiveness: 82, cost: 90, compliance: 87, overall: 86, grade: 'B' },
      { period: 'Q4 2025', quality: 88, delivery: 90, responsiveness: 85, cost: 88, compliance: 90, overall: 88, grade: 'B' },
      { period: 'Q1 2026', quality: 93, delivery: 95, responsiveness: 88, cost: 90, compliance: 94, overall: 92, grade: 'A' },
    ],
  },
  {
    id: 'SUP-002', name: 'FastShip Logistics', category: 'Logistics', tier: 'Preferred',
    currentScore: 85, previousScore: 87, grade: 'B', riskLevel: 'Low', ncrCount: 2, onTimeDelivery: 94, qualityPpm: 0, leadTimeDays: 3,
    history: [
      { period: 'Q3 2025', quality: 90, delivery: 82, responsiveness: 88, cost: 85, compliance: 86, overall: 86, grade: 'B' },
      { period: 'Q4 2025', quality: 88, delivery: 86, responsiveness: 90, cost: 84, compliance: 88, overall: 87, grade: 'B' },
      { period: 'Q1 2026', quality: 85, delivery: 84, responsiveness: 88, cost: 83, compliance: 85, overall: 85, grade: 'B' },
    ],
  },
  {
    id: 'SUP-003', name: 'TechCoat Surfaces', category: 'Surface Treatment', tier: 'Approved',
    currentScore: 78, previousScore: 72, grade: 'C', riskLevel: 'Medium', ncrCount: 4, onTimeDelivery: 88, qualityPpm: 450, leadTimeDays: 10,
    history: [
      { period: 'Q3 2025', quality: 68, delivery: 75, responsiveness: 70, cost: 78, compliance: 72, overall: 72, grade: 'C' },
      { period: 'Q4 2025', quality: 70, delivery: 73, responsiveness: 72, cost: 76, compliance: 70, overall: 72, grade: 'C' },
      { period: 'Q1 2026', quality: 78, delivery: 80, responsiveness: 76, cost: 78, compliance: 78, overall: 78, grade: 'C' },
    ],
  },
  {
    id: 'SUP-004', name: 'Global Metals Inc', category: 'Raw Materials', tier: 'Strategic',
    currentScore: 95, previousScore: 93, grade: 'A', riskLevel: 'Low', ncrCount: 0, onTimeDelivery: 99, qualityPpm: 50, leadTimeDays: 7,
    history: [
      { period: 'Q3 2025', quality: 92, delivery: 94, responsiveness: 90, cost: 91, compliance: 93, overall: 92, grade: 'A' },
      { period: 'Q4 2025', quality: 93, delivery: 95, responsiveness: 92, cost: 90, compliance: 94, overall: 93, grade: 'A' },
      { period: 'Q1 2026', quality: 96, delivery: 97, responsiveness: 93, cost: 92, compliance: 95, overall: 95, grade: 'A' },
    ],
  },
  {
    id: 'SUP-005', name: 'PackRight Solutions', category: 'Packaging', tier: 'Approved',
    currentScore: 71, previousScore: 76, grade: 'C', riskLevel: 'High', ncrCount: 6, onTimeDelivery: 82, qualityPpm: 800, leadTimeDays: 4,
    history: [
      { period: 'Q3 2025', quality: 78, delivery: 80, responsiveness: 75, cost: 82, compliance: 78, overall: 78, grade: 'C' },
      { period: 'Q4 2025', quality: 76, delivery: 77, responsiveness: 73, cost: 80, compliance: 74, overall: 76, grade: 'C' },
      { period: 'Q1 2026', quality: 70, delivery: 72, responsiveness: 68, cost: 78, compliance: 68, overall: 71, grade: 'C' },
    ],
  },
  {
    id: 'SUP-006', name: 'ElectroComp Systems', category: 'Electronic Components', tier: 'Preferred',
    currentScore: 89, previousScore: 86, grade: 'B', riskLevel: 'Low', ncrCount: 1, onTimeDelivery: 96, qualityPpm: 200, leadTimeDays: 8,
    history: [
      { period: 'Q3 2025', quality: 84, delivery: 88, responsiveness: 85, cost: 83, compliance: 85, overall: 85, grade: 'B' },
      { period: 'Q4 2025', quality: 86, delivery: 87, responsiveness: 86, cost: 84, compliance: 86, overall: 86, grade: 'B' },
      { period: 'Q1 2026', quality: 90, delivery: 91, responsiveness: 88, cost: 86, compliance: 90, overall: 89, grade: 'B' },
    ],
  },
  {
    id: 'SUP-007', name: 'QuickMold Tooling', category: 'Tooling', tier: 'Conditional',
    currentScore: 62, previousScore: 58, grade: 'D', riskLevel: 'High', ncrCount: 8, onTimeDelivery: 75, qualityPpm: 1200, leadTimeDays: 15,
    history: [
      { period: 'Q3 2025', quality: 55, delivery: 60, responsiveness: 58, cost: 65, compliance: 52, overall: 58, grade: 'D' },
      { period: 'Q4 2025', quality: 56, delivery: 58, responsiveness: 60, cost: 62, compliance: 54, overall: 58, grade: 'D' },
      { period: 'Q1 2026', quality: 62, delivery: 65, responsiveness: 60, cost: 64, compliance: 58, overall: 62, grade: 'D' },
    ],
  },
];
...
export default function ScorecardDashboardClient() {
  ...
  const suppliers = useMemo(() => {
    ...
    else filtered.sort((a, b) => { const r: Record<string, number> = { High: 0, Medium: 1, Low: 2 }; return (r[a.riskLevel] ?? 2) - (r[b.riskLevel] ?? 2); });
    return filtered;
  }, [filterTier, filterRisk, sortBy]);

  // Summary
  const avgScore = Math.round(MOCK_SUPPLIERS.reduce((s, sup) => s + sup.currentScore, 0) / MOCK_SUPPLIERS.length);
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-[10px] font-medium rounded-full px-2 py-0.5 ${riskConfig[supplier.riskLevel]}`}>{supplier.riskLevel}</span>
                </div>
              </div>
