...
export default function SuppliersClient() {
  ...
  function openEdit(item: Supplier) {
    setForm({
      ...
      status: item.status || 'PROSPECTIVE',
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-blue-600">
                {items.filter((i) => i.status === 'PROSPECTIVE').length}
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Prospective</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Critical Tier</p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <TableBody>
                    {items.map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>
                          <span
                            className={`px-2 py-1 rounded-full text-xs font-medium ${getTierColor(item.tier)}`}
                          >
                            {item.tier || '-'}
                          </span>
                        </TableCell>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setForm((p) => ({ ...p, approvedDate: e.target.value }))}
                  />
                </div>
                <div>
