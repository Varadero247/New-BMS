      ...
      <div className="max-w-7xl mx-auto">
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-teal-600">
                {items.length > 0
                  ? Math.round(items.reduce((a, b) => a + (b.overallScore || 0), 0) / items.length)
                  : 0}
                %
              </p>
        ...
        {modalOpen && (
          <Modal
            ...
            title={editId ? 'Edit Scorecard' : 'Add Scorecard'}
            size="lg"
          >
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-5 gap-4">
                ...
                <div>
                  <Label>Response (0-100)</Label>
                  <Input
                    type="number"
                    min="0"
                    max="100"
                    value={form.responsiveness}
                    onChange={(e) => setForm((p) => ({ ...p, responsiveness: e.target.value }))}
                    placeholder="0"
                  />
                </div>
                <div>
              ...
              <div className="p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg">
                <p className="text-sm text-teal-700 dark:text-teal-300">
                  Overall Score: <span className="font-bold text-lg">{calcOverall()}%</span>
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
