...
export default function SpendClient() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      console.error('Failed to save spend record:', err);
    } finally {
      setSaving(false);
    }
  }
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Track and analyse supplier spend
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-teal-600">{formatCurrency(totalSpend)}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Total Spend</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-blue-600">{formatCurrency(avgSpend)}</p>
        ...
        <div className="flex gap-4 mb-6 flex-wrap items-center">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              type="text"
              aria-label="Search spend records"
        ...
        {modalOpen && (
          <Modal
            ...
            title={editId ? 'Edit Spend Record' : 'Add Spend Record'}
            size="lg"
          >
            ...
            <ModalFooter>
              ...
              <Button
                ...
                disabled={saving || !form.supplierId || !form.period || !form.amount}
              >
                {saving ? (
                  <>
