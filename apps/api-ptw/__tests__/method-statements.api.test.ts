...
jest.mock('../src/prisma', () => ({
  prisma: { ptwMethodStatement: { findMany: jest.fn(), findFirst: jest.fn(), create: jest.fn(), update: jest.fn(), count: jest.fn() } },
  Prisma: {},
}));
...
const app = express(); app.use(express.json()); app.use('/api/method-statements', router);
