        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Contract notice tracking and acknowledgements
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Total Notices</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-red-600">
                {items.filter((n) => n.priority === 'CRITICAL').length}
              </p>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-amber-600">
                {items.filter((n) => isDueOrOverdue(n.dueDate) && !n.acknowledged).length}
              </p>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-green-600">
                {items.filter((n) => n.acknowledged).length}
              </p>
                  ...
                  <TableBody>
                    {items.map((item) => (
                      <TableRow
                        key={item.id}
                        className={
                          isDueOrOverdue(item.dueDate) && !item.acknowledged
          ...
          >
              ...
              <div className="grid grid-cols-3 gap-4 items-end">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setForm((p) => ({ ...p, acknowledgedBy: e.target.value }))}
                    placeholder="User ID"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setForm((p) => ({ ...p, acknowledgedAt: e.target.value }))}
                  />
                </div>
              </div>
            </div>
            <ModalFooter>
              ...
              <Button
                ...
                disabled={saving || !form.contractId || !form.title || !form.dueDate}
              >
                {saving ? (
                  <>
