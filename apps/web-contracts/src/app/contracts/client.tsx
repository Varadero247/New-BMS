      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Manage all contracts and agreements
            </p>
          </div>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-amber-600">
                {items.filter((c) => c.status === 'PENDING_APPROVAL').length}
              </p>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-red-600">
                {items.filter((c) => c.status === 'EXPIRED').length}
              </p>
        ...
        {modalOpen && (
          <Modal
            ...
            title={editId ? 'Edit Contract' : 'Add Contract'}
            size="lg"
          >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, counterpartyContact: e.target.value }))
                    }
