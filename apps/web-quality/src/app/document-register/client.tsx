...
const MOCK_DOCUMENTS: ControlledDocument[] = [
  {
    ...
    isoClause: '4.4',
    description:
      'Top-level QMS manual describing the scope, processes, and interactions of the quality management system.',
    revisionHistory: [
      {
        rev: 'Rev 5',
        date: '2026-01-15',
        author: 'J. Smith',
        changes: 'Updated for ISO 9001:2015 transition audit findings',
      },
      {
        rev: 'Rev 4',
        date: '2025-06-20',
        author: 'J. Smith',
        changes: 'Annual review — minor formatting updates',
      },
      {
        rev: 'Rev 3',
        date: '2024-12-10',
        author: 'M. Jones',
        changes: 'Added remote work process references',
      },
    ],
  },
  {
    ...
    isoClause: '5.2',
    description:
      "Statement of the organisation's commitment to quality, customer satisfaction, and continual improvement.",
    revisionHistory: [
      {
        rev: 'Rev 3',
        date: '2026-01-05',
        author: 'CEO',
        changes: 'Refreshed for 2026 strategic objectives',
      },
    ],
  },
  {
    id: '3',
    docNumber: 'QMS-PRO-001',
    ...
    isoClause: '7.5',
    description:
      'Defines the process for creating, reviewing, approving, distributing, and retiring controlled documents.',
    revisionHistory: [
      {
        rev: 'Rev 4',
        date: '2025-11-20',
        author: 'A. Patel',
        changes: 'Added electronic signature requirements',
      },
      {
        rev: 'Rev 3',
        date: '2025-03-15',
        author: 'A. Patel',
        changes: 'Added retention schedule table',
      },
    ],
  },
  {
    id: '4',
    docNumber: 'QMS-PRO-002',
    ...
    isoClause: '9.2',
    description:
      'Defines the planning, execution, and follow-up of internal QMS audits including auditor competence.',
    revisionHistory: [
      {
        rev: 'Rev 6',
        date: '2026-02-01',
        author: 'R. Brown',
        changes: 'Under review — adding remote audit provisions',
      },
    ],
  },
  {
    id: '5',
    docNumber: 'QMS-PRO-003',
    title: 'Non-Conformance Management Procedure',
    category: 'Procedure',
    status: 'Approved',
    currentRevision: 'Rev 5',
    revisionDate: '2025-09-10',
    ...
    isoClause: '10.2',
    description:
      'Describes the identification, recording, investigation, and closure of non-conformances.',
    revisionHistory: [
      {
        rev: 'Rev 5',
        date: '2025-09-10',
        author: 'A. Patel',
        changes: 'Added containment action requirements',
      },
    ],
  },
  {
    id: '6',
    docNumber: 'QMS-WI-001',
    title: 'Incoming Inspection Work Instruction',
    category: 'Work Instruction',
    status: 'Approved',
    currentRevision: 'Rev 3',
    revisionDate: '2025-08-15',
    ...
    isoClause: '8.6',
    description:
      'Step-by-step instructions for receiving inspection of incoming materials and components.',
    revisionHistory: [
      {
        rev: 'Rev 3',
        date: '2025-08-15',
        author: 'L. Chen',
        changes: 'Updated sampling plan per AQL changes',
      },
    ],
  },
  {
    id: '7',
    docNumber: 'QMS-WI-045',
    title: 'CNC Machine Setup — Part Family A',
    category: 'Work Instruction',
    status: 'Draft',
    ...
    revisionHistory: [
      {
        ...
        date: '2026-02-10',
        author: 'M. Jones',
        changes: 'Initial draft — pending review',
      },
    ],
  },
  {
    id: '8',
    docNumber: 'QMS-FRM-001',
    title: 'CAPA Request Form',
    category: 'Form',
    status: 'Approved',
    currentRevision: 'Rev 2',
    revisionDate: '2025-07-22',
    ...
    revisionHistory: [
      {
        ...
        date: '2025-07-22',
        author: 'A. Patel',
        changes: 'Added root cause analysis section',
      },
    ],
  },
  {
    id: '9',
    docNumber: 'QMS-SPC-001',
    title: 'Material Specification — Aluminium 6061-T6',
    ...
    isoClause: '8.4',
    description:
      'Defines the chemical composition, mechanical properties, and testing requirements for Aluminium 6061-T6.',
    revisionHistory: [
  ...
  },
  {
    ...
    isoClause: '7.1.5',
    description:
      'Standard operating procedure for the calibration of measuring and test equipment. Superseded by QMS-PRO-010.',
    revisionHistory: [
      {
        rev: 'Rev 3',
        date: '2024-06-15',
        author: 'L. Chen',
        changes: 'Obsoleted — replaced by QMS-PRO-010',
      },
    ],
  },
  {
    id: '11',
    docNumber: 'QMS-REC-001',
    ...
    isoClause: '9.3',
    description:
      'Template for recording management review meetings, inputs, outputs, and action items.',
    revisionHistory: [
...
export default function DocumentRegisterClient() {
  ...
  const filtered = useMemo(() => {
    return documents.filter((doc) => {
      if (
        search &&
        !`${doc.docNumber} ${doc.title} ${doc.owner}`.toLowerCase().includes(search.toLowerCase())
      )
        return false;
  ...
  const overdueReviews = documents.filter(
    (d) => d.status === 'Approved' && isOverdue(d.nextReviewDate)
  ).length;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            ISO 9001:2015 Clause 7.5 — Controlled documents, revision history, and review schedules
          </p>
        </div>
        <a
          href="/documents"
            ...
            {filtered.map((doc) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2.5 px-3 text-gray-900 dark:text-gray-100 font-medium max-w-[250px] truncate">
                    {doc.title}
                  </td>
                  ...
                  <td className="py-2.5 px-3">
                    <span
                      className={`font-mono ${overdue ? 'text-red-600 font-bold' : 'text-gray-500 dark:text-gray-400'}`}
                    >
      ...
      {selectedDoc && (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-5">
          <div className="flex items-start justify-between mb-4">
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <span
                  className={`text-[10px] font-medium rounded-full px-2 py-0.5 ${statusConfig[selectedDoc.status].bg} ${statusConfig[selectedDoc.status].text}`}
                >
                  {selectedDoc.status}
                </span>
                <Badge variant="secondary" className="text-[9px]">
          ...
          <div className="grid grid-cols-4 gap-4 text-xs mb-4">
            ...
            <div>
              <span className="text-gray-500 dark:text-gray-400">Revision Date:</span>{' '}
              <span className="font-medium text-gray-900 dark:text-gray-100">
                {selectedDoc.revisionDate}
              </span>
            </div>
            <div>
            ...
            <div>
              <span className="text-gray-500 dark:text-gray-400">ISO Clause:</span>{' '}
              <span className="font-mono font-medium text-gray-900 dark:text-gray-100">
                {selectedDoc.isoClause}
              </span>
            </div>
            <div>
              <span className="text-gray-500 dark:text-gray-400">Next Review:</span>{' '}
              <span
                className={`font-medium ${isOverdue(selectedDoc.nextReviewDate) ? 'text-red-600' : 'text-gray-900 dark:text-gray-100'}`}
              >
          ...
          <div className="border border-gray-100 dark:border-gray-700 rounded-lg overflow-x-auto">
            <table className="w-full text-[11px]">
              ...
              <tbody className="divide-y divide-gray-50">
                {selectedDoc.revisionHistory.map((rev, i) => (
                  <tr key={i}>
                    <td className="py-2 px-3 font-mono font-medium text-gray-700 dark:text-gray-300">
                      {rev.rev}
                    </td>
