      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Quality Templates</h1>
              <p className="text-gray-500 dark:text-gray-400 mt-1">ISO 9001 quality management templates</p>
            </div>
          </div>
        </div>
              ...
              <Card key={template.id} className="hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
                <CardContent className="pt-6">
                  <div className="flex items-start justify-between mb-3">
                    <Badge className="bg-blue-100 text-blue-700 text-xs font-mono">{template.code}</Badge>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white" onClick={() => handleUse(template)}>
                      Use
                    </Button>
        ...
        >
          {selectedTemplate && (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <Badge className="bg-blue-100 text-blue-700 font-mono">{selectedTemplate.code}</Badge>
          ...
          <ModalFooter>
            ...
            <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={() => selectedTemplate && handleUse(selectedTemplate)}>
              Use Template
            </Button>
          </ModalFooter>
        </Modal>
