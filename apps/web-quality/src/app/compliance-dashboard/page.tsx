...
> = {
  compliant: {
    ...
    darkColor: 'dark:text-green-300 dark:bg-green-900/40',
    variant: 'success',
  },
  partial: {
    label: 'Partial',
    color: 'text-yellow-700 bg-yellow-100',
    darkColor: 'dark:text-yellow-300 dark:bg-yellow-900/40',
    variant: 'warning',
  },
  'non-compliant': {
    label: 'Non-Compliant',
    color: 'text-red-700 bg-red-100',
    darkColor: 'dark:text-red-300 dark:bg-red-900/40',
    variant: 'danger',
  },
  'not-assessed': {
    label: 'Not Assessed',
    color: 'text-gray-600 bg-gray-100',
    darkColor: 'dark:text-gray-400 dark:bg-gray-700/40',
    variant: 'default',
  },
};
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-muted-foreground">Compliant: {compliantClauses}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="h-2.5 w-2.5 rounded-full bg-yellow-500" />
                <span className="text-muted-foreground">Partial: {partialClauses}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="h-2.5 w-2.5 rounded-full bg-red-500" />
                <span className="text-muted-foreground">Non-Compliant: {nonCompliantClauses}</span>
              </div>
              <div className="flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-2 p-2 rounded-md bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/30">
                ...
                <div className="text-xs">
                  <span className="font-medium text-yellow-800 dark:text-yellow-300">
                    &sect;9.2 Internal Audit
                  </span>
                  <span className="text-yellow-600 dark:text-yellow-400">
                    {' '}
                    &mdash; due in 14 days
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-2 p-2 rounded-md bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/30">
                ...
                <div className="text-xs">
                  <span className="font-medium text-yellow-800 dark:text-yellow-300">
                    &sect;9.3 Management Review
                  </span>
                  <span className="text-yellow-600 dark:text-yellow-400">
                    {' '}
                    &mdash; Q1 2026 pending
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-2 p-2 rounded-md bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800/30">
                ...
                <div className="text-xs">
                  <span className="font-medium text-orange-800 dark:text-orange-300">
                    &sect;7.1.5 Calibrations
                  </span>
                  <span className="text-orange-600 dark:text-orange-400"> &mdash; 2 overdue</span>
                </div>
              </div>
                ...
                <div className="border-t border-border">
                  <table className="w-full text-sm">
                    <thead className="bg-muted/50">
                      <tr>
                        <th className="text-left px-4 py-2 font-medium text-foreground w-20">
                          Clause
                        </th>
                        <th className="text-left px-4 py-2 font-medium text-foreground">
                          Requirement
                        </th>
                        <th className="text-left px-4 py-2 font-medium text-foreground w-32">
                          Status
                        </th>
                        ...
                        return (
                          <tr key={sub.id} className="hover:bg-muted/30">
                            ...
                            <td className="px-4 py-2">
                              <span
                                className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${subSc.color} ${subSc.darkColor}`}
                              >
                                {subSc.label}
                              </span>
                            </td>
