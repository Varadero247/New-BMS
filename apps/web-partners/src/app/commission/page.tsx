                    ...
                    {history.map((deal) => (
                      <tr key={deal.id} className="hover:bg-gray-800/50">
                        ...
                        <td className="py-3 px-6 text-sm text-gray-400">
                          {fmt(deal.actualACV || 0)}
                        </td>
                        <td className="py-3 px-6 text-sm text-gray-400">
                          {(deal.commissionRate * 100).toFixed(1)}%
                        </td>
                        <td className="py-3 px-6 text-sm text-green-400">
                          {fmt(deal.commissionValue || 0)}
                        </td>
                        <td className="py-3 px-6">
                          <span
                            className={`px-2 py-0.5 rounded-full text-xs ${deal.commissionPaid ? 'bg-green-500/20 text-green-400' : 'bg-yellow-500/20 text-yellow-400'}`}
                          >
                        ...
                        <td className="py-3 px-6 text-sm text-gray-400">
                          {deal.closedAt
                            ? new Date(deal.closedAt).toLocaleDateString('en-GB')
                            : '—'}
                        </td>
                      </tr>
                    ))}
