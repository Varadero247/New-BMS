        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Annual audit programme planning and tracking
            </p>
          </div>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-blue-600">
                {programmes.filter((p) => p.status === 'COMPLETED').length}
              </p>
                    ...
                    {programmes.map((prog) => (
                      <TableRow key={prog.id}>
                        ...
                        <TableCell className="text-sm">
                          {Array.isArray(prog.auditIds) ? prog.auditIds.length : 0} linked
                        </TableCell>
                        <TableCell>
        ...
        {modalOpen && (
          ...
          >
            <div className="space-y-4">
              ...
              <div>
                <Label>Linked Audit IDs (comma-separated)</Label>
                <Input
                  value={form.auditIds}
                  onChange={(e) => setForm((p) => ({ ...p, auditIds: e.target.value }))}
