      ...
      <div className="max-w-7xl mx-auto">
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-3xl font-bold text-amber-600">
                {audits.filter((a) => a.status === 'PLANNED' || a.status === 'SCHEDULED').length}
              </p>
                  ...
                  <TableBody>
                    {audits.map((audit) => (
                      <TableRow key={audit.id}>
                        ...
                        <TableCell>
                          <Badge variant="outline">{audit.type?.replace(/_/g, ' ') || '-'}</Badge>
                        </TableCell>
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                            <Button size="sm" variant="outline" onClick={() => openEdit(audit)}>
                              Edit
                            </Button>
                            <Button
                              size="sm"
        ...
        {modalOpen && (
          <Modal
            ...
            title={editId ? 'Edit Audit' : 'New Audit'}
            size="lg"
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  value={form.leadAuditorName}
                  onChange={(e) => setForm((p) => ({ ...p, leadAuditorName: e.target.value }))}
