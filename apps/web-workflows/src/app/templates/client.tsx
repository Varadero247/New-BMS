    ...
    <div className="space-y-6">
      ...
      <div className="bg-violet-50 rounded-xl p-6 border border-violet-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-violet-600 mt-1">Change request and process workflow templates</p>
          </div>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex items-center gap-4">
            ...
            <select
              className="rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-violet-500 focus:ring-1 focus:ring-violet-500"
            ...
            <Card key={template.id} className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-3">
                  <Badge className="bg-violet-50 text-violet-600 text-xs font-mono">
                    {template.code}
                  </Badge>
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-white bg-violet-600 hover:bg-violet-700 rounded-lg transition-colors"
                  >
      ...
      >
        {selectedTemplate && (
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Badge className="bg-violet-50 text-violet-600 font-mono">{selectedTemplate.code}</Badge>
      ...
      >
        ...
        <ModalFooter>
          ...
          <Button className="bg-violet-600 hover:bg-violet-700 text-white" onClick={handleSubmitUse}>
            Submit
          </Button>
        </ModalFooter>
      </Modal>
