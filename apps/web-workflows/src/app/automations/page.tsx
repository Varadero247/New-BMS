...
import {
  Zap, Plus, Search, CheckCircle, AlertTriangle, Play, Clock,
...
const MOCK_RULES: AutomationRule[] = [
  { id: '1', name: 'Auto-assign NCR to Quality Manager', description: 'Assigns newly created NCRs to the quality manager on call.', triggerType: 'ON_CREATE', priority: 1, isActive: true, lastExecutedAt: new Date(Date.now() - 3600000).toISOString(), executionCount: 47, successCount: 46, failureCount: 1, definition: { name: 'NCR Workflow' } },
  { id: '2', name: 'Escalate overdue CAPA', description: 'Sends escalation email when CAPA due date is exceeded by 3 days.', triggerType: 'SCHEDULED', priority: 2, isActive: true, lastExecutedAt: new Date(Date.now() - 86400000).toISOString(), executionCount: 120, successCount: 120, failureCount: 0, definition: null },
  { id: '3', name: 'Auto-close incident on CAPA closure', description: 'Closes the linked incident when all CAPAs are marked complete.', triggerType: 'ON_STATUS_CHANGE', priority: 3, isActive: true, lastExecutedAt: new Date(Date.now() - 7200000).toISOString(), executionCount: 34, successCount: 33, failureCount: 1, definition: { name: 'Incident Workflow' } },
  { id: '4', name: 'Notify manager on high-risk assessment', description: 'Sends notification when risk score exceeds 20.', triggerType: 'ON_FIELD_CHANGE', priority: 4, isActive: false, lastExecutedAt: null, executionCount: 0, successCount: 0, failureCount: 0, definition: null },
  { id: '5', name: 'Weekly compliance summary', description: 'Generates and emails weekly compliance status report every Monday.', triggerType: 'SCHEDULED', priority: 5, isActive: true, lastExecutedAt: new Date(Date.now() - 4 * 86400000).toISOString(), executionCount: 52, successCount: 52, failureCount: 0, definition: null },
  { id: '6', name: 'Webhook: Jira issue → CAPA', description: 'Creates a CAPA from inbound Jira webhook payload.', triggerType: 'WEBHOOK', priority: 6, isActive: false, lastExecutedAt: new Date(Date.now() - 14 * 86400000).toISOString(), executionCount: 8, successCount: 7, failureCount: 1, definition: { name: 'CAPA Workflow' } },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <div className="relative flex-1 min-w-48">
          ...
          <input
            type="text"
            aria-label="Search rules..." placeholder="Search rules..."
            value={search}
        ...
        >
          ...
          {['ON_CREATE','ON_UPDATE','ON_STATUS_CHANGE','ON_FIELD_CHANGE','SCHEDULED','MANUAL','WEBHOOK'].map(t => (
