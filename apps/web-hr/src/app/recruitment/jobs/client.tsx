...
const jobs: Job[] = [
  {
    ...
    description:
      'Lead quality initiatives including CAPA management, process validation, and ISO 13485 compliance for medical device manufacturing.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Coordinate environmental, health, and safety programs across multiple sites. Support ISO 14001 and ISO 45001 management systems.',
    requirements: [
      'NEBOSH Certificate',
  ...
  },
  {
    ...
    description:
      'Develop and maintain the Integrated Management System platform. Full-stack role with React/Next.js frontend and Node.js backend.',
    requirements: [
  ...
  },
  {
    ...
    hiringManager: 'CISO',
    description:
      'Support the ISO 27001 ISMS programme. Conduct risk assessments, manage vulnerability scanning, and support incident response.',
    requirements: [
  ...
  },
  {
    ...
    description:
      '6-month internship supporting supply chain operations, supplier quality management, and inventory control.',
    requirements: [
      'Studying Supply Chain, Engineering, or Business',
  ...
  },
  {
    ...
    hiringManager: 'Dr. Sarah Chen',
    description:
      'Lead regulatory submissions for medical devices. Manage CE marking, FDA 510(k), and international registrations.',
    requirements: [
      'MSc in Regulatory Science or related',
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Active vacancies and recruitment pipeline
        </p>
      </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <span className={`px-1.5 py-0.5 rounded text-xs font-medium ${tc.color}`}>
                          {tc.label}
                        </span>
                      </div>
                    </div>
              ...
              {isExpanded && (
                <div className="px-4 py-3 bg-gray-50 dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 ml-12 space-y-2">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                    ...
                    <div>
                      <span className="text-gray-500 dark:text-gray-400">Hiring Mgr:</span>{' '}
