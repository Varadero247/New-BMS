    ...
    <div className="space-y-6">
      ...
      <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">HR Templates</h1>
            <p className="text-emerald-600 mt-1">Human resources forms and assessment templates</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 text-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                value={search}
                onChange={(e) => setSearch(e.target.value)}
              />
            </div>
            <select
              className="rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
            ...
            <Card key={template.id} className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-3">
                  <Badge className="bg-emerald-50 text-emerald-600 text-xs font-mono">
                    {template.code}
                  </Badge>
      ...
      >
        {selectedTemplate && (
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Badge className="bg-emerald-50 text-emerald-600 font-mono">{selectedTemplate.code}</Badge>
      ...
      >
        ...
        <ModalFooter>
          ...
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white" onClick={handleSubmitUse}>
            Submit
          </Button>
        </ModalFooter>
      </Modal>
