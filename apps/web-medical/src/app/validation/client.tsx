...
const activities: ValidationActivity[] = [
  {
    id: '1',
    validationId: 'VAL-CMX3-001',
    title: 'Clinical Evaluation — 30-day Monitoring Study',
    product: 'CardioMonitor Pro X3',
    type: 'clinical-evaluation',
    status: 'completed',
    protocol: 'PROT-CMX3-CE-001 v2.0',
  ...
  },
  {
    ...
    title: 'Summative Usability Test — IEC 62366',
    product: 'CardioMonitor Pro X3',
    type: 'usability',
    status: 'completed',
    protocol: 'PROT-CMX3-USE-001 v1.3',
  ...
  },
  {
    ...
    title: 'Formative Usability Study — Round 2',
    product: 'NeuroStim Controller V2',
    type: 'usability',
    status: 'in-execution',
    protocol: 'PROT-NSV2-USE-002 v1.0',
  ...
  },
  {
    ...
    title: 'Software Validation — IEC 62304 Class C',
    product: 'NeuroStim Controller V2',
    type: 'software-validation',
    status: 'protocol-approved',
    protocol: 'PROT-NSV2-SW-001 v1.0',
  ...
  },
  {
    ...
    title: 'Process Validation — Sterilization (EtO)',
    product: 'OrthoFix Implant Kit',
    type: 'process-validation',
    status: 'completed',
    protocol: 'PROT-OFK-STER-001 v3.0',
  ...
  },
  {
    ...
    title: 'Packaging Validation — ASTM D4169',
    product: 'SurgiView Endoscope',
    type: 'packaging',
    status: 'report-draft',
    protocol: 'PROT-SVE-PKG-001 v1.0',
  ...
  },
  {
    ...
    title: 'Shelf-Life Validation — Accelerated Ageing',
    product: 'DiagnosScan Portable',
    type: 'shelf-life',
    status: 'planned',
    protocol: 'PROT-DSP-SL-001 v0.5',
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Clinical evaluation, usability, and process validation — ISO 13485:2016 Clause 7.3.7
        </p>
      </div>
                ...
                <div className="px-4 py-3 bg-gray-50 dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 space-y-2 ml-7">
                  ...
                  {activity.findings > 0 && (
                    <div className="flex items-center gap-1 text-xs text-amber-600">
                      <AlertTriangle className="h-3 w-3" /> {activity.findings} finding(s)
                      identified
                    </div>
                  )}
