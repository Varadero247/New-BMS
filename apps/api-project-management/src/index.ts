...
dotenv.config();
initSentry('api-project-management');
initTracing({ serviceName: 'api-project-management' });
...
app.get('/health', createHealthCheck('api-project-management', prisma as unknown as Parameters<typeof createHealthCheck>[1], '1.0.0'));
