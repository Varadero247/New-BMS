  ...
  try {
    ...
    const document = await prisma.projectDocument.create({
      data: {
        ...
        accessLevel: (data.accessLevel || 'PROJECT_TEAM') as import('@ims/database/project-management').DocumentAccessLevel,
        status: (data.status || 'DRAFT') as import('@ims/database/project-management').PmDocumentStatus,
