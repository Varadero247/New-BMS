  ...
  try {
    ...
    const stakeholder = await prisma.projectStakeholder.create({
      data: {
        ...
        stakeholderCategory,
        currentEngagement: (data.currentEngagement || 'NEUTRAL') as import('@ims/database/project-management').EngagementLevel,
        desiredEngagement: (data.desiredEngagement || 'SUPPORTIVE') as import('@ims/database/project-management').EngagementLevel,
        engagementStrategy: data.engagementStrategy,
        communicationFrequency: (data.communicationFrequency || 'MONTHLY') as import('@ims/database/project-management').CommunicationFrequency,
        communicationMethod: data.communicationMethod,
        requirements: data.requirements,
        expectations: data.expectations,
        status: (data.status || 'ACTIVE') as import('@ims/database/project-management').StakeholderStatus,
      },
    });
