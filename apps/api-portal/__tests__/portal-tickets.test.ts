...
describe('GET /api/portal/tickets', () => {
  it('should list tickets', async () => {
    const items = [{ id: '00000000-0000-0000-0000-000000000001', number: 'PTL-TKT-2602-1234', subject: 'Login issue', status: 'OPEN', messages: [] }];
...
describe('POST /api/portal/tickets', () => {
  it('should create a ticket', async () => {
    const ticket = { id: '00000000-0000-0000-0000-000000000001', number: 'PTL-TKT-2602-1234', subject: 'Login issue', status: 'OPEN' };
...
describe('GET /api/portal/tickets/:id', () => {
  it('should return ticket with messages', async () => {
    const ticket = { id: '00000000-0000-0000-0000-000000000001', subject: 'Login issue', messages: [{ id: 'm-1', message: 'Help' }] };
...
describe('PUT /api/portal/tickets/:id', () => {
  it('should update a ticket', async () => {
    (prisma as any).portalTicket.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).portalTicket.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', priority: 'LOW' });
...
describe('GET /api/portal/tickets/:id/messages', () => {
  it('should list messages', async () => {
    ...
    const res = await request(app).get('/api/portal/tickets/00000000-0000-0000-0000-000000000001/messages');
  ...
  it('should return 404 if ticket not found for messages', async () => {
    ...
    const res = await request(app).get('/api/portal/tickets/00000000-0000-0000-0000-000000000099/messages');
...
describe('PUT /api/portal/tickets/:id/resolve', () => {
  ...
  it('should return 400 if ticket already closed', async () => {
    (prisma as any).portalTicket.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', status: 'CLOSED' });
