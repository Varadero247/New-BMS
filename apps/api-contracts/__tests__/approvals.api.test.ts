...
describe('GET /api/approvals', () => {
  it('should return approvals', async () => {
    (prisma as any).contApproval.findMany.mockResolvedValue([{ id: '00000000-0000-0000-0000-000000000001', title: 'Test' }]);
...
describe('GET /api/approvals/:id', () => {
  ...
  it('should return item by id', async () => {
    (prisma as any).contApproval.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
...
describe('POST /api/approvals', () => {
  it('should create', async () => {
    ...
    (prisma as any).contApproval.create.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', title: 'New' });
...
describe('PUT /api/approvals/:id', () => {
  it('should update', async () => {
    (prisma as any).contApproval.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).contApproval.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', title: 'Updated' });
...
describe('DELETE /api/approvals/:id', () => {
  it('should soft delete', async () => {
    (prisma as any).contApproval.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).contApproval.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
