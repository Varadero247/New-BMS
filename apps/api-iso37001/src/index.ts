...
dotenv.config();
initSentry('api-iso37001');
initTracing({ serviceName: 'api-iso37001' });
...
app.use(metricsMiddleware('api-iso37001'));
...
app.get('/health', createHealthCheck('api-iso37001', prisma, '1.0.0'));
...
const server = app.listen(PORT, () => {
  logger.info(`ISO 37001 Anti-Bribery API server running on port ${PORT}`);
});
