...
describe('GET /api/actions', () => {
  it('should return actions', async () => {
    (prisma as any).compAction.findMany.mockResolvedValue([{ id: '00000000-0000-0000-0000-000000000001', title: 'Test' }]);
...
describe('GET /api/actions/:id', () => {
  ...
  it('should return item by id', async () => {
    (prisma as any).compAction.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
...
describe('POST /api/actions', () => {
  it('should create', async () => {
    ...
    (prisma as any).compAction.create.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', title: 'New' });
...
describe('PUT /api/actions/:id', () => {
  it('should update', async () => {
    (prisma as any).compAction.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).compAction.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001', title: 'Updated' });
    const res = await request(app).put('/api/actions/00000000-0000-0000-0000-000000000001').send({ title: 'Updated' });
    expect(res.status).toBe(200);
  });
});
...
describe('DELETE /api/actions/:id', () => {
  it('should soft delete', async () => {
    (prisma as any).compAction.findFirst.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
    (prisma as any).compAction.update.mockResolvedValue({ id: '00000000-0000-0000-0000-000000000001' });
