    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg bg-white p-6 shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">Total Payroll Runs</p>
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">Current Period Gross</p>
              <p className="mt-1 text-3xl font-semibold text-gray-900">
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">Current Period Net</p>
              <p className="mt-1 text-3xl font-semibold text-gray-900">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Run payroll cycle</p>
              </div>
            </Link>
            <Link
              href="/expenses"
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900">Review Expenses</p>
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900">Manage Loans</p>
                <p className="text-sm text-gray-500">Employee loans</p>
              </div>
            </Link>
            <Link
              href="/tax"
        ...
        {/* Recent Payroll Runs */}
        <div className="rounded-lg bg-white p-6 shadow">
          <h2 className="mb-4 text-lg font-semibold text-gray-900">Recent Payroll Runs</h2>
          {recentRuns.length === 0 ? (
              ...
              {recentRuns.map((run) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{run.runNumber}</p>
                  ...
                  <div className="text-right">
                    <p className="font-medium text-gray-900">{formatCurrency(run.totalNet)}</p>
