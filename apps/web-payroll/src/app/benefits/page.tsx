      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <div className="rounded-lg bg-white p-4 shadow">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-500">Retirement Plans</p>
              <p className="text-xl font-semibold">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {plans.length === 0 ? (
          <div className="col-span-full rounded-lg bg-white p-12 text-center shadow">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">No benefit plans</h3>
            <p className="mt-2 text-gray-500">Get started by creating a benefit plan.</p>
          </div>
        ) : (
          plans.map((plan) => (
            <div key={plan.id} className="rounded-lg bg-white p-6 shadow hover:shadow-lg transition-shadow">
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900">{formatCurrency(plan.employeeContribution)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Employer Contribution:</span>
                  <span className="text-gray-900">{formatCurrency(plan.employerContribution)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Waiting Period:</span>
                  <span className="text-gray-900">{plan.waitingPeriodDays} days</span>
                </div>
              </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg bg-white p-6 shadow-xl">
            <h2 className="mb-4 text-xl font-bold text-gray-900">Add Benefit Plan</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-sm text-gray-700">Dependents Coverage</span>
                </label>
              </div>
