...
import {
  Shield, Leaf, Award, TreePine, UtensilsCrossed,
  Zap, Brain, Scale, ShieldCheck, Plane, Stethoscope, Car,
} from 'lucide-react';
...
const ISO_STANDARDS = [
  ...
  { id: 'iso27001', label: 'ISO 27001', subtitle: 'Information Security', icon: ShieldCheck, color: 'cyan' },
  { id: 'iso22000', label: 'ISO 22000', subtitle: 'Food Safety', icon: UtensilsCrossed, color: 'amber' },
  ...
  { id: 'iso13485', label: 'ISO 13485', subtitle: 'Medical Devices', icon: Stethoscope, color: 'red' },
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 dark:text-gray-400 mb-6">
        Choose the standards your organisation needs. We'll pre-configure modules and seed document templates for each.
      </p>
        ...
        {ISO_STANDARDS.map((std) => {
          ...
          return (
            ...
            >
              ...
              <span className="font-semibold text-sm text-gray-900 dark:text-gray-100">{std.label}</span>
