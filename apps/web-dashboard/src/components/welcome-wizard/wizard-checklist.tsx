...
const CHECKLIST_ITEMS = [
  {
    ...
    description: 'Browse your IMS overview and KPIs',
    href: '/',
  },
  {
    id: 'open-hs',
    title: 'Open Health & Safety',
    description: 'Visit the H&S module to manage risks and incidents',
    href: `${APP_BASE}:3001`,
  },
  {
    id: 'create-risk',
    title: 'Create your first risk',
    description: 'Add a risk to the enterprise risk register',
    href: `${APP_BASE}:3031/risks/new`,
  },
  {
    id: 'invite-team',
  ...
  },
  {
    ...
    description: 'Use templates to create your first document',
    href: '/templates',
  },
  {
    id: 'take-tour',
    title: 'Take the dashboard tour',
    description: 'Get a guided walkthrough of the main dashboard',
    href: '/',
  },
  {
    id: 'complete-setup',
    title: 'Complete the setup wizard',
    description: 'Configure ISO standards and seed initial data',
    href: '/setup',
  },
];
