...
export const WIDGET_META: Record<WidgetId, { label: string; description: string; icon: string }> = {
  'compliance-gauges': {
    label: 'Compliance Gauges',
    description: 'ISO 45001, 14001, 9001 & overall compliance scores',
    icon: 'gauge',
  },
  'stat-cards': {
    label: 'Stat Cards',
    description: 'Active risks, open incidents, overdue actions, AI insights',
    icon: 'bar-chart',
  },
  'quick-actions': {
    label: 'Quick Actions',
    description: 'Shortcuts to report incidents, raise NCRs, create work orders',
    icon: 'zap',
  },
  'activity-feed': {
    label: 'Activity Feed',
    description: 'Recent cross-module activity timeline',
    icon: 'clock',
  },
  'top-risks': {
    label: 'Top Risks',
    description: 'Top 5 highest-scoring risks across all modules',
    icon: 'alert-triangle',
  },
  'overdue-capa': {
    label: 'Overdue CAPA',
    description: 'Corrective and preventive actions past their due date',
    icon: 'clock',
  },
  'ai-insights': {
    label: 'AI Insights',
    description: 'Latest AI-generated analyses and recommendations',
    icon: 'sparkles',
  },
};
...
export const SECTION_META: Record<SectionId, { label: string; description: string }> = {
  ...
  'portals-specialist': {
    label: 'Portals & Specialist',
    description: 'External portals and industry-specific modules',
  },
};
