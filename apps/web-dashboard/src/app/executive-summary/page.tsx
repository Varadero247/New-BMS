      ...
      <main className="flex-1 overflow-auto p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">
                Cross-module IMS performance overview
              </p>
            </div>
            <select
              value={period}
          ...
          <h2 className="text-lg font-semibold text-gray-800 mb-4">
            Module Compliance Scores — {period}
          </h2>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1 mt-0.5">
                            ...
                            <span
                              className={`text-xs font-medium ${mod.trend === 'up' ? 'text-green-600' : mod.trend === 'down' ? 'text-red-600' : 'text-gray-400'}`}
                            >
                              {mod.trend === 'up' ? '+' : mod.trend === 'down' ? '-' : ''}
                              {mod.change}% vs last period
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span
                            className={`text-xs px-1.5 py-0.5 rounded font-medium ${risk.module === 'InfoSec' ? 'bg-cyan-100 text-cyan-700' : risk.module === 'H&S' ? 'bg-red-100 text-red-700' : risk.module === 'Quality' ? 'bg-blue-100 text-blue-700' : 'bg-green-100 text-green-700'}`}
                          >
                            {risk.module}
                          </span>
                        </div>
                      ...
                      <div className="flex items-center gap-2 ml-3">
                        <span
                          className={`text-xs px-2 py-1 rounded font-medium ${risk.level === 'CRITICAL' ? 'bg-red-100 text-red-700' : risk.level === 'HIGH' ? 'bg-orange-100 text-orange-700' : 'bg-yellow-100 text-yellow-700'}`}
                        >
                          {risk.level}
                        </span>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      <tr
                        key={row.module}
                        className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:bg-gray-800"
                      >
                        ...
                        <td className="py-3 px-4 text-right">
                          <span
                            className={`font-semibold ${row.compliance >= 90 ? 'text-green-600' : row.compliance >= 80 ? 'text-blue-600' : 'text-orange-600'}`}
                          >
                            {row.compliance}%
                          </span>
                        </td>
                        ...
                        <td className="py-3 px-4 text-right">
                          <span
                            className={
                              row.overdue > 0 ? 'text-red-600 font-medium' : 'text-green-600'
                            }
                          >
                            {row.overdue}
                          </span>
