...
import { Search, Shield, TrendingUp, TrendingDown, Minus, ArrowRight, CheckCircle, AlertCircle, XCircle } from 'lucide-react';
...
const MOCK_SCORES: ModuleScore[] = [
  { id: '1', module: 'Health & Safety', standard: 'ISO 45001:2018', score: 87, previousScore: 82, status: 'CERTIFIED', openFindings: 3, criticalFindings: 0, lastAudit: '2025-10-15', nextAudit: '2026-10-15', certificationExpiry: '2027-10-15', trend: 'UP', href: 'http://localhost:3001' },
  { id: '2', module: 'Environment', standard: 'ISO 14001:2015', score: 91, previousScore: 88, status: 'CERTIFIED', openFindings: 2, criticalFindings: 0, lastAudit: '2025-09-20', nextAudit: '2026-09-20', certificationExpiry: '2027-09-20', trend: 'UP', href: 'http://localhost:3002' },
  { id: '3', module: 'Quality', standard: 'ISO 9001:2015', score: 79, previousScore: 84, status: 'CERTIFIED', openFindings: 7, criticalFindings: 1, lastAudit: '2025-11-01', nextAudit: '2026-05-01', certificationExpiry: '2027-11-01', trend: 'DOWN', href: 'http://localhost:3003' },
  { id: '4', module: 'Information Security', standard: 'ISO 27001:2022', score: 83, previousScore: 83, status: 'CERTIFIED', openFindings: 4, criticalFindings: 0, lastAudit: '2025-08-15', nextAudit: '2026-08-15', certificationExpiry: '2027-08-15', trend: 'STABLE', href: 'http://localhost:3015' },
  { id: '5', module: 'ESG', standard: 'GRI Standards', score: 74, previousScore: 68, status: 'IN_PROGRESS', openFindings: 9, criticalFindings: 2, lastAudit: '2025-12-01', nextAudit: '2026-06-01', certificationExpiry: null, trend: 'UP', href: 'http://localhost:3016' },
  { id: '6', module: 'AI Management', standard: 'ISO 42001:2023', score: 62, previousScore: 48, status: 'IN_PROGRESS', openFindings: 12, criticalFindings: 3, lastAudit: '2026-01-10', nextAudit: '2026-07-10', certificationExpiry: null, trend: 'UP', href: 'http://localhost:3024' },
  { id: '7', module: 'Anti-Bribery', standard: 'ISO 37001:2016', score: 88, previousScore: 85, status: 'CERTIFIED', openFindings: 2, criticalFindings: 0, lastAudit: '2025-09-01', nextAudit: '2026-09-01', certificationExpiry: '2027-09-01', trend: 'UP', href: 'http://localhost:3025' },
  { id: '8', module: 'Food Safety', standard: 'ISO 22000:2018', score: 93, previousScore: 90, status: 'CERTIFIED', openFindings: 1, criticalFindings: 0, lastAudit: '2025-11-15', nextAudit: '2026-11-15', certificationExpiry: '2027-11-15', trend: 'UP', href: 'http://localhost:3020' },
  { id: '9', module: 'Energy', standard: 'ISO 50001:2018', score: 76, previousScore: 71, status: 'CERTIFIED', openFindings: 5, criticalFindings: 0, lastAudit: '2025-10-01', nextAudit: '2026-10-01', certificationExpiry: '2027-10-01', trend: 'UP', href: 'http://localhost:3021' },
];
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            { label: 'Modules Tracked', value: items.length, color: 'bg-blue-50 text-blue-700', icon: Shield },
            { label: 'Certified', value: `${certified}/${items.length}`, color: 'bg-green-50 text-green-700', icon: CheckCircle },
            { label: 'Avg Score', value: `${avgScore}%`, color: `${avgScore >= 85 ? 'bg-green-50 text-green-700' : avgScore >= 70 ? 'bg-yellow-50 text-yellow-700' : 'bg-red-50 text-red-700'}`, icon: TrendingUp },
            { label: 'Open Findings', value: totalOpenFindings, color: totalCritical > 0 ? 'bg-red-50 text-red-700' : 'bg-orange-50 text-orange-700', icon: AlertCircle },
          ].map(s => {
            const Icon = s.icon;
            return (
              <div key={s.label} className={`rounded-lg p-4 ${s.color} flex items-start justify-between`}>
                <div>
        ...
        {totalCritical > 0 && (
          <div className="mb-6 rounded-lg border border-red-200 bg-red-50 p-4 flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-red-800">{totalCritical} critical finding{totalCritical > 1 ? 's' : ''} require immediate attention</p>
              <p className="text-xs text-red-600 mt-0.5">Critical findings must be resolved before next certification audit.</p>
            </div>
          </div>
        )}
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <div className="relative flex-1 min-w-48">
            ...
            <input
              type="text"
              aria-label="Search modules or standards..." placeholder="Search modules or standards..."
              value={searchTerm}
          ...
          <select aria-label="Filter by status" value={statusFilter} onChange={e => setStatusFilter(e.target.value)} className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
