...
import { FileText, Search, Download, Copy, Eye, X, Filter, ChevronDown } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Template Library</h1>
              <p className="text-gray-500 dark:text-gray-400 mt-1">Browse and use templates across all IMS modules</p>
            </div>
          </div>
        </div>
              ...
              <Card key={template.id} className="hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
                <CardContent className="pt-6">
                  <div className="flex items-start justify-between mb-3">
                    <Badge className="bg-purple-100 text-purple-700 text-xs font-mono">{template.code}</Badge>
                    <Badge className={getModuleBadgeColor(template.module)}>{template.module.replace('_', ' ')}</Badge>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button size="sm" className="bg-purple-600 hover:bg-purple-700 text-white" onClick={() => handleUse(template)}>
                      Use
                    </Button>
        ...
        >
          {selectedTemplate && (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <Badge className="bg-purple-100 text-purple-700 font-mono">{selectedTemplate.code}</Badge>
          ...
          <ModalFooter>
            ...
            <Button className="bg-purple-600 hover:bg-purple-700 text-white" onClick={() => selectedTemplate && handleUse(selectedTemplate)}>
              Use Template
            </Button>
          </ModalFooter>
        </Modal>
