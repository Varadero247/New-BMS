...
const MOCK_ENTRIES: AuditEntry[] = [
  {
    ...
    description: 'NCR created: Supplier material out of spec',
    userId: 'u1',
  ...
  },
  {
    ...
    action: 'UPDATE',
    entityType: 'Incident',
    entityId: 'INC-2026-0118',
    description: 'Incident status changed to CLOSED',
    userId: 'u2',
    userName: 'Bob Smith',
    ipAddress: '10.0.1.22',
    module: 'H&S',
  ...
  },
  {
    ...
    action: 'APPROVE',
    entityType: 'CAPA',
    entityId: 'CAPA-2026-0031',
    description: 'CAPA approved by quality manager',
    userId: 'u4',
  ...
  },
  {
    id: '5',
    action: 'CREATE',
    entityType: 'EnvAspect',
    entityId: 'ENV-ASP-2026-012',
    description: 'Environmental aspect registered: Water discharge',
    userId: 'u5',
    userName: 'Eve Green',
  ...
  },
  {
    ...
    action: 'UPDATE',
    entityType: 'Risk',
    entityId: 'ISR-2026-008',
    description: 'Risk severity updated from HIGH to CRITICAL',
    userId: 'u6',
  ...
  },
  {
    ...
    description: 'Q1 compliance report exported to PDF',
    userId: 'u1',
    userName: 'Alice Johnson',
    ipAddress: '192.168.1.14',
    module: 'Quality',
  ...
  },
  {
    ...
    action: 'DELETE',
    entityType: 'Document',
    entityId: 'DOC-2026-OLD',
    description: 'Obsolete procedure document deleted',
    userId: 'u7',
  ...
  },
  {
    ...
    entityId: 'WO-2026-0315',
    description: 'Preventive maintenance work order created',
    userId: 'u8',
  ...
  },
  {
    ...
    entityType: 'Employee',
    entityId: 'EMP-0074',
    description: 'Employee competence record updated',
    userId: 'u9',
    userName: 'Ivan HR',
  ...
  },
  {
    ...
    action: 'CREATE',
    entityType: 'Lead',
    entityId: 'LEAD-2026-0089',
    description: 'New CRM lead created: Acme Corp',
    userId: 'u11',
    userName: 'Karl Sales',
          ...
          <div className="mb-8 flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">
                Complete activity log across all IMS modules
              </p>
            </div>
            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex flex-wrap gap-3">
                <div className="relative flex-1 min-w-48">
                  ...
                  <input
                    type="text"
                    aria-label="Search events, users, IDs..."
                      ...
                      paginated.map((entry) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <span
                              className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${ACTION_COLORS[entry.action] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}
                            >
                              {entry.action}
                            </span>
                          </td>
                          <td className="py-3 px-4">
                            <span
                              className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${MODULE_COLORS[entry.module] || 'bg-gray-100 dark:bg-gray-800 text-gray-700'}`}
                            >
                              {entry.module}
                            </span>
                          </td>
                          ...
                          <td className="py-3 px-4 text-gray-400 dark:text-gray-500 font-mono text-xs">
                            {entry.ipAddress}
                          </td>
                        </tr>
                      ))
