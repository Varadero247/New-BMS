...
describe('GET /api/records/:id', () => {
  ...
  it('should return item by id', async () => {
    (prisma as any).trainRecord.findFirst.mockResolvedValue({
...
describe('POST /api/records', () => {
  it('should create', async () => {
    (prisma as any).trainRecord.count.mockResolvedValue(0);
    (prisma as any).trainRecord.create.mockResolvedValue({
      id: '00000000-0000-0000-0000-000000000001',
      title: 'New',
...
describe('PUT /api/records/:id', () => {
  it('should update', async () => {
    ...
    (prisma as any).trainRecord.update.mockResolvedValue({
      id: '00000000-0000-0000-0000-000000000001',
      title: 'Updated',
    });
    const res = await request(app)
