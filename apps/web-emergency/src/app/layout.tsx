...
export const metadata: Metadata = {
  title: 'Emergency Management — Nexara IMS',
  description: 'Fire, Emergency & Disaster Management module',
  themeColor: '#080B12',
};
