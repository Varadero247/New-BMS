...
const tickets: Ticket[] = [
  {
    id: 't1',
    subject: 'Quality certificate request for batch QC-2602-089',
    status: 'in-progress',
    priority: 'medium',
    created: '2026-02-10',
...
const orders: Order[] = [
  {
    id: 'o1',
    orderNumber: 'PO-2602-0045',
    description: 'CardioMonitor Pro X3 — 50 units',
    ...
    items: 50 },
  {
    ...
    description: 'Replacement sensor modules — 200 units',
    status: 'shipped',
    total: 24000,
    ...
    items: 200 },
  {
    ...
    description: 'Custom enclosure assembly — 30 units',
    status: 'delivered',
    total: 45000,
    ...
    items: 30 },
  {
    ...
    description: 'Calibration standards kit — 5 units',
    status: 'confirmed',
    total: 8500,
    ...
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Welcome back — manage your orders, tickets, and documents
        </p>
      </div>
      ...
      <div className="flex gap-1 bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === tab.id ? 'bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700'}`}
          >
            {tab.icon}
            {tab.label}
          </button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">
                £{(totalOrderValue / 1000).toFixed(0)}k
              </p>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
              <p className="text-xs text-gray-500 dark:text-gray-400 uppercase font-medium">
              ...
              <div className="space-y-2">
                {tickets.slice(0, 3).map((t) => (
                  ...
                  >
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs font-medium ${ticketStatus[t.status].color}`}
                    >
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          £{o.total.toLocaleString()} · Due {o.expectedDelivery}
                        </p>
                      </div>
                      <span
                        className={`px-2 py-0.5 rounded-full text-xs font-medium ${orderStatus[o.status].color}`}
                      >
              ...
              {tickets.map((t) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs font-medium ${t.priority === 'high' ? 'bg-red-100 text-red-700' : t.priority === 'medium' ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600'}`}
                    >
                      {t.priority}
                    </span>
                  </td>
                ...
                <div className="flex items-center gap-1">
                  {['Pending', 'Confirmed', 'In Production', 'Shipped', 'Delivered'].map((s, i) => (
                    <div key={s} className="flex-1">
                      <div
                        className={`h-2 rounded-full ${i + 1 <= step ? 'bg-blue-500' : 'bg-gray-200'}`}
                      />
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-800">
              <tr>
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-gray-400 w-20">
                  Action
                </th>
              </tr>
            </thead>
