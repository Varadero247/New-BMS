                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">{data?.dealsWon || 0} won / {(data?.dealsWon || 0) + (data?.dealsLost || 0)} total</p>
                    </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Across all won deals</p>
                    </div>
                ...
                <div className="space-y-4">
                  {data.pipelineVelocity.map((stage) => (
                    <div key={stage.stage} className="flex items-center gap-4">
                      ...
                      <div className="w-20 text-sm text-gray-500 text-right">{stage.count} deals</div>
                    </div>
                  ))}
                </div>
              ) : (
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b">
                    ...
                    <span className="font-medium text-gray-900">{(data?.winRate || 0).toFixed(1)}%</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b">
                  ...
                  <div className="flex justify-between items-center py-3 border-b">
                    ...
                    <span className="font-medium text-gray-900">{data?.avgDaysToClose || 0} days</span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                    <span className="text-sm text-gray-600">Revenue from Won</span>
                    <span className="font-medium text-gray-900">{formatCurrency(data?.totalRevenue || 0)}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-right py-3 px-4 font-medium text-gray-500">Projected</th>
