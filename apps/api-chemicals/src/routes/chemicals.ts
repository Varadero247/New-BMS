...
const createChemicalSchema = z.object({
  ...
  chemicalName: z.string().trim().min(1, 'chemicalName is required'),
  casNumber: z.string().trim().optional(),
  ecNumber: z.string().trim().optional(),
  reachRegistrationNo: z.string().trim().optional(),
  unNumber: z.string().trim().optional(),
  signalWord: signalWordEnum.optional(),
  pictograms: z.array(pictogramEnum).optional(),
  hazardStatements: z.array(z.string().trim()).optional(),
  precautionaryStmts: z.array(z.string().trim()).optional(),
  hazardCategory: z.string().trim().optional(),
  physicalState: physicalStateEnum.optional(),
  colour: z.string().trim().optional(),
  odour: z.string().trim().optional(),
  ...
  solubilityWater: z.string().trim().optional(),
  ph: z.string().trim().optional(),
  ...
  storageTemperatureMin: z.number().nonnegative().optional(),
  storageTemperatureMax: z.number().nonnegative().optional(),
  ...
  incompatibleWith: z.array(z.string().trim()).optional(),
  maxQuantityOnsite: z.number().nonnegative().optional(),
  maxQuantityUnit: z.string().trim().optional(),
  wasteClassification: wasteClassEnum.optional(),
  ewcCode: z.string().trim().optional(),
  disposalRoute: z.string().trim().optional(),
  supplier: z.string().trim().optional(),
  supplierId: z.string().trim().optional(),
  manufacturerName: z.string().trim().optional(),
  manufacturerContact: z.string().trim().optional(),
