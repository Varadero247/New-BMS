...
const catColor = (c: string) => c === 'FMEA' ? 'bg-orange-100 text-orange-700' : c === 'PPAP' ? 'bg-blue-100 text-blue-700' : c === 'APQP' ? 'bg-purple-100 text-purple-700' : c === 'EIGHT_D' ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-700';
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div><h1 className="text-3xl font-bold text-gray-900">Templates</h1><p className="text-gray-500 mt-1">IATF 16949 document and form templates</p></div>
        </div>
