...
router.post('/', async (req: AuthRequest, res: Response) => {
  try {
    const schema = z.object({
      ...
      dateOfEvent: z.string().trim().min(1).max(200),
      ...
      notificationReference: z.string().trim().optional(),
      gpsCoordinates: z.string().trim().optional(),
      immediateCause: z.string().trim().optional(),
      contributingFactors: z.string().trim().optional(),
      mediaAffected: z.array(z.string().trim()).optional().default([]),
      substanceInvolved: z.string().trim().optional(),
      quantityReleased: z.number().nonnegative().optional(),
      quantityUnit: z.string().trim().optional(),
      concentration: z.string().trim().optional(),
      receptorDistance: z.string().trim().optional(),
      ...
      cleanupDuration: z.string().trim().optional(),
      rcaMethod: z.string().trim().optional(),
      rootCause: z.string().trim().optional(),
      linkedAspectId: z.string().trim().optional(),
      investigationLead: z.string().trim().optional(),
      investigationDueDate: z
        .string()
        .refine((s) => !isNaN(Date.parse(s)), 'Invalid date format')
        .optional(),
      investigationCompleted: z.string().trim().optional(),
      environmentalDamage: z.string().trim().optional(),
      biodiversityImpact: z.boolean().optional(),
      biodiversityDescription: z.string().trim().optional(),
      waterCourseImpact: z.boolean().optional(),
      waterCourseName: z.string().trim().optional(),
      airQualityImpact: z.boolean().optional(),
      remediationCost: z.number().nonnegative().optional(),
      reputationalImpact: z.string().trim().optional(),
      ...
      monitoringDescription: z.string().trim().optional(),
      followUpDate: z
        .string()
        .refine((s) => !isNaN(Date.parse(s)), 'Invalid date format')
        .optional(),
      ...
      aiImmediateActions: z.string().trim().optional(),
      aiRegulatoryObligations: z.string().trim().optional(),
      aiEnvironmentalImpact: z.string().trim().optional(),
      aiPreventiveMeasures: z.string().trim().optional(),
      aiCAPARecommendations: z.string().trim().optional(),
...
const eventUpdateSchema = z.object({
  ...
  dateOfEvent: z.string().trim().optional(),
  ...
  immediateCause: z.string().trim().optional(),
  contributingFactors: z.string().trim().optional(),
  mediaAffected: z.array(z.string().trim()).optional(),
  substanceInvolved: z.string().trim().optional(),
  quantityReleased: z.number().nonnegative().optional(),
  quantityUnit: z.string().trim().optional(),
  concentration: z.string().trim().optional(),
