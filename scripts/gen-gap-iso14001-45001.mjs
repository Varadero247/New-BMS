...
const templates = [
    ...
    sections: [
      {
        heading: '1. Purpose',
        content:
          "To establish [COMPANY NAME]'s commitment to environmental protection, pollution prevention, and continual improvement of environmental performance in accordance with ISO 14001:2015.",
      },
      {
  ...
  },
  {
    ...
    docNumber: 'PRO-049',
    title: 'Environmental Aspects & Impacts Assessment Procedure',
    version: '1.0',
    owner: '[Environmental Manager]',
    approvedBy: '[Managing Director]',
    ...
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To identify environmental aspects of activities, products, and services, determine those with significant environmental impacts, and establish controls to manage them.',
      },
      {
        heading: '2. Scope',
        content:
          'Applies to all activities, products, and services within the scope of the EMS, including those the organisation can control and those it can influence. Considers normal, abnormal, and emergency conditions.',
      },
      {
        heading: '3. Aspect Identification',
        content:
          'Environmental aspects shall be identified considering:\n\na) Emissions to air (including GHG)\nb) Releases to water\nc) Releases to land\nd) Use of raw materials and natural resources\ne) Use of energy\nf) Generation of waste\ng) Noise, vibration, odour, dust\nh) Effects on biodiversity\n\nLife cycle stages considered: raw material acquisition, design, production, transport, use, end-of-life, disposal.',
      },
      {
        heading: '4. Significance Assessment',
        content:
          'Each aspect is scored using the following criteria (1-5 scale):\n\n- Severity of impact\n- Probability of occurrence\n- Duration/frequency\n- Scale/extent\n- Reversibility\n- Regulatory sensitivity\n- Stakeholder concern\n\nSignificance Score = (Severity x 1.5) + (Probability x 1.5) + Duration + Extent + Reversibility + Regulatory + Stakeholder\n\nScore >= 15 = Significant aspect (requires operational controls and objectives)',
      },
      {
        heading: '5. Review',
        content:
          'Aspects register reviewed annually, and whenever there are changes to activities, products, services, legal requirements, or following an environmental incident.',
      },
    ],
  },
  {
    outputPath:
      'docs/compliance-templates/procedures/PRO-050-Emergency-Preparedness-Environmental.docx',
    docNumber: 'PRO-050',
    title: 'Emergency Preparedness & Response — Environmental',
    version: '1.0',
    owner: '[Environmental Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ISO 14001:2015 Clause 8.2',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To identify potential emergency situations that can have an environmental impact, plan response actions, mitigate environmental consequences, and periodically test the response arrangements.',
      },
      {
        heading: '2. Potential Emergency Situations',
        table: {
          headers: ['Scenario', 'Potential Environmental Impact', 'Likelihood', 'Response Plan'],
          rows: [
            [
              'Chemical/fuel spill',
              'Soil/water contamination',
              'Medium',
              'Spill kit deployment, containment, notify EA',
            ],
            [
              'Fire',
              'Air emissions, firewater contamination',
              'Low',
              'Firewater containment, air monitoring',
            ],
            [
              'Flood',
              'Contaminated runoff, waste dispersal',
              'Low',
              'Elevated storage, flood barriers',
            ],
            [
              'Equipment failure',
              'Uncontrolled emissions/releases',
              'Medium',
              'Shutdown procedures, backup systems',
            ],
            [
              'Loss of containment',
              'Ground/water contamination',
              'Low',
              'Secondary containment, emergency isolation',
            ],
          ],
        },
      },
      {
        heading: '3. Response Actions',
        content:
          'a) Raise alarm and ensure personnel safety\nb) Contain the environmental impact (spill kits, isolation valves, shut-off systems)\nc) Notify the Environmental Manager and site management immediately\nd) Notify external authorities as required (Environment Agency, local authority)\ne) Implement remediation actions\nf) Investigate root cause and implement corrective actions\ng) Update emergency plans based on lessons learned',
      },
      {
        heading: '4. Testing & Drills',
        content:
          'Emergency response drills shall be conducted:\n- Spill response drill: Annually\n- Desktop exercise: Annually\n- Full emergency simulation: Every 2 years\n\nDrill results, lessons learned, and improvement actions shall be documented.',
      },
      {
        heading: '5. Records',
        content:
          'Emergency Response Plans, Drill Records, Incident Reports, Corrective Actions. Retained for 7 years.',
      },
    ],
  },
  {
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              'Transport',
              'Fuel consumption',
              'Air pollution / resource depletion',
              'Normal',
              '',
              '',
              '',
  ...
  },
  {
    ...
    docNumber: 'REG-032',
    title: 'Waste Management Register',
    version: '1.0',
    owner: '[Environmental Manager]',
    approvedBy: '[Site Manager]',
    isoRef: 'ISO 14001:2015 Clause 8.1',
    sections: [
      {
        heading: '1. Waste Stream Register',
        table: {
          headers: [
            'Waste Code',
            'Description',
  ...
  },
  {
    ...
    docNumber: 'PLN-007',
    title: 'Environmental Objectives & Targets Plan',
    version: '1.0',
    owner: '[Environmental Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ISO 14001:2015 Clause 6.2',
    sections: [
      {
        heading: '1. Environmental Objectives',
        table: {
          headers: ['Ref', 'Objective', 'Target', 'Baseline', 'KPI', 'Owner', 'Due Date', 'Status'],
          rows: [
            [
              'EO-01',
      ...
      },
      {
        ...
        table: {
          headers: ['Objective', 'Action', 'Resource', 'Responsible', 'Timeline'],
          rows: [
            [
              'EO-01',
              'LED lighting upgrade across all sites',
              '£25,000 capex',
              'Facilities',
              'Q2 2026',
            ],
            ...
            [
              'EO-02',
              'Waste segregation training for all staff',
              'Training time',
              'Env Manager',
              'Q1 2026',
            ],
            [
              'EO-03',
              'Install water meters on key processes',
              '£3,000 capex',
              'Maintenance',
              'Q1 2026',
            ],
            [
              'EO-05',
              'Introduce closed-loop recycling for key materials',
      ...
      },
      {
        heading: '3. Review',
        content:
          'Progress reviewed monthly by Environmental Manager, reported quarterly to management. Full review at annual management review meeting.',
      },
    ],
  },
  {
    ...
    owner: '[Environmental Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ISO 14001:2015 Clause 9.1',
    sections: [
      {
      ...
      {
        heading: '2. Environmental KPIs',
        table: {
          headers: ['KPI', 'Unit', 'Target', 'Q1', 'Q2', 'Q3', 'Q4', 'Annual', 'vs Target'],
          rows: [
      ...
      {
        heading: '3. Significant Aspects Update',
        content:
          '[Summary of changes to significant environmental aspects, new aspects identified, aspects resolved]',
      },
      {
        heading: '4. Compliance Status',
        content:
          '[Summary of compliance with environmental permits, licences, and legal requirements. Any non-compliances, enforcement actions, or near-misses]',
      },
      {
        heading: '5. Recommendations',
        content:
          '[Recommendations for management review: resource needs, process changes, new objectives, training requirements]',
      },
    ],
  },
  // ============================================
    ...
    sections: [
      {
        ...
        content:
          '[COMPANY NAME] is committed to providing a safe and healthy workplace for all workers, contractors, and visitors. We recognise that occupational health and safety is an integral part of our business operations.',
      },
      {
      ...
      },
      {
        ...
        content:
          'Senior Management: Provide leadership, resources, and accountability for OH&S\nHealth & Safety Manager: Maintain the OH&S MS, advise on compliance, monitor performance\nLine Managers: Implement OH&S controls, conduct risk assessments, investigate incidents\nAll Workers: Follow safe systems of work, report hazards, use PPE as required, participate in consultation',
      },
      {
        heading: '4. Communication',
        content:
          'This policy is communicated to all workers and made available to interested parties including contractors, visitors, and regulatory authorities.',
      },
      {
        heading: '5. Review',
        content:
          'Reviewed annually at management review and following any significant incident, change in legislation, or organisational change.\n\nSigned: _________________________ Date: ___/___/______\nManaging Director',
      },
    ],
  },
  {
    ...
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To establish a systematic process for ongoing proactive identification of hazards, assessment of OH&S risks and opportunities, and determination of controls using the hierarchy of controls.',
      },
      {
        heading: '2. Hazard Identification',
        content:
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: '5. Investigation Timescales',
        table: {
          headers: ['Severity', 'Investigation Start', 'Investigation Complete', 'Actions Due'],
          rows: [
            [
              'Fatality / specified injury',
              'Immediately',
              '48 hours',
              'ASAP — no later than 1 week',
            ],
      ...
      },
      {
        heading: '6. Records',
        content:
          'Incident Report Forms (FRM-041), Investigation Reports, Witness Statements, Photographs, CAPA records. Retained for 40 years (occupational health) or 7 years (general).',
      },
    ],
  },
  {
    outputPath:
      'docs/compliance-templates/procedures/PRO-053-Worker-Consultation-Participation.docx',
    docNumber: 'PRO-053',
    title: 'Worker Consultation & Participation Procedure',
    version: '1.0',
    owner: '[Health & Safety Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ISO 45001:2018 Clause 5.4',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To establish processes for worker consultation and participation in the development, planning, implementation, performance evaluation, and improvement of the OH&S management system.',
      },
      {
        heading: '2. Consultation vs Participation',
        content:
          'Consultation (seeking views before decisions): Required for all workers on OH&S policy, objectives, legal compliance, roles, hazard identification, controls, change management, and contractor management.\n\nParticipation (involvement in decision-making): Required for non-managerial workers on hazard identification, risk assessment, actions to control risks, competence/training needs, incident investigation, and consultation arrangements.',
      },
      {
        heading: '3. Mechanisms',
        table: {
          headers: ['Mechanism', 'Frequency', 'Participants', 'Records'],
          rows: [
  ...
  },
  {
    ...
    docNumber: 'FRM-040',
    title: 'OH&S Risk Assessment Form',
    version: '1.0',
    owner: '[Health & Safety Manager]',
    approvedBy: '[Site Manager]',
    isoRef: 'ISO 45001:2018 Clause 6.1.2',
    sections: [
      ...
      {
        heading: '3. Risk Matrix',
        table: {
          headers: ['', 'Negligible (1)', 'Minor (2)', 'Moderate (3)', 'Major (4)', 'Fatal (5)'],
          rows: [
    ...
    sections: [
      {
        ...
        table: {
          headers: ['Field', 'Detail'],
          rows: [
            ['Report Number', '[INC-YYYY-NNN]'],
            ['Date & Time of Incident', ''],
            ['Location', ''],
            ['Reported By', ''],
            ['Date Reported', ''],
            ['Type', 'Injury / Ill Health / Near-Miss / Dangerous Occurrence / Property Damage'],
          ],
        },
      },
      {
        heading: '2. Person(s) Involved',
        table: {
          headers: [
            'Name',
            'Role',
      ...
      {
        heading: '3. Description of Incident',
        content:
          '[Detailed description of what happened, including events leading up to the incident, the incident itself, and immediate aftermath]\n\nWitnesses:\nName: _________________________ Contact: _________________________\nName: _________________________ Contact: _________________________',
      },
      {
        heading: '4. Immediate Actions Taken',
        content:
          '[What was done immediately to make the area safe, treat injuries, and prevent further harm]',
      },
      {
        heading: '5. RIDDOR Reportable?',
        content:
          'Yes / No\nIf Yes — Reference: _____________ Reported by: _____________ Date: ___/___/______',
      },
      {
        heading: '6. Investigation (H&S Manager)',
        content:
  ...
  },
  {
    ...
    sections: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              'HAZ-002',
              'Warehouse',
              'Working at height (racking)',
              'Falls from height',
              'High (16)',
              'MEWP, harnesses, inspection',
              'Medium (8)',
              'Warehouse Manager',
              '',
            ],
            [
              ...
              'Medium (9)',
              'DSE assessment, adjustable furniture',
              'Low (4)',
              'Office Manager',
              '',
            ],
            ...
            [
              ...
              'High (12)',
              'COSHH assessments, PPE, ventilation',
              'Medium (6)',
              'Lab Manager',
              '',
            ],
      ...
      {
        heading: '2. Review Schedule',
        content:
          'Full register reviewed annually. Individual entries reviewed following incidents, near-misses, changes, or new hazards identified.',
      },
    ],
  },
  {
    ...
    docNumber: 'PLN-008',
    title: 'OH&S Objectives & Programme Plan',
    version: '1.0',
    owner: '[Health & Safety Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ISO 45001:2018 Clause 6.2',
    sections: [
      {
        heading: '1. OH&S Objectives',
        table: {
          ...
          rows: [
            ...
            [
              'SO-03',
              'Complete all outstanding risk assessments',
              '% RA current',
              '100%',
              '75%',
              'H&S Manager',
            ...
            [
              'SO-05',
              'Achieve 100% H&S induction compliance',
              '% inducted',
              '100%',
              '85%',
              'HR/H&S',
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              'SO-01',
              'Behavioural safety observation programme',
              'Training budget',
              'H&S Manager',
              'Q1 2026',
            ],
            [
              'SO-02',
              'Launch near-miss reporting app + incentive scheme',
              '£5,000 + IT support',
              'H&S Manager',
              'Q1 2026',
            ],
            [
              'SO-03',
              'Risk assessment blitz — dedicated team for 2 weeks',
              'H&S team + managers',
              'H&S Manager',
              'Q1 2026',
            ],
            [
              'SO-04',
              'Mechanical handling aids for top 5 manual tasks',
              '£12,000 capex',
              'Operations',
              'Q2 2026',
            ],
            [
              'SO-05',
              'Online induction module + tracking system',
              'LMS budget',
              'HR Manager',
              'Q1 2026',
            ],
      ...
      },
      {
        heading: '3. Review',
        content:
          'Progress reviewed monthly at H&S Committee. Reported to management review quarterly. Objectives updated annually or following significant incidents/changes.',
      },
    ],
  },
];
