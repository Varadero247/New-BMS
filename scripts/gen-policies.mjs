...
const policies = [
  {
    ...
    docNumber: "POL-001", title: "Quality Policy", version: "1.0",
    owner: "[Quality Manager]", approvedBy: "[Managing Director]",
    isoRef: "ISO 9001:2015 Clause 5.2",
    sections: [
      { heading: "1. Purpose", content: "This Quality Policy establishes the commitment of [COMPANY NAME] to the consistent delivery of products and services that meet customer requirements and applicable statutory and regulatory requirements. It provides the framework for setting and reviewing quality objectives across the organisation.\n\nThis policy is aligned with ISO 9001:2015 and forms the foundation of the Quality Management System (QMS) operated through the Nexara Integrated Management System." },
      { heading: "2. Scope", content: "This policy applies to all employees, contractors, and third parties involved in the design, development, production, delivery, and support of [COMPANY NAME]'s products and services. It covers all sites, departments, and processes within the scope of the QMS.\n\nThe scope of the QMS is documented in the Nexara IMS and includes: [describe products/services and locations]." },
      ...
      { heading: "10. Approval", content: "This policy has been approved by the undersigned and is effective from the date of issue.\n\nSignature: ________________________    Date: [DD/MM/YYYY]\nName: [Managing Director Name]\nTitle: [Managing Director / CEO]\n\nSignature: ________________________    Date: [DD/MM/YYYY]\nName: [Quality Manager Name]\nTitle: [Quality Manager]" },
    ],
  },
  {
    outputPath: "docs/compliance-templates/policies/POL-002-Environmental-Policy.docx",
    docNumber: "POL-002", title: "Environmental Policy", version: "1.0",
    owner: "[Environmental Manager]", approvedBy: "[Managing Director]",
    isoRef: "ISO 14001:2015 Clause 5.2",
    sections: [
      { heading: "1. Purpose", content: "This Environmental Policy establishes the commitment of [COMPANY NAME] to protecting the environment, preventing pollution, and fulfilling compliance obligations. It provides the framework for setting environmental objectives and targets within the Environmental Management System (EMS) aligned to ISO 14001:2015, operated through the Nexara Integrated Management System." },
      { heading: "2. Scope", content: "This policy applies to all activities, products, and services of [COMPANY NAME] across all sites and operations. It addresses environmental aspects including but not limited to: emissions to air, discharges to water, land contamination, waste generation and management, resource use and efficiency, energy consumption, and impacts on biodiversity and ecosystems." },
      ...
      { heading: "9. Approval", content: "Signature: ________________________    Date: [DD/MM/YYYY]\nName: [Managing Director Name]\nTitle: [Managing Director / CEO]" },
    ],
  },
  {
    outputPath: "docs/compliance-templates/policies/POL-003-Health-Safety-Policy.docx",
    docNumber: "POL-003", title: "Occupational Health & Safety Policy", version: "1.0",
    owner: "[Health & Safety Manager]", approvedBy: "[Managing Director]",
    isoRef: "ISO 45001:2018 Clause 5.2",
    sections: [
      { heading: "1. Purpose", content: "This Occupational Health & Safety (OH&S) Policy establishes the commitment of [COMPANY NAME] to providing safe and healthy working conditions for the prevention of work-related injury and ill health. It sets the framework for the OH&S Management System aligned to ISO 45001:2018, operated through the Nexara Integrated Management System." },
      { heading: "2. Scope", content: "This policy applies to all workers, including employees, contractors, agency workers, visitors, and any other persons under the control or influence of [COMPANY NAME] across all workplaces and operations." },
      ...
      { heading: "8. Approval", content: "Signature: ________________________    Date: [DD/MM/YYYY]\nName: [Managing Director Name]\nTitle: [Managing Director / CEO]" },
    ],
  },
  {
    outputPath: "docs/compliance-templates/policies/POL-004-Information-Security-Policy.docx",
    docNumber: "POL-004", title: "Information Security Policy", version: "1.0",
    owner: "[Information Security Manager]", approvedBy: "[Managing Director]",
    isoRef: "ISO 27001:2022 Clause 5.2",
    sections: [
      { heading: "1. Purpose", content: "This Information Security Policy establishes the commitment of [COMPANY NAME] to protecting the confidentiality, integrity, and availability of information assets. It defines the framework for the Information Security Management System (ISMS) aligned to ISO 27001:2022, operated through the Nexara Integrated Management System." },
      { heading: "2. Scope", content: "This policy applies to all information assets owned, managed, or processed by [COMPANY NAME], including digital and physical information, across all locations, systems, networks, and third-party services. It applies to all employees, contractors, and third parties with access to [COMPANY NAME] information." },
  ...
  },
  {
    ...
    docNumber: "POL-007", title: "Data Protection & Privacy Policy", version: "1.0",
    owner: "[Data Protection Officer]", approvedBy: "[Managing Director]",
    isoRef: "UK GDPR / Data Protection Act 2018",
    sections: [
      { heading: "1. Purpose", content: "This Data Protection & Privacy Policy sets out how [COMPANY NAME] collects, uses, stores, shares, and protects personal data in compliance with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018." },
      { heading: "2. Scope", content: "This policy applies to all personal data processed by [COMPANY NAME], whether in electronic or paper form. It applies to all employees, contractors, and third-party data processors who handle personal data on behalf of the organisation." },
      { heading: "3. Data Protection Principles", content: "[COMPANY NAME] shall ensure that personal data is:\n\na) Processed lawfully, fairly, and in a transparent manner (Lawfulness, Fairness, Transparency)\nb) Collected for specified, explicit, and legitimate purposes (Purpose Limitation)\nc) Adequate, relevant, and limited to what is necessary (Data Minimisation)\nd) Accurate and kept up to date (Accuracy)\ne) Kept for no longer than is necessary (Storage Limitation)\nf) Processed in a manner that ensures appropriate security (Integrity and Confidentiality)\ng) The controller shall be responsible for and be able to demonstrate compliance (Accountability)" },
      { heading: "4. Lawful Basis for Processing", content: "[COMPANY NAME] identifies and documents the lawful basis for each processing activity in the Record of Processing Activities (FRM-014). The lawful bases include:\n\n• Consent of the data subject\n• Performance of a contract\n• Compliance with a legal obligation\n• Vital interests of the data subject\n• Performance of a task in the public interest\n• Legitimate interests pursued by the controller" },
      { heading: "5. Data Subject Rights", content: "Individuals have the following rights which [COMPANY NAME] will facilitate:\n\n• Right to be informed (privacy notices)\n• Right of access (Subject Access Requests — responded to within 1 month)\n• Right to rectification\n• Right to erasure (right to be forgotten)\n• Right to restrict processing\n• Right to data portability\n• Right to object\n• Rights related to automated decision making and profiling\n\nRequests are managed through the Nexara IMS data subject request module and tracked to completion." },
      { heading: "6. Data Breach Notification", content: "In the event of a personal data breach:\n\n• The breach must be reported internally immediately to the DPO\n• The DPO will assess the breach and determine if notification is required\n• The ICO must be notified within 72 hours where the breach is likely to result in a risk to individuals' rights and freedoms\n• Affected data subjects must be notified without undue delay where the breach is likely to result in a high risk to their rights and freedoms\n• All breaches are logged in the Nexara IMS incident module regardless of severity" },
      { heading: "7. Data Retention", content: "[COMPANY NAME] retains personal data only for as long as necessary for the purposes for which it was collected. Retention periods are defined in the Data Retention Schedule and enforced through the Nexara IMS data retention management module.\n\nWhen the retention period expires, data is securely deleted or anonymised." },
      { heading: "8. International Transfers", content: "Personal data shall not be transferred outside the UK unless adequate safeguards are in place, such as:\n\n• UK Adequacy Regulations\n• Standard Contractual Clauses (SCCs)\n• Binding Corporate Rules\n• Explicit consent of the data subject" },
      { heading: "9. Data Protection Officer", content: "The Data Protection Officer can be contacted at:\n\nName: [DPO Name]\nEmail: [dpo@company.com]\nPhone: [Phone Number]\nAddress: [Address]" },
      { heading: "10. Related Documents", bullets: [
  ...
  {
    outputPath: "docs/compliance-templates/policies/POL-008-Equal-Opportunities-Diversity-Policy.docx",
    docNumber: "POL-008", title: "Equal Opportunities & Diversity Policy", version: "1.0",
    owner: "[HR Director]", approvedBy: "[Managing Director]",
    isoRef: "Equality Act 2010 / HR Best Practice",
    sections: [
      { heading: "1. Purpose", content: "This Equal Opportunities & Diversity Policy sets out the commitment of [COMPANY NAME] to promoting equality of opportunity and valuing diversity. It ensures that no employee, job applicant, customer, or other stakeholder receives less favourable treatment on the grounds of any protected characteristic." },
      { heading: "2. Scope", content: "This policy applies to all aspects of employment including recruitment, selection, training, development, promotion, pay, benefits, disciplinary and grievance procedures, redundancy, and termination. It also covers the treatment of customers, suppliers, and visitors." },
      ...
      { heading: "4. Recruitment & Selection", content: "All recruitment and selection processes shall:\n\n• Use objective, job-related criteria\n• Be free from bias in advertising, shortlisting, and interviewing\n• Include diverse interview panels where practicable\n• Make reasonable adjustments for disabled applicants\n• Retain records to demonstrate fair and transparent decision-making" },
      { heading: "5. Complaints & Grievances", content: "Any employee who believes they have been subject to discrimination, harassment, or victimisation should raise the matter through:\n\n• Their line manager (if appropriate)\n• The HR Department\n• The formal Grievance Procedure\n\nAll complaints will be taken seriously, investigated promptly and confidentially, and resolved fairly. Victimisation of anyone making a complaint in good faith is prohibited." },
      { heading: "6. Monitoring", content: "[COMPANY NAME] monitors workforce diversity data including recruitment, promotion, training, and leavers to identify trends and address any disparities. This data is reviewed by the HR Director and reported to the Board annually." },
      { heading: "7. Approval", content: "Signature: ________________________    Date: [DD/MM/YYYY]\nName: [Managing Director Name]\nTitle: [Managing Director / CEO]" },
    ],
  },
  {
    outputPath: "docs/compliance-templates/policies/POL-009-Energy-Policy.docx",
    docNumber: "POL-009", title: "Energy Policy", version: "1.0",
    owner: "[Energy Manager]", approvedBy: "[Managing Director]",
    isoRef: "ISO 50001:2018 Clause 5.2",
    sections: [
      { heading: "1. Purpose", content: "This Energy Policy establishes the commitment of [COMPANY NAME] to improving energy performance through the Energy Management System (EnMS) aligned to ISO 50001:2018, operated through the Nexara Integrated Management System." },
      { heading: "2. Scope", content: "This policy applies to all activities, equipment, systems, and processes that affect energy performance across all [COMPANY NAME] facilities and operations, including offices, manufacturing sites, warehouses, and transport." },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "9. Approval", content: "Approved by the Board of Directors: [DD/MM/YYYY]\n\nSignature: ________________________\nName: [Chair of the Board]\nTitle: [Chair]" },
    ],
  },
];
