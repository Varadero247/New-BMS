...
const templates = [
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Lead Auditor', '[Name]'],
            ['Auditee / Department', '[Name / Department]'],
            ['Audit Scope', '[Clauses / Processes covered]'],
          ],
        },
      },
      {
      ...
      {
        heading: '8. Clause 9 — Performance Evaluation',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '9. Clause 10 — Improvement',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
            '10.1 General',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: '7. Clause 9 — Performance Evaluation',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '8. Clause 10 — Improvement',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
            '10.1 General',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: '3. Clause 5 — Leadership & Worker Participation',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
            '5.1 Leadership and commitment',
  ...
  },
  {
    ...
    docNumber: 'AUD-004',
    title: 'ISO 27001:2022 Internal Audit Checklist',
    version: '1.0',
    owner: '[Information Security Manager]',
    approvedBy: '[Management Representative]',
    isoRef: 'ISO/IEC 27001:2022',
    sections: [
      {
        heading: '1. Audit Information',
        table: {
      ...
      {
        heading: '3. Annex A Controls — Organisational (A.5)',
        table: {
          headers: ['Control', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '5. Annex A — Physical (A.7)',
        table: {
          headers: ['Control', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '6. Annex A — Technological (A.8)',
        table: {
          headers: ['Control', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
  ...
  },
  {
    ...
    docNumber: 'AUD-005',
    title: 'ISO 22000:2018 Internal Audit Checklist',
    version: '1.0',
    owner: '[Food Safety Manager]',
    approvedBy: '[Management Representative]',
    isoRef: 'ISO 22000:2018',
    sections: [
      {
        heading: '1. Audit Information',
        table: {
      ...
      {
        heading: '3. Clause 8 — Operation (HACCP)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
            '8.1 Operational planning and control',
  ...
  },
  {
    ...
    docNumber: 'AUD-006',
    title: 'ISO 50001:2018 Internal Audit Checklist',
    version: '1.0',
    owner: '[Energy Manager]',
    approvedBy: '[Management Representative]',
    isoRef: 'ISO 50001:2018',
    sections: [
      {
        heading: '1. Audit Information',
        table: {
      ...
      },
      {
        ...
        table: {
          ...
          rows: auditRows([
            ...
            '5.3 Roles and authorities',
            '6.1 Risks and opportunities',
            '6.2 Objectives, energy targets and planning',
            '6.3 Energy review',
  ...
  },
  {
    ...
    docNumber: 'AUD-007',
    title: 'ISO 37001:2016 Internal Audit Checklist',
    version: '1.0',
      ...
      },
      {
        ...
        table: {
          ...
          rows: auditRows([
            ...
            '8.8 Managing inadequacy of controls',
  ...
  },
  {
    ...
    docNumber: 'AUD-008',
    title: 'ISO/IEC 42001:2023 Internal Audit Checklist',
    version: '1.0',
    ...
    sections: [
      ...
      {
        heading: '3. Annex A Controls',
        table: {
          headers: ['Control', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
            'A.2 AI policies',
            'A.3 Internal organisation for AI',
  ...
  },
  {
    ...
    docNumber: 'AUD-009',
    title: 'GDPR / UK GDPR Compliance Audit Checklist',
    version: '1.0',
    owner: '[Data Protection Officer]',
    approvedBy: '[Management Representative]',
    isoRef: 'GDPR / UK GDPR / DPA 2018',
    sections: [
      {
        heading: '1. Audit Information',
        table: {
          ...
          rows: [
            ['Audit Number', '[AUD-YYYY-NNN]'],
            ['Regulation', 'GDPR / UK GDPR / DPA 2018'],
            ['Audit Date', '[DD/MM/YYYY]'],
            ['Lead Auditor', '[Name]'],
            ['Auditee', '[Name / Department]'],
          ],
      ...
      {
        heading: '2. Lawfulness, Fairness, Transparency (Art 5-6)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '3. Data Subject Rights (Art 12-22)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '4. Accountability & Governance (Art 24-43)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
  ...
  },
  {
    ...
    docNumber: 'AUD-010',
    title: 'ESG / CSRD Compliance Audit Checklist',
    version: '1.0',
    owner: '[ESG Manager]',
    approvedBy: '[Management Representative]',
    isoRef: 'CSRD / ESRS / GRI',
    sections: [
      {
        heading: '1. Audit Information',
        table: {
          ...
          rows: [
            ['Audit Number', '[AUD-YYYY-NNN]'],
            ['Framework', 'CSRD / ESRS / GRI Standards'],
            ['Audit Date', '[DD/MM/YYYY]'],
            ['Lead Auditor', '[Name]'],
            ['Auditee', '[Name / Department]'],
          ],
      ...
      {
        heading: '2. Environmental — Climate Change (ESRS E1)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '3. Environmental — Pollution & Resources (ESRS E2-E5)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '4. Social — Own Workforce (ESRS S1)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      {
        heading: '5. Social — Value Chain & Communities (ESRS S2-S4)',
        table: {
          headers: ['Requirement', 'Evidence', 'Rating', 'Finding', 'NCR Ref'],
          rows: auditRows([
      ...
      },
      {
        ...
        table: {
          ...
          rows: auditRows([
            ...
            'Impact materiality (inside-out) assessed',
            'Financial materiality (outside-in) assessed',
            'Stakeholder engagement in materiality process',
            'Material topics identified and prioritised',
            'Materiality results approved by governance body',
          ]),
        },
      },
      {
