...
const templates = [
  ...
  // ============================================
  {
    ...
    sections: [
      ...
      {
        heading: '4. Governance Commitments',
        bullets: [
      ...
      },
      {
        heading: '5. Review',
        content:
          'This policy is reviewed annually and approved by the Board of Directors.\n\nSigned: _________________________ Date: ___/___/______\nManaging Director',
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: '5. Review',
        content:
          'Materiality assessment updated annually and when significant changes occur in the business, value chain, or stakeholder expectations.',
      },
    ],
  },
  {
    ...
    docNumber: 'PRO-066',
    title: 'Carbon Footprint Measurement Procedure',
    version: '1.0',
    owner: '[ESG Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ESRS E1 / GHG Protocol',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To define the methodology for measuring and reporting greenhouse gas emissions in Scope 1, 2, and 3, aligned with the GHG Protocol Corporate Standard and ESRS E1 Climate Change requirements.',
      },
      {
        heading: '2. Scope Definitions',
        table: {
          headers: ['Scope', 'Description', 'Data Sources', 'Methodology'],
          rows: [
            [
              'Scope 1 — Direct',
              'Owned/controlled sources: combustion, process, fugitive, fleet',
              'Fuel invoices, refrigerant logs, fleet mileage',
              'Activity data x emission factor (DEFRA)',
            ],
            [
              'Scope 2 — Indirect (Energy)',
              'Purchased electricity, steam, heating, cooling',
              'Utility invoices, meter reads',
              'Location-based + market-based (IEA, supplier factors)',
            ],
            [
              'Scope 3 — Value Chain',
              'All other indirect emissions (15 categories)',
              'Supplier data, spend data, travel data',
              'Activity or spend-based (DEFRA, Exiobase)',
            ],
          ],
        },
      },
      {
        heading: '3. Scope 3 Categories',
        table: {
          headers: ['Category', 'Description', 'Relevant?', 'Method'],
          rows: [
            [
              '1. Purchased goods & services',
              'Cradle-to-gate emissions of purchased inputs',
              '',
              'Spend-based / supplier-specific',
            ],
            ...
            [
              ...
              'Transport of purchased goods',
              '',
              'Distance x weight x factor',
            ],
            [
              '5. Waste generated in operations',
              'Treatment of waste',
              '',
              'Waste data x DEFRA factors',
            ],
  ...
  },
  {
    ...
    docNumber: 'FRM-051',
    title: 'GHG Emissions Data Collection Form (Scope 1/2/3)',
    version: '1.0',
    owner: '[ESG Manager]',
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          headers: ['Source', 'Fuel Type', 'Unit', 'Quantity', 'Emission Factor', 'tCO2e'],
          rows: [
      ...
      {
        heading: '3. Scope 2 — Energy Indirect',
        table: {
          headers: [
            'Source',
            'Unit',
      ...
      {
        heading: '4. Scope 3 Summary',
        table: {
          headers: ['Category', 'Data Source', 'Activity Data', 'tCO2e', 'Method'],
          rows: [
            ['1. Purchased goods & services', '', '', '', ''],
  ...
  },
  {
    ...
    docNumber: 'FRM-052',
    title: 'Social Sustainability Data Collection Form',
    version: '1.0',
    owner: '[HR Director / ESG Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ESRS S1-S4',
    sections: [
      {
        heading: '1. Own Workforce (ESRS S1)',
        table: {
          headers: ['Metric', 'Male', 'Female', 'Non-Binary', 'Not Disclosed', 'Total'],
          rows: [
            ['Total headcount', '', '', '', '', ''],
            ['Full-time employees', '', '', '', '', ''],
            ['Part-time employees', '', '', '', '', ''],
  ...
  },
  {
    ...
    sections: [
      {
        heading: '1. Environmental KPIs',
        table: {
          headers: ['KPI', 'ESRS Ref', 'Unit', 'Baseline', 'Target', 'Current', 'Status'],
          rows: [
  ...
  },
  {
    ...
    owner: '[ESG Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ESRS 2 / AA1000',
    sections: [
      {
        heading: '1. Stakeholder Register',
        table: {
          headers: [
            'Stakeholder Group',
          ...
          rows: [
            [
              'Employees',
              'Working conditions, pay, career development, wellbeing',
              'Surveys, town halls, works council',
            ...
            [
              'Customers',
              'Product quality, sustainability, ethical sourcing',
              'Feedback forms, account reviews',
              'Quarterly',
              '',
              '',
            ],
            [
              ...
              'ESG performance, risk management, returns',
            ...
            [
              'Suppliers',
              'Fair terms, payment, partnership, sustainability expectations',
              'Audits, meetings, questionnaires',
              'Annual',
              '',
              '',
            ],
            [
              'Local communities',
              'Employment, environmental impact, social investment',
              'Community meetings, CSR programmes',
              'Bi-annual',
              '',
              '',
            ],
            [
              'Regulators',
              'Compliance, reporting, permits',
              'Formal submissions, inspections',
              'As required',
              '',
              '',
            ],
            [
              'NGOs/Civil society',
              'Environmental protection, human rights, transparency',
      ...
      {
        heading: '2. Materiality Influence',
        content:
          'Stakeholder feedback is a key input to the double materiality assessment (PRO-065). Engagement results are documented and used to validate material ESG topics.',
      },
    ],
  },
  {
    ...
    sections: [
      {
        heading: '1. Environmental Targets',
        table: {
          headers: [
            'Target',
            'ESRS',
      ...
      {
        heading: '2. Social Targets',
        table: {
          headers: ['Target', 'ESRS', 'Current', '2026 Target', '2030 Target', 'Owner'],
          rows: [
            ...
            [
              'Human rights due diligence — Tier 1 suppliers',
              'S2',
              '',
              '100%',
              '100%',
      ...
      {
        heading: '3. Governance Targets',
        table: {
          headers: ['Target', 'ESRS', 'Current', '2026 Target', 'Owner'],
          rows: [
      ...
      {
        heading: '4. Key Actions',
        table: {
          headers: ['Action', 'Pillar', 'Budget', 'Responsible', 'Timeline'],
          rows: [
            ...
            [
              'Supplier sustainability audits (top 20)',
              'S',
              '£20,000',
              'Procurement',
              'Q2-Q4 2026',
  ...
  },
  {
    ...
    docNumber: 'RPT-012',
    title: 'ESG & Sustainability Report Template',
    version: '1.0',
    owner: '[ESG Manager]',
    ...
    sections: [
      {
        heading: '1. Report Information',
        table: {
          headers: ['Field', 'Detail'],
          rows: [
            ['Reporting Entity', '[COMPANY NAME]'],
            ['Reporting Period', '[FY YYYY]'],
            ['Reporting Standards', 'ESRS (CSRD)'],
      ...
      {
        heading: '2. Materiality',
        content:
          '[Summary of double materiality assessment results, material ESRS topics, and disclosure map]',
      },
      {
        heading: '3. Environmental Disclosures (ESRS E1-E5)',
        table: {
          headers: ['Disclosure', 'Metric', 'Year-1', 'Year', 'Change', 'Target'],
          rows: [
      ...
      {
        heading: '4. Social Disclosures (ESRS S1-S4)',
        table: {
          headers: ['Disclosure', 'Metric', 'Year-1', 'Year', 'Change'],
          rows: [
      ...
      {
        heading: '5. Governance Disclosures (ESRS G1)',
        content:
          '[Business conduct disclosures: anti-corruption, political engagement, supplier relationships, whistleblowing]',
      },
      {
        heading: '6. Targets & Progress',
        content: '[Summary of ESG targets, progress against each, actions taken, and outlook]',
      },
      {
        heading: '7. Assurance Statement',
        content:
          '[Space for independent assurance statement or reference to separate assurance report]',
      },
    ],
  },
];
