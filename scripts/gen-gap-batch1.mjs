...
const templates = [
  ...
  // ============================================
  {
    ...
    isoRef: 'ISO/IEC 27001:2022 Clause 4.3',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'This document defines the scope and boundaries of the [COMPANY NAME] Information Security Management System (ISMS) in compliance with ISO/IEC 27001:2022 Clause 4.3.',
      },
      {
        heading: '2. Organisational Context',
        content:
          'The following internal and external issues have been considered in determining the ISMS scope:\n\na) Internal: [Organisation structure, business strategy, information systems, culture]\nb) External: [Regulatory environment, market conditions, technology trends, threat landscape]',
      },
      {
        heading: '3. Interested Parties',
        table: {
          headers: ['Interested Party', 'Relevant Requirements', 'Applicable to ISMS'],
          rows: [
      ...
      {
        heading: '4. ISMS Scope Definition',
        content:
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: '5. Risk Acceptance Criteria',
        content:
          'Risk scores are categorised as:\n\n• 1-4: LOW — Accept the risk, monitor\n• 5-9: MEDIUM — Risk treatment required within 6 months\n• 10-15: HIGH — Risk treatment required within 3 months\n• 16-25: CRITICAL — Immediate risk treatment required, escalate to CISO',
      },
      {
        heading: '6. Risk Treatment Options',
        bullets: [
          'Modify/Mitigate: Apply controls from ISO 27001 Annex A',
          'Accept: Formally accept residual risk (risk owner sign-off required)',
          'Avoid: Cease the activity creating the risk',
          'Transfer/Share: Transfer to third party (insurance, outsourcing)',
        ],
      },
      {
        heading: '7. Frequency',
      ...
      },
      {
        heading: '8. Records',
        bullets: [
          'REG-001: Risk Register (with information security risks)',
          'REG-014: Statement of Applicability',
          'PLN-010: Risk Treatment Plan',
          'RPT-005: InfoSec Risk Assessment Report',
        ],
      },
    ],
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[CISO / Managing Director]',
    isoRef: 'ISO/IEC 27001:2022 Clause 6.1.3',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To document the risk treatment decisions for all identified information security risks, including selected controls, implementation plan, and residual risk acceptance.',
      },
      {
        heading: '2. Risk Treatment Summary',
        table: {
          headers: [
            'Risk ID',
            'Risk Description',
      ...
      {
        heading: '3. Residual Risk Acceptance',
        content:
          'Risk owners have accepted the following residual risks:\n\n[For each accepted risk: Risk ID, Description, Residual Risk Score, Risk Owner Name, Acceptance Date, Review Date]\n\nSignature: _________________________ Date: ___/___/______',
      },
      {
        heading: '4. Implementation Resources',
        content:
          'Budget: [Estimated budget for risk treatment implementation]\nPersonnel: [Key personnel and time commitments]\nExternal support: [Consultants, technology vendors]',
      },
      {
        heading: '5. Review',
        content:
          'This plan shall be reviewed quarterly and updated following any risk assessment changes or significant security incidents.',
      },
    ],
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[CISO / Managing Director]',
    isoRef: 'ISO/IEC 27001:2022 Clause 6.1.3(d)',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'This Statement of Applicability (SoA) lists all 93 controls from ISO/IEC 27001:2022 Annex A, states whether each is applicable or excluded with justification, and provides the implementation status. This is a mandatory document for ISO 27001 certification.',
      },
      {
        heading: '2. Organisational Controls (A.5)',
        table: {
          headers: [
            'Control',
            'Title',
          ...
          rows: [
            ...
            [
              ...
              'Yes',
              'Required to prevent fraud/error',
              'Implemented',
              'RBAC system',
            ],
            [
            ...
            [
              ...
              'Threat intelligence',
              'Yes',
              'Required for proactive security',
              'Implemented',
              'Feed subscription',
            ],
            [
            ...
            [
              ...
              'Yes',
              'Required for user responsibility',
              'Implemented',
              'POL-011',
            ],
            [
            ...
            [
              ...
              'Yes',
              'Required for ongoing assurance',
              'Implemented',
              'Supplier review',
            ],
            [
      ...
      {
        heading: '3. People Controls (A.6)',
        table: {
          headers: ['Control', 'Title', 'Applicable', 'Justification', 'Status', 'Evidence'],
          rows: [
      ...
      {
        heading: '4. Physical Controls (A.7)',
        table: {
          headers: ['Control', 'Title', 'Applicable', 'Justification', 'Status', 'Evidence'],
          rows: [
            [
      ...
      {
        heading: '5. Technological Controls (A.8)',
        table: {
          headers: ['Control', 'Title', 'Applicable', 'Justification', 'Status', 'Evidence'],
          rows: [
            [
  ...
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Clause 6.2',
    sections: [
      {
        heading: '1. Information Security Objectives',
        table: {
          headers: [
            'Obj #',
            'Objective',
          ...
          rows: [
            ...
            [
              'ISO-2',
              '100% staff security awareness training',
              'All staff trained',
              'IS Manager',
              'E-learning platform',
              'Mar 2026',
            ...
            [
              'ISO-4',
              'Patch critical vulnerabilities within 48hrs',
              '≤48hr patch time',
              'IT Manager',
              'Patching tools',
              'Ongoing',
  ...
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.5.9',
    sections: [
      {
        heading: '1. Information Asset Inventory',
        table: {
          headers: [
            'Asset ID',
            'Asset Name',
      ...
      },
      {
        ...
        table: {
          headers: ['Level', 'Description', 'Handling Requirements'],
          rows: [
            [
              'Public',
            ...
            [
              ...
              'Internal use only, no external sharing without approval',
            ],
            [
              'Confidential',
              'Sensitive business information, customer data',
              'Encrypted at rest and in transit, access restricted to authorised personnel',
            ],
            [
              'Restricted',
              'Highly sensitive data (special category PII, trade secrets)',
              'Strongest encryption, strict need-to-know, logged access, no removable media',
            ],
          ],
        },
      },
  ...
  },
  {
    ...
    docNumber: 'PRO-025',
    title: 'Information Classification & Labelling Procedure',
    version: '1.0',
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.5.12, A.5.13',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To ensure all information assets are classified according to their value, sensitivity, and legal requirements, and are appropriately labelled to indicate their classification level.',
      },
      {
        heading: '2. Classification Scheme',
        content:
          'All information shall be classified into one of four levels: Public, Internal, Confidential, or Restricted. Classification is determined by the information owner based on the potential impact of unauthorised disclosure.',
      },
      {
        heading: '3. Classification Criteria',
        table: {
          headers: ['Criterion', 'Public', 'Internal', 'Confidential', 'Restricted'],
          rows: [
      ...
      {
        heading: '4. Labelling Requirements',
        bullets: [
          'Documents: Classification label in header/footer of every page',
          'Emails: Classification in subject line prefix [PUBLIC] / [INTERNAL] / [CONFIDENTIAL] / [RESTRICTED]',
          'Electronic files: Classification in file properties/metadata',
          'Physical media: Classification sticker on exterior',
          'Systems: Classification banner on login screen',
        ],
      },
      {
        heading: '5. Handling Rules',
        content:
          'Handling rules for each classification level are defined in the Information Security Policy (POL-004) and include requirements for storage, transmission, printing, disposal, and sharing.',
      },
      {
        heading: '6. Reclassification',
        content:
          'Information owners shall review classifications annually or when circumstances change. Reclassification requires approval from the Information Security Manager.',
      },
    ],
  },
  {
    ...
    sections: [
      ...
      {
        heading: '6. Access Review Schedule',
        content:
  ...
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.5.10',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To define the acceptable use of [COMPANY NAME] information systems, networks, and data by all employees, contractors, and third parties with access to company resources.',
      },
      {
        heading: '2. Scope',
        content:
          'This policy applies to all users of [COMPANY NAME] information systems including computers, mobile devices, email, internet, cloud services, social media, and any systems accessed for company business.',
      },
      {
        heading: '3. General Principles',
        bullets: [
  ...
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[Managing Director]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.5.19-5.21',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To define the information security requirements for all suppliers, third parties, and service providers who access, process, store, or transmit [COMPANY NAME] information or connect to [COMPANY NAME] systems.',
      },
      {
        heading: '2. Supplier Classification',
        table: {
          headers: ['Tier', 'Description', 'Security Requirements', 'Review Frequency'],
          rows: [
            [
              'Critical',
              'Access to restricted/confidential data or critical systems',
              'Full security assessment, contractual controls, annual audit right',
              'Annual on-site/remote audit',
            ],
            [
              'High',
              'Access to internal data or non-critical systems',
              'Security questionnaire, contractual controls',
              'Annual questionnaire',
            ],
            [
              'Standard',
              'No access to data or systems (goods/physical services)',
              'Standard T&Cs with security clauses',
              'Biennial review',
            ],
          ],
        },
  ...
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.8.24',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To ensure the proper and effective use of cryptographic controls to protect the confidentiality, integrity, and authenticity of [COMPANY NAME] information.',
      },
      {
        heading: '2. Encryption Requirements',
        table: {
          headers: ['Data State', 'Minimum Standard', 'Examples'],
          rows: [
            [
              'Data at rest',
              'AES-256',
              'Database encryption, disk encryption (BitLocker/FileVault), backup encryption',
            ],
            [
              'Data in transit',
              'TLS 1.2+ (TLS 1.3 preferred)',
              'HTTPS, encrypted email (S/MIME/PGP), VPN (IPSec/WireGuard)',
            ],
            [
              'Data in use',
              'Application-level controls',
              'Memory encryption where supported, secure enclaves',
            ],
          ],
        },
      },
      {
        heading: '3. Key Management',
        content:
          'a) Keys generated using cryptographically secure random number generators\nb) Key length: RSA ≥2048 bit, ECC ≥256 bit, symmetric ≥256 bit\nc) Keys stored in hardware security modules (HSMs) or approved key vaults\nd) Key rotation: Annual for encryption keys, on compromise for all keys\ne) Key destruction: Secure overwrite using approved methods\nf) Key escrow: Recovery keys for critical systems stored in sealed envelopes in fireproof safe, or in approved key escrow service',
      },
      {
        heading: '4. Certificate Management',
        content:
          'a) TLS certificates from trusted Certificate Authorities only\nb) Certificate inventory maintained and monitored for expiry\nc) Minimum 30-day renewal window before expiry\nd) Wildcard certificates minimised — use specific domain certificates where practical',
      },
    ],
  },
  {
    ...
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.7',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To prevent unauthorised physical access, damage, and interference to [COMPANY NAME] information and information processing facilities.',
      },
      {
        heading: '2. Security Perimeters',
        content:
          'a) External perimeter: Fencing, locks, CCTV, intrusion detection\nb) Building entry: Access-controlled doors (card/biometric)\nc) Secure areas (server rooms, comms rooms): Dual-factor access, logged entry\nd) Restricted areas (executive offices, R&D): Additional access restrictions',
      },
      {
        heading: '3. Entry Controls',
        bullets: [
          'All staff must wear visible ID badges at all times',
          'Visitors must sign in at reception, be issued a visitor badge, and be escorted at all times',
          'Delivery personnel escorted in loading areas only',
          'Access logs reviewed monthly for anomalies',
          'Lost access cards reported immediately and deactivated',
        ],
      },
      {
        heading: '4. Secure Areas',
        content:
      ...
      {
        heading: '5. Clear Desk & Clear Screen',
        bullets: [
          'Confidential/restricted documents locked away when unattended',
          'Computer screens locked when leaving desk (Win+L / Ctrl+Cmd+Q)',
          'Automatic screen lock after 5 minutes of inactivity',
          'Printers: collect printouts immediately, use secure print where available',
          'Whiteboards cleared after meetings',
        ],
      },
      {
        heading: '6. Equipment Disposal',
        content:
          'All IT equipment must be securely disposed of in compliance with WEEE regulations:\n\na) Hard drives: Degaussed and physically destroyed (NIST SP 800-88)\nb) SSDs: Cryptographic erasure + physical destruction\nc) Paper: Cross-cut shredding (DIN 66399 Level P-4 minimum)\nd) Disposal certificate obtained from approved vendor',
      },
    ],
  },
  {
    ...
    owner: '[IT Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.8.32',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To ensure all changes to information systems, infrastructure, and software are managed in a controlled manner, minimising the risk of disruption and security vulnerabilities.',
      },
      {
        heading: '2. Change Categories',
        table: {
          headers: ['Category', 'Description', 'Approval', 'Lead Time'],
          rows: [
            [
              'Standard',
              'Pre-approved low-risk changes (e.g., routine patching)',
              'Pre-approved by CAB',
              'As scheduled',
            ],
            [
              'Normal',
              'Planned changes requiring assessment',
              'Change Advisory Board (CAB)',
              'Minimum 5 working days',
            ],
            [
              'Emergency',
              'Urgent changes to restore service or fix critical vulnerabilities',
              'Emergency CAB (CISO + IT Manager)',
              'Immediate — retrospective review within 48 hours',
            ],
          ],
        },
      },
  ...
  },
  {
    ...
    docNumber: 'PLN-011',
    title: 'ISMS Internal Audit Programme',
    version: '1.0',
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Clause 9.2',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To establish a planned programme of internal audits to verify that the ISMS conforms to ISO/IEC 27001:2022 requirements and is effectively implemented and maintained.',
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              'ISMS-AUD-003',
              'Clause 8 (Operation) + A.5 (Org Controls)',
              '[IT/IS Team]',
              '[Auditor]',
              'Q2',
              'Planned',
  ...
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Clause 9.3',
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Chair', '[CISO / Managing Director]'],
          ],
        },
      },
      {
        heading: '2. Mandatory Inputs (Clause 9.3)',
        table: {
          headers: ['Input', 'Status/Summary', 'Action Required'],
          rows: [
      ...
      {
        heading: '3. Decisions & Actions (Outputs)',
        table: {
          headers: ['Decision/Action', 'Owner', 'Due Date', 'Priority'],
          rows: [
            ['', '', '', ''],
            ['', '', '', ''],
            ['', '', '', ''],
  ...
  },
  {
    ...
    docNumber: 'FRM-022',
    title: 'ISMS Nonconformity & Corrective Action Form',
    version: '1.0',
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Clause 10.2',
    sections: [
      {
        heading: '1. Nonconformity Details',
        table: {
          headers: ['Field', 'Detail'],
          rows: [
            ['NCR Number', '[ISMS-NCR-YYYY-NNN]'],
            ['Date Raised', '[DD/MM/YYYY]'],
            ['Raised By', '[Name]'],
            ['Source', 'Internal Audit / External Audit / Incident / Observation'],
            ['ISMS Clause/Control', '[e.g., Clause 7.2 or A.8.7]'],
            ['Severity', 'Major / Minor / Observation'],
          ],
        },
      },
      {
        heading: '2. Description of Nonconformity',
        content: '[Describe what was found to be nonconforming, including objective evidence]',
      },
      {
        heading: '3. Immediate Correction',
        content:
      ...
      },
      {
        ...
        content:
          '[Analysis of the underlying root cause using 5-Whys, fishbone, or equivalent method]',
      },
      {
      ...
      {
        heading: '6. Verification of Effectiveness',
        content:
          '[How was the corrective action verified to be effective? Date and evidence of verification]\n\nVerified by: _____________ Date: ___/___/______\nEffective: Yes / No — if No, further action required',
      },
  ...
  },
  {
    ...
    owner: '[Information Security Manager]',
    approvedBy: '[CISO]',
    isoRef: 'ISO/IEC 27001:2022 Annex A.5.24-5.27',
    sections: [
      {
        heading: '1. Incident Log',
        table: {
          headers: [
            'Incident #',
            'Date Reported',
          ...
          rows: [
            [
              ...
              '',
              '',
              'Phishing/Malware/Breach/Loss/Unauthorised Access',
              'P1-P4',
              '',
              '',
      ...
      {
        heading: '2. Severity Classification',
        table: {
          headers: ['Priority', 'Description', 'Response Time', 'Escalation'],
          rows: [
            [
              'P1 — Critical',
              'Active breach, data exfiltration, ransomware',
              '<1 hour',
              'Immediate: CISO, CEO, Legal, ICO (if PII)',
            ],
            [
              'P2 — High',
              'Significant vulnerability exploited, suspected breach',
              '<4 hours',
              'CISO, IS Manager, affected system owners',
            ],
            [
              'P3 — Medium',
              'Malware detection, policy violation, suspicious activity',
              '<8 hours',
              'IS Manager, IT Security',
            ],
  ...
  // ============================================
  {
    ...
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Article 35',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To define when and how Data Protection Impact Assessments (DPIAs) are conducted, ensuring compliance with GDPR Article 35 and UK GDPR.',
      },
      {
        heading: '2. When a DPIA is Required',
        content:
          'A DPIA must be conducted before any processing that is likely to result in a high risk to the rights and freedoms of individuals. This includes:',
        bullets: [
  ...
  },
  {
    ...
    docNumber: 'FRM-032',
    title: 'Data Protection Impact Assessment (DPIA) Form',
    version: '1.0',
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Article 35(7)',
    sections: [
      {
        heading: '1. Project/Processing Details',
        table: {
          headers: ['Field', 'Detail'],
          rows: [
      ...
      },
      {
        ...
        content:
          '[Describe the processing operation: What data? Whose data? How collected? How used? Who has access? How long retained? Any transfers?]',
      },
      {
        heading: '3. Necessity & Proportionality (Article 35(7)(b))',
        content:
          '[Explain why this processing is necessary for the stated purpose. Why can the purpose not be achieved with less data or less intrusive means?]',
      },
      {
        heading: '4. Risk Assessment',
        table: {
          headers: ['Risk', 'Likelihood', 'Severity', 'Overall Risk', 'Mitigation Measure'],
          rows: [
  ...
  },
  {
    ...
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Articles 33-34',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To ensure personal data breaches are detected, reported, investigated, and notified in compliance with GDPR Articles 33 (notification to supervisory authority) and 34 (communication to data subjects).',
      },
      {
        heading: '2. What is a Personal Data Breach',
        content:
      ...
      {
        heading: '6. Investigation & Remediation',
        content:
          'a) DPO leads the breach investigation with support from IT Security and relevant departments\nb) Root cause analysis within 5 working days\nc) Corrective actions identified and assigned\nd) Lessons learned documented and shared\ne) DPIA updated if the breach relates to existing processing',
      },
      {
        heading: '7. Records',
        content:
          'All breaches (including those not notified to the ICO) must be documented in the Data Breach Register (REG-028). Records retained for 6 years.',
      },
    ],
  },
  {
    ...
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Article 33(5)',
    sections: [
      {
        heading: '1. Breach Log',
        table: {
          headers: [
            'Breach #',
            'Date Detected',
      ...
      {
        heading: '2. Risk Assessment Criteria',
        table: {
          headers: [
            'Risk Level',
            'Description',
            'ICO Notification Required?',
            'Subject Communication Required?',
          ],
          rows: [
            ...
            [
              ...
              'Yes — within 72 hours',
              'No (unless subsequently escalated)',
            ],
            [
              'High',
  ...
  },
  {
    ...
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Articles 12-22',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To ensure [COMPANY NAME] responds to data subject rights requests lawfully, within the statutory timeframes, and in compliance with GDPR Articles 12-22.',
      },
      {
        heading: '2. Data Subject Rights',
        table: {
          headers: ['Right', 'GDPR Article', 'Description', 'Timeframe'],
          rows: [
            [
              'Access (DSAR)',
              'Art 15',
              'Copy of all personal data held about the individual',
              '1 month',
            ],
            [
              'Rectification',
            ...
            [
              'Erasure',
              'Art 17',
              'Deletion of personal data where no lawful basis for continued processing',
              '1 month',
            ],
            [
              'Restriction',
              'Art 18',
              'Temporary suspension of processing while accuracy/lawfulness is verified',
              '1 month',
            ],
            [
              'Data Portability',
              'Art 20',
              'Personal data provided in structured, machine-readable format',
              '1 month',
            ],
            [
              'Objection',
  ...
  },
  {
    ...
    docNumber: 'FRM-033',
    title: 'Data Subject Rights Request Form & Log',
    version: '1.0',
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Articles 12, 15-22',
    sections: [
      {
        heading: '1. Request Log',
        table: {
          headers: [
            'Ref #',
            'Date Received',
      ...
      {
        heading: '2. Request Form (for data subjects)',
        content:
  ...
  },
  {
    ...
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Article 5(1)(e)',
    sections: [
      {
        heading: '1. Retention Schedule',
        table: {
          headers: [
            'Data Category',
            'Examples',
          ...
          rows: [
            [
              'Employee records',
              'Contracts, payroll, performance reviews',
            ...
            [
              ...
              'Accident reports, risk assessments',
              'Legal obligation',
              '40 years (occupational health) / 3 years (general)',
              'Secure deletion',
            ],
            [
              'Financial records',
              'Accounts, tax records, VAT',
              'Legal obligation',
              '7 years',
              'Secure deletion',
            ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: '4. Sub-Processing',
        content:
          'The Processor shall not engage any sub-processor without prior specific or general written authorisation from the Controller. Where general authorisation is given, the Processor shall inform the Controller of any intended changes concerning the addition or replacement of sub-processors, giving the Controller an opportunity to object.',
      },
      {
        heading: '5. International Transfers',
        content:
          'The Processor shall not transfer personal data to a country outside the UK/EEA without prior written consent and appropriate safeguards (Standard Contractual Clauses, adequacy decision, or other approved mechanism).',
      },
      {
        heading: '6. Breach Notification',
        content:
          'The Processor shall notify the Controller without undue delay (and no later than 24 hours) after becoming aware of a personal data breach affecting Controller data.',
      },
      {
  ...
  },
  {
    ...
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Articles 6(1)(a), 7',
    sections: [
      {
        heading: '1. Purpose',
        content:
          'To ensure valid consent is obtained, recorded, managed, and withdrawable for all processing activities that rely on consent as the lawful basis under GDPR Article 6(1)(a).',
      },
      {
        heading: '2. Requirements for Valid Consent',
        bullets: [
      ...
      },
      {
        heading: '5. Review',
        content:
          'Consent mechanisms and records shall be reviewed annually to ensure they remain valid, up-to-date, and compliant with current ICO guidance.',
      },
    ],
  },
  {
    ...
    owner: '[Data Protection Officer]',
    approvedBy: '[Managing Director]',
    isoRef: 'GDPR Articles 44-49',
    sections: [
      {
        heading: '1. Transfer Details',
        table: {
          headers: ['Field', 'Detail'],
          rows: [
            ['Reference', '[TRA-YYYY-NNN]'],
            ['Data Exporter', '[COMPANY NAME]'],
            ['Data Importer', '[Name, country]'],
