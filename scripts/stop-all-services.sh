...
for port in 4000 4001 4002 4003 4004 4005 4006 4007 4008 3000 3001 3002 3003 3004 3005 3006 3007 3008; do
...
# Verify using ss
REMAINING=$(ss -tlnp 2>/dev/null | grep -E ":(300[0-8]|400[0-8]) " | wc -l)

if [ "$REMAINING" -eq 0 ]; then
    echo "All services stopped"
else
    echo "Warning: $REMAINING services may still be running"
    ss -tlnp 2>/dev/null | grep -E ":(300[0-8]|400[0-8]) "
fi
